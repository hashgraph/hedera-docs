...
description: "Compare Hedera's JSON-RPC relay with Ethereum on state management, historical data, and snapshots, and use eth_call and mirror nodes for contract queries."
---
