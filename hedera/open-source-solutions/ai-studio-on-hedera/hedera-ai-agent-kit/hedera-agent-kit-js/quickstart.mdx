...
description: "This guide walks you through scaffolding a minimal Node.js project that uses the Hedera Agent Kit to run an AI agent against the Hedera Testnet."
---
