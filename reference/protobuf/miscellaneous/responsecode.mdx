---
title: "ResponseCode"
description: "Hedera protobuf reference for the ResponseCodeEnum listing precheck and receipt status codes returned by Hedera nodes for transactions and queries."
---
