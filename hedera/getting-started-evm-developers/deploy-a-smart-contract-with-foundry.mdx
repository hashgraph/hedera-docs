...
This command compiles your contracts and places the artifacts(including the [ABI](/hedera/core-concepts/smart-contracts/compiling-smart-contracts) and bytecode) into the `out` directory. We are now ready to deploy the smart contract.
...
```solidity script/HederaToken.s.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.28;
