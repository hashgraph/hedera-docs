...
description: "Run a Hedera frictionless airdrop campaign using the new airdrop, claim, cancel, and reject token transaction types to safely distribute tokens at scale."
---
