...
description: "Set up Hardhat to compile, deploy, and test Solidity smart contracts on the Hiero Local Node or Hedera testnet using the JSON-RPC relay and ethers.js."
