...
**Benefits**
  * Improves reliability by ensuring only healthy and in-range block nodes are selected
  * Reduces risk of data loss during node restarts
...
**Benefits**
  * Enhances node stability and recovery
  * Improves consistency of state across nodes
