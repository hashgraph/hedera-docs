...
description: "Configure Hedera Local Node in multinode mode to run multiple consensus nodes locally for advanced testing scenarios that mimic mainnet network behavior."
---
...
To start Hedera Local Node in multinode mode, append the `--multinode` flag to your [start command](/learn/networks/localnet/single-node#npm). For example:
