...
description: "Create a Hedera KeyList structure that requires every key in the list to sign transactions modifying accounts, topics, tokens, contracts, or files."
---
