...
description: 'Token airdrops are commonly used to distribute tokens to multiple accounts, often as a promotional or reward mechanism. Hedera introduced "frictionless".'
---
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-airdrops/token-airdrops-1.webp" />
</Frame>
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-airdrops/token-airdrops-2.webp" />
</Frame>
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-airdrops/token-airdrops-3.webp" />
</Frame>
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-airdrops/token-airdrops-4.webp" />
</Frame>
