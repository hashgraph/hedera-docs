---
title: "Create a Personal Access Token in the Hedera Portal"
description: "In the Hedera Portal, the Personal Access Token (API key) is a new feature for seamless application development and management. This feature facilitates the."
---
...
- [Create a Hedera Portal profile](#step-1%3A-create-a-hedera-portal-profile)
- [Create a new token/API key](#step-2%3A-create-a-new-personal-access-token)
- [Make API calls ](#step-3%3A-api-calls-to-list-and-get-accounts)
