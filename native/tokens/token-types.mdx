---
title: "Token types"
description: "Compare fungible (FUNGIBLE_COMMON) and non-fungible (NON_FUNGIBLE_UNIQUE) token types on the Hedera Token Service and choose the right type for your use case."
---
