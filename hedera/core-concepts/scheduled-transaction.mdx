...
description: "A scheduled transaction is a type of transaction that allows you to publicly collect all the required signatures on the network. For example, Transaction A."
---
...
<Card
  ...
  href="/hedera/sdks-and-apis/sdks/schedule-transaction/get-schedule-info"
/>
...
<Card
  title="Sign A Schedule Transaction"
  href="/hedera/sdks-and-apis/sdks/schedule-transaction/sign-a-schedule-transaction"
/>
...
<Card
  ...
  href="/hedera/sdks-and-apis/sdks/schedule-transaction/delete-a-schedule-transaction"
/>
