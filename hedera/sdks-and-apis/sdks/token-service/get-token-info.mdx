...
description: "Gets information about a fungible or non-fungible token instance. For obtaining token information and historical data, consider using the Mirror Node REST."
---
...
For obtaining token information and historical data, consider using the Mirror Node REST API endpoint [**Get Token Info**](https://docs.hedera.com/api-reference/tokens/get-token-by-id) which offers several advantages:
