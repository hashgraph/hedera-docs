...
description: "Hedera protobuf reference for the ConsensusSubmitMessage transaction used to publish a message to an HCS topic and receive a consensus timestamp and order."
---
