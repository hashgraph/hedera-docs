---
title: "Mint and burn an ERC-721 token with Hardhat (Part 1)"
description: "Deploy, mint, and burn ERC-721 NFTs on Hedera testnet using Hardhat, Ethers.js, and OpenZeppelin contracts to learn essential NFT operations end to end."
---
