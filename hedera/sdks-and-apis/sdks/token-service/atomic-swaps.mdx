---
title: "Atomic swaps"
description: "An atomic swap is when you swap tokens between two accounts without using a third-party intermediary, such as a centralized exchange or custody provider, to."
---
...
<Info>
Hedera accounts must be associated with the specified token before you can transfer a token to their account. Please see how to associate a token to an account [here](/hedera/sdks-and-apis/sdks/token-service/associate-tokens-to-an-account).
</Info>
