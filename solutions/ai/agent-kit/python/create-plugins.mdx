...
description: "Create, publish, and register custom Python plugins for the Hedera Agent Kit, including the Plugin class and Tool interface for extending AI agent capabilities."
---
