---
title: "NFT DAO"
description: "Create an NFT-gated DAO on HashioDAO where membership and voting power are determined by ownership of a specific Hedera non-fungible token collection."
---
