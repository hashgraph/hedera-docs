...
description: "Hedera protobuf reference for the AssessedCustomFee message describing custom fees actually charged during an HTS token transfer, shown in transaction records."
---
