...
Hardhat can be used to deploy your smart contract by pointing to a community-hosted [JSON-RPC Relay](/hedera/core-concepts/smart-contracts/json-rpc-relay). However, EVM tools do not support features that are native to Hedera smart contracts like:
