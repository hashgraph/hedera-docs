...
description: "One-click deployment options for launching your own Hedera mirror node through the Google Cloud Platform Marketplace, with billing prerequisites set."
---
...
Once you deploy your mirror node, you can access the mirror node via the [gRPC API](/reference/hcs-api) or the [REST API](/reference/rest-api).
