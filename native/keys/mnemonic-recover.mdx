...
description: "Recover a Hedera private key from a 12 or 24-word mnemonic phrase using the SDK, with optional passphrase support compatible with iOS and Android wallets."
---
