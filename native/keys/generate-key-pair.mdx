...
<Tip>
**ECDSA is recommended for new accounts and applications.** It enables setting an **EVM Address from Public Key** on the account, native compatibility with EVM tooling, and `msg.sender` resolution in Solidity. Use ED25519 for Hedera-native workflows where EVM compatibility is not required. See [Keys and Signatures](/learn/core-concepts/keys) for the full comparison.
</Tip>
