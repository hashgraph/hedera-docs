...
description: "Hedera protobuf reference for the deprecated ThresholdSignature message, superseded by the modern Hedera SignaturePair and SignatureMap signing types."
---
