...
description: "Submit messages to a private Hedera Consensus Service topic by setting a Submit Key, controlling who can publish messages to your HCS topic on testnet."
---
