...
description: "Hedera protobuf reference for the SystemUndelete transaction used by privileged accounts to restore a previously system-deleted Hedera file or contract."
---
