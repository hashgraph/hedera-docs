...
description: "Hedera protobuf reference for the TokenGetAccountNftInfos query used to retrieve information about non-fungible HTS tokens owned by a specific Hedera account."
---
...
| `accountID` | [AccountID](/reference/protobuf/basic-types/accountid)       | The Account for which information is requested                                                                                                     |
...
| `nfts`   | repeated [TokenNftInfo](/reference/protobuf/token/tokengetnftinfo#tokennftinfo) | List of NFTs associated to the account                                                                           |
