...
description: "Create a Hedera mainnet account through supported wallets like HashPack, Kabila, Exodus, and Atomic to hold HBAR and access mainnet network services."
---
