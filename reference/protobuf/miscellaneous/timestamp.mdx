---
title: "TimeStamp"
description: "Hedera protobuf reference for the Timestamp message representing a UTC instant with seconds and nanoseconds precision used in Hashgraph transactions."
---
