...
description: "Retrieve metadata, supply, keys, and configuration for a fungible token or NFT on the Hedera Token Service using TokenInfoQuery or the Mirror Node REST API."
---
