...
description: "Submit a message to a Hedera Consensus Service (HCS) topic with TopicMessageSubmitTransaction, including chunking for messages larger than 1024 bytes."
---
