...
description: "To install the Hedera Custodians Integration package from NPM, run the following command in your terminal:. This command will install the Hedera Custodians."
---
