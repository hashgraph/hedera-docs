...
<Info>
  If you are use Testnet instead of a local node, you can skip this step. Note that you will need to create a different config using a testnet private key and a public RPC URL.
</Info>
