...
description: "Query Hedera scheduled transaction details with ScheduleInfoQuery, returning admin key, payer, expiration, signatories, and the scheduled inner transaction."
---
