...
description: "Schedule future smart contract calls on Hedera using the HSS system contract, HIP-755, and HIP-1215 for on-chain cron jobs without off-chain bots."
---
