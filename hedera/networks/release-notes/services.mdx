...
<Check>
  **TESTNET UPDATE: NOVEMBER 25, 2025**
</Check>

## Release Highlights

Release v0.68 prepares the Hiero Consensus Node for [Dynamic Address Book (DAB)](https://hips.hedera.com/hip/hip-1299) node account ID changes as well as scheduled contract calls on Hiero Consensus Node. These changes are now live on Hedera testnet (Nov 13, 2025) and are scheduled for mainnet on Dec 10, 2025
