...
description: "This tutorial demonstrates how to use an ECCSECGP256K1 key in AWS KMS to sign Hedera transactions. This solution ensures that your private keys are never."
---
