...
description: "Learn how the Hedera hashgraph gossip protocol spreads transaction events between nodes and builds the gossip-about-gossip DAG used to reach consensus."
---
