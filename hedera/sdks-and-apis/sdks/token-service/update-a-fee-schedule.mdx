...
description: "Update the custom fees for a given token. If the token does not have a fee schedule, the network response returned will be CUSTOMSCHEDULEALREADYHASNO_FEES."
---
