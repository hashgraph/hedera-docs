...
If you are using Testnet, for the `HEDERA_PRIVATE_KEY`, enter your testnet ECDSA EVM private key which you can get by signing up on the [Hedera Developer Portal](https://portal.hedera.com/dashboard)
