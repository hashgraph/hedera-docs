...
description: "Customize tool behavior and enforce business logic in the Hedera Agent Kit with hooks and policies that observe, modify, or block AI agent tool calls."
---
