...
description: "Sign Hedera transactions with an ECC_SECG_P256K1 key stored in AWS KMS so your private keys never leave the HSM, using a custom Hedera SDK signer."
---
