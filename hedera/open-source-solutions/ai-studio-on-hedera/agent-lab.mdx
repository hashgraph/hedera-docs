...
- The **Advanced Mode** toggle enables you to edit the code directly, with the help of an AI Assistance on the right hand side.
- Run your agent in the terminal at the bottom of the screen, or interact with the **Run Agent** to get a previous of what your Hedera Agent will look like for end users.
...
Below the center panel is an **Terminal** showing the agent chat, compilation results and agent runtime logs.
