...
description: "Tutorial on hybrid HTS plus EVM tokenization showing how to manage Hedera Token Service tokens from Solidity smart contracts via system contracts."
---
