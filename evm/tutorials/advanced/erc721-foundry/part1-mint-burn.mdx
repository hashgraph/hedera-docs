...
description: "Deploy, mint, and burn an ERC-721 NFT on Hedera testnet using Foundry, OpenZeppelin contracts, forge scripts, and cast through the JSON-RPC relay."
---
