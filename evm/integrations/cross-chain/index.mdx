...
>
  Programmable cross-chain messaging and token transfers with built-in risk controls. Live on Hedera Mainnet and Hedera Testnet.
</Card>
...
| --- | --- | --- | --- |
| [Chainlink CCIP](/evm/integrations/cross-chain/chainlink-ccip) | Programmable cross-chain messaging and token transfers with risk controls | Yes, integrate the CCIP router and receiver | CCIP messaging plus supported token transfers; live on Hedera Mainnet and Hedera Testnet |
