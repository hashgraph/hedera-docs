---
title: "TokenMint"
description: "Mints tokens to the Token's treasury Account. If no Supply Key is defined, the transaction will resolve to TOKENHASNOSUPPLYKEY. The operation increases the."
---
