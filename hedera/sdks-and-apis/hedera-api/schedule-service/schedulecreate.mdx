...
description: 'ScheduleCreate transaction protobuf reference for creating a new scheduled entity in the Hedera action queue; receipt returns the new ScheduleID.'
---
