...
description: "Tutorial for running your own Hedera mirror node by pulling transaction records and balance files from either Google Cloud Storage or Amazon S3 buckets."
---
## Overview
...
<Card
  ...
  href="/operators/mirror-node/run-your-own/gcs"
/>

<Card
  title="Run Your Own Mirror Node S3"
  href="/operators/mirror-node/run-your-own/s3"
/>
