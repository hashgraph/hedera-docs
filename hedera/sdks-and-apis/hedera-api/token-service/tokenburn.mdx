---
title: "TokenBurn"
description: "Burns tokens from the Token's treasury Account. If no Supply Key is defined, the transaction will resolve to TOKENHASNOSUPPLYKEY. The operation decreases the."
---
