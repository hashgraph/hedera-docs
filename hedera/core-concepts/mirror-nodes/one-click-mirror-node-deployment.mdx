...
description: "Deploy your own mirror node with just a few clicks! The Hedera Mirror Node is open-source software and does not carry an associated license or deployment fee."
---
...
<Accordion title="How To Obtain Google Cloud Platform Requester Pay Information">
...
Click [here](https://console.cloud.google.com/marketplace/details/mirror-node-public/hedera-mirror-node) to get started; you will need the following details you obtained from the previous [step](#how-to-obtain-google-cloud-platform-requester-pay-information):
...
Once you deploy your mirror node, you can access the mirror node via the [gRPC API](/hedera/sdks-and-apis/hedera-consensus-service-api) or the [REST API](/hedera/sdks-and-apis/rest-api).
