...
description: "Compare 8 and 18 decimal handling for HBAR, HTS tokens, and ERC tokens across HAPI, the EVM, and JSON-RPC Relay, plus conversion helpers to avoid errors."
---
