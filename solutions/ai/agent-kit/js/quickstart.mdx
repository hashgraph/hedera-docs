...
description: "Get started with the Hedera Agent Kit JavaScript SDK by scaffolding a Node.js project that runs an AI agent against Hedera testnet using LangChain or Vercel AI."
---
