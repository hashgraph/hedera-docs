...
description: 'TokenFeeScheduleUpdate transaction protobuf reference for updating the custom fee schedule on a Hedera Token Service token; requires the fee schedule key.'
---
