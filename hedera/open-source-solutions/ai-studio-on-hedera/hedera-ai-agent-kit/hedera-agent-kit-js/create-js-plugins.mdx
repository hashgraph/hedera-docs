...
description: "Every plugin must implement the Plugin interface:. Each tool must implement the Tool interface:. See packages/core/src/shared/tools.ts for the full."
---
