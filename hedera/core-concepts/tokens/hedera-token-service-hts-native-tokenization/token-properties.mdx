...
description: "Token properties on Hedera define the characteristics, governance, and lifecycle of fungible and non-fungible tokens. These properties are set during token."
---
