...
description: "Reference list of Hedera network response and error codes returned by transactions and queries, with descriptions to help debug protocol-level failures."
