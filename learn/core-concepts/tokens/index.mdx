...
description: "Learn about tokenization on Hedera with HTS native tokens, ERC-20 and ERC-721 contracts, and hybrid HTS plus EVM models for fungible tokens and NFTs."
---
...
<Columns cols={3}>
  <Card
    title="HTS Native"
    href="/learn/core-concepts/tokens/hts-overview"
    arrow
  ...
  <Card
    title="ERC/EVM"
    href="/evm/hedera-services/hybrid/erc-compatibility"
    arrow
  ...
  <Card
    ...
    href="/evm/hedera-services/hybrid"
    arrow
...
<Card
  ...
  href="/learn/core-concepts/tokens/custom-fees"
/>
