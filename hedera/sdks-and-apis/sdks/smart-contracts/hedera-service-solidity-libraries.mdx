...
<Info>
**Note:** Although [IHederaTokenService.sol](https://github.com/hiero-ledger/hiero-contracts/blob/main/contracts/token-service/IHederaTokenService.sol) is not imported in the contract, you need it in your project directory so supporting libraries can reference it.
</Info>
