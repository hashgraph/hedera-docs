...
description: "Create a Hedera threshold key requiring N-of-M signatures from a KeyList to authorize transactions, supporting ED25519 and ECDSA keys for multisig flows."
---
