---
title: "Hedera Token Service Part 3: pause, freeze, wipe, delete"
description: "Part 3 of the HTS tutorial series: use admin keys to pause tokens, freeze accounts, wipe balances, and delete NFTs on the Hedera Token Service."
