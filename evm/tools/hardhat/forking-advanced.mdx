---
title: "Fork Hedera with Hardhat: advanced HTS contract (Part 2)"
description: "Fork Hedera with Hardhat to create HTS fungible tokens via system contract precompiles, mint and transfer tokens, and explore emulation layer limits."
