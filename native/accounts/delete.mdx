...
description: "Delete a Hedera account with AccountDeleteTransaction, transferring the remaining HBAR balance to a designated account using the native SDK."
---
