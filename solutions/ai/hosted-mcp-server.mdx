...
description: "Connect your own MCP-compatible agents to the Hedera Hosted MCP Server to access Hedera Agent Kit tools without deploying local infrastructure."
