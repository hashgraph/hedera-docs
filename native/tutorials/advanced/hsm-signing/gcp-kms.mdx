...
description: "Sign Hedera transactions using a Google Cloud HSM-backed secp256k1 key so private keys never leave the HSM, with patterns for the Hiero SDKs and HSM-only flows."
---
...
- [Hedera SDK Documentation](/reference)
