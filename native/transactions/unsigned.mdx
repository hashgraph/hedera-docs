...
description: "Build and freeze a Hedera transaction without signing, then sign with multiple keys or serialize to bytes for offline signing, multi-sig, or HSM-backed flows."
---
