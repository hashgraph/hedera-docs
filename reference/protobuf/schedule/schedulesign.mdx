---
title: "ScheduleSign"
description: "Hedera protobuf reference for the ScheduleSign transaction used to add signatures to an existing Hedera scheduled transaction to satisfy its key requirements."
---
