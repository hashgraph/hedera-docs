...
## Hosted Network MCP Server

The **Hashgraph Hosted Network MCP Server** provides a managed, remote instance of the Hedera Agent Kit exposing its tools via the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/). It's non-custodial — every transaction is approved and signed in your own wallet.

[Learn more about the Hosted Network MCP Server →](/solutions/ai/hosted-mcp-server)
