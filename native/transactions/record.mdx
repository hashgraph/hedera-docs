...
description: "Query a Hedera transaction record with TransactionRecordQuery to retrieve consensus timestamp, transfers, fees charged, and contract function results."
---
