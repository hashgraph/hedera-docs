...
* ✅ Recommended use of "which": Hedera's dashboard is customizable, which allows users to customize it as per their needs.
* ❌ Recommended (not using "which"): Hedera's dashboard is customizable for the users.
