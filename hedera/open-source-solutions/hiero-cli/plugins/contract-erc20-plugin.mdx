...
description: "The Contract ERC-20 plugin calls standard EIP-20 methods on a contract already deployed on Hedera. Deploy or import the contract first with the Contract."
---
