...
<CardGroup cols={2}>
  ...
  <Card title="Consensus Service (HCS)" icon="list-check" href="/learn/core-concepts/services/tokens">
    Publish ordered, timestamped, verifiable messages to a topic. Ideal for audit logs, supply chain, and AI data provenance.
  </Card>
  <Card title="File Service (HFS)" icon="file" href="/learn/core-concepts/services/tokens">
