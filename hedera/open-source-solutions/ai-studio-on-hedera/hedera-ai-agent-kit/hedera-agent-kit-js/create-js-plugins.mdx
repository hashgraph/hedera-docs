...
Extending `BaseTool` splits execution into a 7-stage lifecycle that hooks and policies tap into automatically — you never call them manually. For a detailed step-by-step guide on refactoring your tools, see the [Migration Guide](/hedera/open-source-solutions/ai-studio-on-hedera/hedera-ai-agent-kit/hedera-agent-kit-js/migration-guide#migrating-custom-tools-to-basetool-recommended-non-breaking).

<CodeGroup>

```typescript v3 (Functional Tool object)
