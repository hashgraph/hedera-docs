---
title: "Response"
description: "Hedera protobuf reference for the Response message wrapping all possible Hedera query responses returned to clients across crypto, file, contract, and HTS."
---
