...
description: "Provision a secp256k1 key in Azure Key Vault Premium and use it from a Node.js app to sign Hedera transactions without exposing private key material."
---
