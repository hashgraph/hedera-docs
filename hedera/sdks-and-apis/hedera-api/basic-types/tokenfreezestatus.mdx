...
description: "TokenFreezeStatus protobuf enum listing the possible freeze states returned for an account by TokenGetInfoQuery and CryptoGetInfoResponse on Hedera."
---
