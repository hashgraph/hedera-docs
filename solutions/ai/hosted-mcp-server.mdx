...
description: "Connect Cursor, Claude Desktop, and other MCP clients to the Hedera Hosted MCP Server to use Hedera Agent Kit tools without local infrastructure."
