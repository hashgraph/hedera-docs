...
<Columns cols={2}>
  ...
  <Card
    title="Editor: Georgi, Sr Software Dev (LimeChain)"
    arrow
  >
    [GitHub](https://github.com/georgi-l95) | [LinkedIn](https://www.linkedin.com/in/georgi-dimitorv-lazarov/)
  </Card>
</Columns>
