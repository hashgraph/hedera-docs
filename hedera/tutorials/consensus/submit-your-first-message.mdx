...
✅ *You can find a full* [*code check*](#code-check) *for this tutorial at the bottom of this page.*
...
To subscribe to a topic, you will use [***`TopicMessageQuery()`***](/hedera/sdks-and-apis/sdks/consensus-service/get-topic-message). You will provide it with the topic ID to subscribe to, the Hedera mirror node client information, and the topic message contents to return.
...
Now you are ready to submit your first message to the topic. To do this, you will use [***`TopicMessageSubmitTransaction()`***](/hedera/sdks-and-apis/sdks/consensus-service/submit-a-message). For this transaction, you will provide the topic ID and the message to submit to it. Each message you send to a topic costs you [**$0.0001**](/hedera/networks/mainnet/fees#consensus-service). In other words, you can send 10,000 messages for $1 on the Hedera Network.
