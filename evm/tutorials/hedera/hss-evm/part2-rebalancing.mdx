---
title: "HSS x EVM: dynamic rebalancing with scheduling (Part 2)"
description: "Build a capacity-aware DeFi rebalancer on Hedera that uses HSS scheduling, exponential backoff, and jitter to self-schedule operations under network load."
---
