...
description: "Run your own Hedera mirror node using Google Cloud Storage requester-pays buckets, with Docker, Java, Gradle, and PostgreSQL prerequisites covered."
---
