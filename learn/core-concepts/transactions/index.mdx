...
description: "Learn how Hedera transactions and queries work, including transaction IDs, valid duration, node submission, fees, and the request and response flow."
---
## Transactions
