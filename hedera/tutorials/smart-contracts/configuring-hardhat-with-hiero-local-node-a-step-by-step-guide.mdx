---
title: "Configure Hardhat with Hedera Localnet or Testnet"
description: "Developers building smart contracts on Hedera often use the Hedera JSON-RPC Relay to enable EVM tools like Hardhat. In this post, we'll walk through how to."
---
