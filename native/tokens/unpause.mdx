...
description: "Unpause a previously paused Hedera Token Service token with TokenUnpauseTransaction so transfers and other operations can resume, signed by the pause key."
---
