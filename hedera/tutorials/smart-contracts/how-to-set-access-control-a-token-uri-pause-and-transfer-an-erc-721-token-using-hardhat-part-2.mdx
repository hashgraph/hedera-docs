---
title: "Access Control, Token URI, Pause & Transfer ERC-721 (Part 2)"
description: "In this tutorial, you'll learn how to create and manage an advanced ERC-721 token smart contract using Hardhat and OpenZeppelin. We'll cover deploying the."
---
