---
title: "ERC-721 access control, URI, pause, and transfer (Part 2)"
description: "Add OpenZeppelin access control roles, token URI storage, and pausable transfers to a Hedera ERC-721 NFT smart contract using Hardhat and Ethers.js."
---
