...
description: "Hardware, network, and hosting requirements for Hedera Council members deploying a permissioned Mainnet consensus node: CPU, memory, and connectivity."
---
