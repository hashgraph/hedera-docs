...
description: "HederaFunctionality is the Hedera protobuf enum listing every HAPI transaction and query type used for fee schedules and throttle configuration."
---
