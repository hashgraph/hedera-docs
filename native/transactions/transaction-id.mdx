...
description: "Hedera transaction ID format and reference: payer account ID plus timestamp, with notes on scheduled flags and nonce-based child transaction IDs."
---
