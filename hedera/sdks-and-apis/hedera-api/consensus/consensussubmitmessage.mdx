...
description: "ConsensusSubmitMessage transaction protobuf reference for publishing a message to a Hedera Consensus Service topic, with optional chunk metadata."
---
