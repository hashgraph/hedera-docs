---
title: "DAO Proposals"
description: "To create a proposal on chain, you must have sufficient voting power. This information can be found on the DAO's Overview tab from the HashioDAO dashboard."
---
