...
description: "Hedera protobuf reference for the TransactionGetFastRecord query used to quickly retrieve a recent transaction record from a Hedera node memory cache."
---
...
| `transactionID` | [TransactionID](/reference/protobuf/basic-types/transactionid) | The ID of the transaction for which the record is requested.                                                                                        |
...
| `transactionRecord` | [TransactionRecord](/reference/protobuf/miscellaneous/transactionrecord) | The requested transaction records                                                                                |
