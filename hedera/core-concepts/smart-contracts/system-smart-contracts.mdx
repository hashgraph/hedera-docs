...
description: "System smart contracts are Hedera API functionality logic presented at reserved address locations on the EVM network. These addresses contain reserved."
...
<Accordion title="IExchangeRate.sol">
```solidity
...
<Accordion title="IHederaTokenService.sol">
```solidity
// SPDX-License-Identifier: Apache-2.0
pragma solidity >=0.4.9 <0.9.0;
...
<Accordion title="IHederaAccountService.sol">
```solidity
// SPDX-License-Identifier: Apache-2.0
pragma solidity >=0.4.9 <0.9.0;
pragma experimental ABIEncoderV2;
...
### **➡** [**Hedera Schedule Service**](/hedera/core-concepts/smart-contracts/system-smart-contracts/hedera-schedule-service)
...
<Accordion title="IHederaScheduleService.sol">
```solidity
// SPDX-License-Identifier: Apache-2.0
pragma solidity >=0.4.9 <0.9.0;
pragma experimental ABIEncoderV2;
...
<Accordion title="IPrngSystemContract.sol">
```solidity
// SPDX-License-Identifier: Apache-2.0
pragma solidity >=0.4.9 <0.9.0;
