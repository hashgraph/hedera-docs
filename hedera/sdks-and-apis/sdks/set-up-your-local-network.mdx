...
description: "While you are developing your application, you can use the Hedera-supported networks (previewnet and testnet) to test your application against."
---
