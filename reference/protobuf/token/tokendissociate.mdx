...
description: "Hedera protobuf reference for the TokenDissociate transaction used to remove the association between a Hedera account and one or more HTS tokens."
---
...
| --------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| `account` | [AccountID](/reference/protobuf/basic-types/accountid)      | The account to be dissociated with the provided tokens |
| `tokens`  | repeated [TokenID](/reference/protobuf/basic-types/tokenid) | The tokens to be dissociated with the provided account |
