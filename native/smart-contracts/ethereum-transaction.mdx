...
description: "Execute raw RLP-encoded Ethereum transactions on Hedera with EthereumTransaction, including call data via HFS file ID and max gas allowance settings."
---
