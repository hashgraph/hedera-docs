---
title: "Configure Foundry with Hedera Localnet or Testnet"
description: "Developers building smart contracts on Hedera often use the Hedera JSON-RPC Relay to enable EVM tools like Foundry. In this post, we'll walk through how to."
---
...
3. [How to Fork the Hedera Network for Local Testing](/hedera/core-concepts/smart-contracts/forking-hedera-network-for-local-testing)\
