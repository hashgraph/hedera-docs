...
description: "Grant and revoke KYC, then rotate the KYC key on a Hedera NFT collection using HTS system contracts and a Solidity admin contract for permissioned tokens."
---
