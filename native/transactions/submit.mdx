...
description: "Submit a signed Hedera transaction to the network with the SDK execute method, returning a TransactionResponse to fetch receipts and records."
---
