---
title: "TimeStamp"
description: "Timestamp protobuf type representing an exact date and time as seconds and nanoseconds since the Unix epoch, used across Hedera transactions and queries."
---
