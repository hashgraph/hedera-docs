---
title: "Hiero Hooks"
description: "Hiero Hooks let developers inject Solidity logic into Hedera transfer transactions for custom validation, account abstraction, and on-network controls."
---
