...
description: "Create, publish, and register custom JavaScript plugins for the Hedera Agent Kit, including the Plugin and Tool interfaces and BaseTool patterns for v4."
---
