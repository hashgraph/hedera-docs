...
description: "Mirror node REST API endpoints for Hedera scheduled transactions, covering schedule metadata, signatures, execution status, and historical scheduling data."
