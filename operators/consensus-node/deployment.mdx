...
description: "Step-by-step deployment process for Hedera Council members to launch a permissioned consensus node on mainnet, from prerequisites to verification."
---
...
Before proceeding, ensure you have reviewed the [Node Requirements](/operators/consensus-node/requirements) to confirm your hardware, network, and software setup complies with Hedera standards.
