...
### ➡ [**Hedera Account Service**](hedera-account-service.md)
...
### **➡** [**Hedera Schedule Service**](hedera-schedule-service.md)

The Hedera Schedule Service (HSS) system contract exposes functions that enable smart contracts to interact with Hedera's native schedule service.&#x20;

| Contract Address | Source                                                                                                                                                                                                                               |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `0x16b`          | [https://github.com/hashgraph/hedera-smart-contracts/tree/main/contracts/system-contracts/hedera-schedule-service](https://github.com/hashgraph/hedera-smart-contracts/tree/main/contracts/system-contracts/hedera-schedule-service) |

#### Example ⬇

<details>

<summary>IHederaScheduleService.sol</summary>
