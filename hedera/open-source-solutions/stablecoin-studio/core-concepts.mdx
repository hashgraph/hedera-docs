---
title: "Core Concepts"
description: "As the adoption of cryptocurrencies grows, a common obstacle deterring new adoption by users is price volatility, particularly when considering these assets."
---
