...
description: 'Virtual voting in the hashgraph algorithm ensures every member knows every event and agrees on a linear ordering of events to reach consensus deterministically.'
---
