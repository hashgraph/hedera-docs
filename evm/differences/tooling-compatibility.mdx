...
description: "The native HBAR token cannot be burned. Learn how EVM developers use the HTS system contract at 0x167 and a supply key to mint and burn custom tokens."
---
