...
description: "Reference table of Hedera account error response codes returned by the consensus network, including invalid balance, transfer, and association errors."
---
