...
description: "Chainlink Oracles are decentralized services that securely connect smart contracts to real-world data, events, and computations. By bridging the gap between."
---
...
<Columns cols={2}>
  <Card
    title="➡ PRICE FEED"
    href="https://docs.chain.link/data-feeds/price-feeds/addresses/?network=hedera&#x26;amp%3Bpage=1&#x26;page=1"
    arrow
  >
  ...
  <Card
    ...
    href="https://github.com/hedera-dev/hedera-example-chainlink-price-feeds"
    arrow
  >
