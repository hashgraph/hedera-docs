...
description: "Ethereum supports native ETH burning via mechanisms like EIP-1559, but Hedera takes a different approach. The native HBAR token cannot be burned."
---
