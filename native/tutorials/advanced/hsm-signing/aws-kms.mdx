...
description: "Use an AWS KMS ECC_SECG_P256K1 key to sign Hedera transactions without exposing private keys, with examples for Java, JavaScript, Go, Rust, C++, and Swift SDKs."
---
