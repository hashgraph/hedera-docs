...
description: "Transfer HBAR, fungible tokens, and NFTs between Hedera accounts with TransferTransaction, including signing requirements and atomic multi-party transfers."
---
