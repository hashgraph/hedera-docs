---
title: "FeeComponents"
description: "FeeComponents protobuf type listing the individual cost components (bandwidth, compute, storage, signatures) used to calculate Hedera transaction fees."
---
