...
description: "Reference table of Hedera smart contract error response codes returned by ContractCreate, ContractExecute, and ContractCall transactions and queries."
---
