...
description: "Execute multiple Hedera transactions atomically with BatchTransaction (HIP-551): inner transactions succeed or fail together for ACID-style workflows."
---
...
<Card
  ...
  href="/learn/core-concepts/transactions/properties"
/>
