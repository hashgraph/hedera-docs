...
description: "Create a token-weighted governance DAO on HashioDAO using a Hedera fungible token where voting power scales with each member's token balance."
---
