...
<CardGroup cols={2}>
  ...
  <Card title="Hedera Harness" icon="diagram-project" href="/solutions/tools/hedera-harness/index">
    Generate and validate scaffold-hbar templates from a PRD with an agentic loop
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Hedera Harness" icon="diagram-project" href="/solutions/tools/hedera-harness/index">
    Agentic generate-and-validate loop for scaffold-hbar templates from a product brief
  </Card>
