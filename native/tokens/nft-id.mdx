---
title: "NFT ID"
description: "Construct and use the NftId object in the Hedera SDK, combining a token ID and serial number to uniquely reference a non-fungible token instance."
---
