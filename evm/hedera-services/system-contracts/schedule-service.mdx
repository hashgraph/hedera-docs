...
description: "Use the Hedera Schedule Service (HSS) system contract to schedule future transactions and contract calls, with its functions, behavior, and costs."
