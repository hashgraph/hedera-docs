...
description: "In this tutorial, you'll deploy, mint, and burn ERC‑721 tokens (NFTs) using Foundry and OpenZeppelin on the Hedera Testnet. You'll set up a Foundry project."
---
...
2. [How to Fork the Hedera Network for Local Testing](/hedera/core-concepts/smart-contracts/forking-hedera-network-for-local-testing)\
