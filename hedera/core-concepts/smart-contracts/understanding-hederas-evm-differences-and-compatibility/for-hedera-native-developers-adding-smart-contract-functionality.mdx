---
title: "For Hedera-Native Devs Adding Smart Contracts"
description: "As a Hedera-native developer, you are already familiar with Hedera's features, such as ED25519-based key management, the Hedera Token Service (HTS), the."
