---
title: "Signer"
description: "Signer interface in the Hedera JavaScript SDK responsible for signing transactions and queries, exposing methods to get the account ID, ledger, and key."
---
