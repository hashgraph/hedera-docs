---
title: "Schedule ID"
description: 'ScheduleId reference for Hedera scheduled transactions, structured as shard.realm.number (for example, 0.0.10), uniquely identifying a schedule entity.'
---
