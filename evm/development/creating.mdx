...
*📣 Learn more about jumbo transactions on the* [*Understanding Hedera's EVM Differences and Compatibility*](/evm/migration#jumbo-ethereum-transactions) *and on the* [*`EthereumTransaction` SDK page*](/native/smart-contracts/ethereum-transaction)*.*
</Info>
