...
description: "Create a Hedera Consensus Service (HCS) topic with TopicCreateTransaction: set admin key, submit key, memo, and auto-renew using the native SDK."
---
...
With the Consensus Node Release [v0.60](/learn/release-notes/services#release-v0.60), you can set an auto renew account ID without the requirement of setting an admin key on the topic.
</Info>
