...
description: "Delete a Hedera token by marking it removed in the ledger with TokenDeleteTransaction, signed by the admin key for fungible tokens or NFT classes."
---
...
| ----------------------- | ----------------------------------------------------------------------------------- | ----------------------------- | ----------- |
| `setTokenId(<tokenId>)` | [TokenId](/native/tokens/token-id) | The ID of the token to delete | Required    |
