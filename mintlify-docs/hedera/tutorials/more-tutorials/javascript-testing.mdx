...
In `my-app.genspec.js`, replace these two lines of code for [*Step 8*](#step-8-bonus-add-generative-testing), in the 'is associative' test.
...
<Columns cols={2}>
  <Card
    title="Writer: Brendan, DevRel Engineer"
    arrow
  >
    [GitHub](https://github.com/bguiz) | [Blog](https://blog.bguiz.com/)
  </Card>
  <Card
    title="Editor: Abi Castro, DevRel Engineer"
    arrow
  >
    [GitHub](https://github.com/a-ridley) | [X](https://twitter.com/ridley___)
  </Card>
</Columns>
