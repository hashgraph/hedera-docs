...
<Tip>
**Building locally?** [Solo](https://solo.hiero.org/docs/) lets you run a full Hedera network on your own machine, with no faucet, resets, or throttles. It works with MetaMask, Hardhat, and Foundry out of the box. See the [Solo quickstart](https://solo.hiero.org/docs/simple-solo-setup/quickstart/) or [Using Solo with EVM tools](https://solo.hiero.org/docs/using-solo/using-solo-with-evm-tools/) to get started.
</Tip>
