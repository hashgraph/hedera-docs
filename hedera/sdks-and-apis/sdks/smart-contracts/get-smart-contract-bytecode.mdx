...
description: "A query that returns the bytecode for a smart contract instance. Anyone can request the byte code of a smart contract instance on the network."
---
