...
description: "Learn how to test Hedera JavaScript dApps, smart contracts, and backend APIs using JavaScript test frameworks, with practical patterns and example projects."
---
...
- The DApp [client](/support/glossary#client) itself, when the DApp is browser-based
- The backend APIs, when the DApp uses some web2 server components
- Test code for [smart contracts](/support/glossary#smart-contract)
