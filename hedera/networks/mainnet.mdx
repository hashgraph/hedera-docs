---
title: Mainnet
description: "The Hedera mainnet (short for main network) is where applications are run in production, with transaction fees paid in HBAR. Any application or retail user."
