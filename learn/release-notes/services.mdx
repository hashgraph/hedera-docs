---
title: "Hedera consensus node release notes and changelog"
description: "Release notes for Hedera consensus node versions, covering new features, protocol changes, HIP rollouts, performance results, and upgrade guidance."
---
