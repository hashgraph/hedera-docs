...
description: "Create JavaScript hooks and policies in the Hedera Agent Kit to limit tool usage, enforce business logic, and customize agent behavior in your apps."
---
