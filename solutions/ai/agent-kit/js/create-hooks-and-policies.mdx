...
description: "Use and create hooks and policies in the Hedera Agent Kit JavaScript SDK to observe, modify, and enforce validation rules across the AI agent tool lifecycle."
---
