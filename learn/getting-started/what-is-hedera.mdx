...
description: "Hedera is a public proof-of-stake network using Hashgraph consensus to deliver fast finality, predictable fees, and enterprise governance — not a blockchain."
...
<CardGroup cols={2}>
  <Card title="Smart Contracts (EVM)" icon="file-code" href="/evm/quickstart/setup-metamask">
  ...
  <Card title="Consensus Service (HCS)" icon="list-check" href="/native/consensus/create-topic">
    Publish ordered, timestamped, verifiable messages to a topic. Ideal for audit logs, supply chain, and AI data provenance.
  </Card>
  <Card title="File Service (HFS)" icon="file" href="/native/files/create">
