...
description: "Explore the Hedera Agent Kit JavaScript plugin architecture, built-in Hedera service plugins, and third-party plugins for extending AI agent functionality."
---
