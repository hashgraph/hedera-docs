...
description: "Step-by-step guide to creating fungible and non-fungible tokens with the Hedera Token Service (HTS), including token properties, keys, and treasury setup."
---
