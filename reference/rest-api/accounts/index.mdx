---
title: "Accounts"
description: "Mirror node REST API endpoints for Hedera accounts, including balances, allowances, token relationships, owned NFTs, and staking reward payout history."
---
