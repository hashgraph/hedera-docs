...
description: "Use LocalProvider in the Hedera JavaScript SDK to construct a Provider from the HEDERA_NETWORK environment variable for previewnet, testnet, or mainnet."
---
