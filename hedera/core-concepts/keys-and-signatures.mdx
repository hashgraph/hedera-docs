...
description: "A key can be a public key of a supported type - ECDSA secp256k1 or Ed25519 - or an ID of a smart contract. The corresponding algorithm generates a public and."
---
