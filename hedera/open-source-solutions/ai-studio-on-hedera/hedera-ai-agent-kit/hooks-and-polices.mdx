...
description: "Hedera Agent Kit hooks and policies overview explaining how to constrain tool usage and enforce business rules across agent-driven workflows."
---
