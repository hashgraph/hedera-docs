...
description: "Set up Foundry to build, deploy, and test Solidity smart contracts against the Hiero Local Node or Hedera testnet through the JSON-RPC relay."
