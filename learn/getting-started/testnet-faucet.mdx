...
description: "Use the Hedera testnet faucet to auto-create a funded testnet account from an EVM wallet address and receive 100 free HBAR to start building on Hedera."
icon: "faucet"
---
