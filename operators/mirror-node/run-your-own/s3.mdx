...
description: "Run your own Hedera mirror node using Amazon S3 requester-pays buckets, with prerequisites for IAM users, Docker, Java, Gradle, and PostgreSQL setup."
---
