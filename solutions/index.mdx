...
<div style={{
  ...
  <div style={{
    ...
    <a href="/solutions/ai/index" style={{
      ...
      <div style={{ fontSize: '0.8125rem', color: 'var(--landing-fg-tertiary)', lineHeight: 1.45, marginBottom: '14px' }}>Build, test, and ship Hedera-powered AI agents: Agent Lab, Agent Kit, and more.</div>
      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
...
<div className="landing-section">
  ...
  <div className="landing-grid landing-grid--loose">
    ...
    <a href="/solutions/ai/hosted-mcp-server" className="landing-media-card">
      <div className="landing-media-card-hero">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--landing-demo-icon)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="6" y="11" width="12" height="6" rx="1"/><path d="M8 17v4M16 17v4M8 21h8M12 14h.01"/></svg>
      </div>
      <div className="landing-media-card-body">
        <div className="landing-card-title">Hedera Network MCP</div>
        <div className="landing-card-desc">Remote MCP server that exposes Hedera tools to any MCP-compatible client.</div>
        <div className="landing-tag-group">
          <span className="landing-tag">MCP</span>
        </div>
      </div>
    </a>

    <a href="/solutions/ai/x402" className="landing-media-card">
      <div className="landing-media-card-hero">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--landing-demo-icon)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20M6 15h.01M10 15h.01M14 15h.01"/></svg>
      </div>
      <div className="landing-media-card-body">
        <div className="landing-card-title">x402 Payments</div>
        <div className="landing-card-desc">Pay for HTTP requests with HBAR or HTS tokens using the x402 standard.</div>
        <div className="landing-tag-group">
          <span className="landing-tag">Payments</span>
        </div>
      </div>
    </a>
  </div>
