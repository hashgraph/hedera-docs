...
description: "The Metadata Validator is built to check your NFT metadata against the HIP-412 (NFT Token Metadata JSON Schema v2) standards, ensuring proper representation."
---
...
<iframe
  width="768"
  height="432"
  src="https://www.youtube.com/embed/Ovyrcc1oLGw"
  title="NFT Studio | Metadata Validator"
  frameborder="0"
