...
description: "Append content to an existing Hedera File Service (HFS) file with FileAppendTransaction, including chunked uploads for files larger than 4 KB."
---
