...
description: "Learn how auto account creation lets wallets and apps generate free Hedera accounts instantly using a public key or EVM address as the account alias."
---
