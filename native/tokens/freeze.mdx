...
description: "Freeze an account's ability to transfer a specific Hedera token using TokenFreezeTransaction, signed by the token's freeze key on the Hedera Token Service."
---
