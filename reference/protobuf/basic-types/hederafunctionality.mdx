---
title: "HederaFunctionality"
description: "Hedera protobuf reference for the HederaFunctionality enum, which enumerates every transaction and query type exposed by the Hashgraph API services."
---
