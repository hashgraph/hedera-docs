---
title: "Hedera Client"
description: "Configure the Hedera SDK Client for mainnet, testnet, previewnet, or a custom network, including mirror node endpoints, TLS, and operator credentials."
---
