...
description: "TokenAllowance protobuf type defining an approved fungible token transfer allowance for a spender, including token, owner, spender, and amount."
---
