...
description: "Use HTS system contract functions like mintToken and burnToken to add conditional minting and burning to tokens, with supply key and access control tips."
---
