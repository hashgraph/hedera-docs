...
description: "The local network comprises the consensus node, mirror node, JSON-RPC relay, and other Consensus Node services and now be set up without Docker and draining."
---
