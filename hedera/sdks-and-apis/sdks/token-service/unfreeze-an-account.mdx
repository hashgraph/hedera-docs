...
description: "Unfreezes transfers of the specified token for the account. The transaction must be signed by the token's Freeze Key. If the provided account is not found."
---
