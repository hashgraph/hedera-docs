---
title: "FileDelete"
description: "Hedera protobuf reference for the FileDelete transaction used to permanently remove a file stored on the Hedera File Service by its file identifier."
---
...
| -------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `fileID` | [FileID](/reference/protobuf/basic-types/fileid) | The file to delete. It will be marked as deleted until it expires. Then it will disappear. |
