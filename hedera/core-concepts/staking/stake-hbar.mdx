---
title: "Stake HBAR"
description: "The Hedera Council (via the Coin Committee) votes on the maximum reward rate. The maximum reward can change over time and is not a fixed value."
---
