---
title: "TokenPause"
description: "Hedera protobuf reference for the TokenPause transaction used by a pause key holder to suspend all transfers and operations on a specific HTS token on Hedera."
---
...
| ------- | -------------------------------------------------------------------------------------- | ---------------------- |
| `token` | [TokenID](/reference/protobuf/basic-types/tokenid) | The token to be paused |
