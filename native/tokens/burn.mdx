---
title: "Burn a token"
description: "Burn fungible tokens or NFTs from the treasury with TokenBurnTransaction on the Hedera Token Service to reduce the total supply using the supply key."
---
