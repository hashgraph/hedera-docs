...
This is the example bytecode output, produced in hexadecimal format, when the [`HelloHedera`](https://github.com/hashgraph/hedera-docs/blob/test-workflows/core-concepts/smart-contracts/broken-reference/README.md) smart contract source code is compiled.
...
This is the example ABI output produced when the [`HelloHedera`](https://github.com/hashgraph/hedera-docs/blob/test-workflows/core-concepts/smart-contracts/broken-reference/README.md) smart contract is compiled.
