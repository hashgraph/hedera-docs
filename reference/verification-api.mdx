...
description: "Smart contract verification API reference using Sourcify to verify Hedera EVM contract source code, check status, and fetch verified contract files."
