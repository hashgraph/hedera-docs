...
description: "Run your own Hedera mirror node using Amazon S3: create an IAM user, generate access keys, configure application.yml, and start the node with Docker."
...
<Frame>
  <img src="/images/core-concepts/mirror-nodes/run-your-own-beta-mirror-node/run-your-own-mirror-node-s3/run-your-own-mirror-node-s3-1.png" />
</Frame>
...
<Frame>
  <img src="/images/core-concepts/mirror-nodes/run-your-own-beta-mirror-node/run-your-own-mirror-node-s3/run-your-own-mirror-node-s3-2.png" />
</Frame>
