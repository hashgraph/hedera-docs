...
description: "The Hedera Schedule Service (HSS) system contract exposes functions that enable smart contracts to interact with Hedera's native schedule service."
mode: "wide"
---
