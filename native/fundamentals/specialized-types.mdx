...
description: "Reference for Hedera SDK specialized types like AccountId, ContractId, FileId, TopicId, TokenId, and ScheduleId, including constructors and conversions."
---
