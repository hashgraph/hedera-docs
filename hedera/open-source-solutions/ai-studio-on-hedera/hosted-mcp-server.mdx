...
Read-only queries such as balances, token info, transaction records, exchange rates, and similar can return their results directly through your AI application, since no transaciton signature is required
