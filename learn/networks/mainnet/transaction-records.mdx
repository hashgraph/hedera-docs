...
description: "Understand Hedera transaction records and receipts, including how account balances change due to transfers, network fees, and node compensation."
---
