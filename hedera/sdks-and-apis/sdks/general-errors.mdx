---
title: "General Network Response Messages"
description: "General Hedera network response messages and error codes returned across all SDK operations, with descriptions and resolution guidance."
---
