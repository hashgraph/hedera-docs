---
title: "Tokens"
description: "The Tokens endpoints in the Hedera Mirror Node REST API allow developers to retrieve token details, token balances, NFT metadata, and transaction history."
