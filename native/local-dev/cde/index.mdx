...
description: "Run a Hedera local node in a cloud development environment (CDE) like Gitpod or GitHub Codespaces without installing Docker on your local machine."
