...
description: "Reference for Hedera token properties — name, symbol, supply, decimals, treasury account, and the keys that govern token administration and lifecycle."
---
