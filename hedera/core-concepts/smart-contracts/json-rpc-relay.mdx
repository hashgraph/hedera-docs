...
description: "/hedera/core-concepts/smart-contracts/deploying-smart-contracts/json-rpc-rel. The Hiero JSON-RPC Relay is an open-source project implementing the EVM."
---
