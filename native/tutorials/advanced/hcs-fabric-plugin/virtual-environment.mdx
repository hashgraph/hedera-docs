...
description: "Set up a Vagrant and VirtualBox virtual environment to run the Hyperledger Fabric sample network powered by the Hedera Consensus Service Fabric plugin."
---
...
* [Hedera testnet](/learn/networks/testnet/access) account ID and account private key
