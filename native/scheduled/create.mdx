...
description: "Create a Hedera scheduled transaction with ScheduleCreateTransaction, allowing multiple parties to sign asynchronously before the inner transaction executes."
---
