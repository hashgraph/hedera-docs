...
description: "Generate ED25519 or ECDSA (secp256k1) key pairs with the Hedera SDK to sign transactions and queries, plus derive public keys and account aliases."
---
