...
description: "Structure HTS metadata for fungible tokens and NFTs using the Hedera Token Metadata JSON Schema V2 so collections stay consistent and ecosystem tool friendly."
---
...
1. [Connect Metadata](#how-do-you-connect-metadata-to-a-token)
2. [Metadata Schema](#what-does-the-token-metadata-json-schema-v2-look-like)
3. [Verify Metadata](#how-to-verify-your-token-metadata-is-correct)
4. [Video Tutorial](#want-to-learn-more-about-token-metadata)
...
An excerpt from the [NFT minting tutorial](/native/tutorials/tokens/create-transfer-nft#2.-mint-a-new-nft) shows this connection when minting a new NFT.

<CodeGroup>

```java Java highlight={1}
...
<iframe
  width="768"
  height="432"
  src="https://www.youtube.com/embed/o8lY5nQ7pYo"
  title="How to Make Sure Your Hedera NFT Metadata Is Correct"
  frameborder="0"
...
You can find **examples** in this [blog post](https://hedera.com/blog/hedera-nft-metadata-hip412) in the section "Token Metadata V2 NFT Examples". If you still have questions, reach out on [Discord](https://hedera.com/discord).
...
<Columns cols={2}>
  <Card title="Writer: Michiel, Developer Advocate" arrow>
