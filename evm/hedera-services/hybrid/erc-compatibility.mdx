...
<table><thead><tr><th>Token Standard</th><th>Description</th><th>Use Cases</th></tr></thead><tbody><tr><td><a href="/evm/tokens/erc20"><strong>ERC-20</strong></a></td><td>Fungible token standard</td><td>Cryptocurrencies, governance tokens</td></tr><tr><td><a href="/evm/tokens/erc721"><strong>ERC-721</strong></a></td><td>Non-fungible token (NFT) standard</td><td>Digital art, collectibles, gaming assets</td></tr><tr><td><a href="/evm/tokens/erc3643"><strong>ERC-3643</strong></a></td><td>Regulated real-world asset (RWA) token standard</td><td>Securities, compliant digital assets</td></tr><tr><td><a href="/evm/tokens/erc1363"><strong>ERC-1363</strong></a></td><td>Payable tokens supporting direct contract payments</td><td>Subscription models, in-app purchases</td></tr></tbody></table>
...
| --- | --- |
| [**Chainlink Oracles**](/evm/integrations/oracles/chainlink) | Decentralized data feeds, price oracles, and verifiable randomness (VRF). Ensures reliable, off-chain data for Hedera EVM smart contracts. |
| [**Chainlink CCIP**](/evm/integrations/cross-chain/chainlink-ccip) | Cross-chain messaging and token transfers, live on Hedera Mainnet and Hedera Testnet. |
| [**LayerZero Interoperability**](/evm/integrations/cross-chain/layerzero) | Enables cross-chain communication. Facilitates integration between Hedera and other EVM-compatible networks. |
| [**OpenZeppelin Libraries**](https://www.openzeppelin.com/solidity-contracts) | Standardized, audited smart contract frameworks. |
| [**Supra / Pyth / ChainLink**](/evm/integrations/oracles) | Oracles for EVM accessible data for prices of tokens, etc. |
