...
description: "Learn the difference between Hedera fungible tokens and NFTs, and how token IDs are formatted as shard, realm, and token number on the Hedera network."
---
