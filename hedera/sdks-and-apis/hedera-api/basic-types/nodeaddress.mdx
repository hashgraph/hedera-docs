---
title: "NodeAddress"
description: "NodeAddress protobuf type containing node metadata including IP address, port, account ID, gossip endpoints, and RSA public key for a consensus node."
---
