---
title: Testnets
description: "Test Hedera applications on the free testnet or previewnet — both mirror mainnet services, throttles, and fees so you can deploy with no code changes."
---
## Overview
