...
The **Hashgraph Hosted Network MCP Server** provides a managed, remote instance of the Hedera Agent Kit exposing its tools via the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/). It operates strictly in `RETURN_BYTES` mode.
