...
description: "Creates one or more hbar/token approved allowances relative to the payer account of thistransaction. Each allowance grants a spender the right to transfer a."
---
