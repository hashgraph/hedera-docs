...
description: "Modify the custom fee schedule of an existing Hedera Token Service token with TokenFeeScheduleUpdateTransaction, signed by the fee schedule key."
---
...
| ----------------------------- | ------------------------------------------------------------------------------------------------- | ----------- |
| `setTokenId(<tokenId>)`       | [TokenId](/native/tokens/token-id)               | Required    |
| `setCustomFees(<customFees>)` | List\<[CustomFee](/native/tokens/custom-fees#custom-fee)> | Optional    |
