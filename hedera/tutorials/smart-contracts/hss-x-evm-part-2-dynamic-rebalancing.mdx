---
title: "HSS x EVM Part 2: Dynamic Rebalancing via Scheduled Exec"
description: "Now, let's build something more sophisticated: a capacity-aware DeFi rebalancer that automatically adjusts its scheduling strategy based on network."
---
