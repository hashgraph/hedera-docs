---
title: "Adding Smart Contracts to Hedera-Native Applications"
description: "What changes when Hedera-native developers add EVM smart contracts: ECDSA and ED25519 keys, mirror node state queries, HTS token logic, and isAuthorized."
