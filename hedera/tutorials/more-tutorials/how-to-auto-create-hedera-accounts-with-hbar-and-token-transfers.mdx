...
[HIP-32](https://hips.hedera.com/hip/hip-32) introduced the ability to auto-create accounts when sending HBAR to a public key or EVM address that does not yet exist on the network. When HBAR is sent to one of these identifiers, the account creation fee is deducted from the amount sent, and the account is auto-created. The new account's initial balance is the amount of HBAR sent minus the account creation fee.

This method of account creation allowed wallet providers to offer free accounts to users. However, sending fungible tokens or NFTs to an identifier that does not exist on the network would result in an `INVALID_ACCOUNT_ID` error because the account creation fee must be paid in HBAR.
...
<Frame>
  ![](/images/tutorials/more-tutorials/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers-1.png)
</Frame>
...
<Accordion title="Get the example code on GitHub:">
  - [auto-create account by sending
    FT](https://github.com/a-ridley/hedera-auto-account-creation-with-ft) \* [auto-create account by sending
...
<Frame>
  ![](/images/tutorials/more-tutorials/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers-2.png)
</Frame>
...
<Frame>
  ![](/images/tutorials/more-tutorials/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers-3.png)
</Frame>
...
<Frame>
  ![](/images/tutorials/more-tutorials/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers-4.png)
</Frame>
...
<Frame>
  ![](/images/tutorials/more-tutorials/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers-5.png)
</Frame>

#### Console Output ✅

<Frame>
  ![](/images/tutorials/more-tutorials/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers/how-to-auto-create-hedera-accounts-with-hbar-and-token-transfers-6.png)
</Frame>
...
<Columns cols={2}>
  <Card title="Writer: Abi, DevRel Engineer">
    [GitHub](https://github.com/a-ridley) | [LinkedIn](https://www.linkedin.com/in/a-ridley/)
  </Card>
