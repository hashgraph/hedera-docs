...
description: "Overview of the Hiero JSON-RPC Relay—what it does, who operates it, and how to choose between public endpoints, managed providers, or self-hosting."
---
...
Hashio is the easiest path for "I just need a testnet endpoint right now." It's _not_ intended for production traffic.
