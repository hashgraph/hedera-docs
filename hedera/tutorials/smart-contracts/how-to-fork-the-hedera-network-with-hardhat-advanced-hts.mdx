...
```json package.json
{
  ...
  "license": "MIT",
  "devDependencies": {
    "@hiero-ledger/hiero-contracts": "^0.1.0-rc.0",
...
Note the addition of `@hiero-ledger/hiero-contracts` which provides the HTS System Contracts interfaces and helper contracts.
...
- **`@hiero-ledger/hiero-contracts`** - HTS System Contracts interfaces
...
4. [**Hedera Smart Contracts Repository**](https://github.com/hiero-ledger/hiero-contracts)\
