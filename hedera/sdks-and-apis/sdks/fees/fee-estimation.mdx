...
description: "The query returns a structured breakdown of node, network, and service fees in tinycents (USD × 10⁻¹⁰). The same calculation runs on the consensus node at."
...
<CardGroup cols={2}>
<Card title="Fee Model" icon="dollar-sign" href="/hedera/core-concepts/fee-model">
  The base-fee-plus-extras model that fee estimation calculates against.
</Card>
<Card title="Mirror Node REST API: Network" icon="code" href="/hedera/sdks-and-apis/rest-api/network">
