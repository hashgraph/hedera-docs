---
title: "AccountAmount"
description: "Hedera protobuf reference for the AccountAmount message, pairing an account with the amount it sends or receives in a crypto or token transfer."
---
