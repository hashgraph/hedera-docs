---
title: "Reference"
description: "Hedera reference hub for REST, gRPC, protobuf, mirror node, and status APIs covering every Hedera service including HCS, HTS, and smart contracts."
mode: wide
---
...
<div className="landing-section">
  <div className="landing-section-heading-row">
    ...
    <a href="/reference/rest-api/index" className="landing-see-all">See all →</a>
  </div>
...
<div className="landing-section">
  <div className="landing-section-heading-row">
    ...
    <a href="/reference/protobuf/index" className="landing-see-all">See all →</a>
  </div>
  <p className="landing-section-description">
