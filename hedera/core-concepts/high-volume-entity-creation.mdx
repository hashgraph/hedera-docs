...
```javascript Account creation wrap
...
```javascript Token creation wrap
...
<Card title="Fee Model" icon="coin" href="/hedera/core-concepts/fee-model">
...
<Card title="Estimate a Fee" icon="calculator" href="/hedera/sdks-and-apis/sdks/fees/fee-estimation">
