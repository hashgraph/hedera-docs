---
title: "Hedera mirror node release notes"
description: "Release notes for the Hedera mirror node, including new features, bug fixes, performance improvements, and supported versions across mainnet and testnet."
---
...
## [v0.163.1](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.163.1)

Integrates the 0.77.0 consensus node library into the web3 module. This update provides compatibility with the latest consensus node and includes a number of security fixes.

<Accordion title="Dependency Upgrades">
  * Bump hedera-app to 0.77.0 (0.163) [#14268](https://github.com/hiero-ledger/hiero-mirror-node/pull/14268)
</Accordion>

## [v0.163.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.163.0)

This release lands support for [HIP-1341](https://hips.hedera.com/hip/hip-1341) Ethereum Pectra and provides compatibility with the consensus node 0.77. This includes EIP-2537 BLS precompiles and EIP-7623 increased gas cost of calldata. Note that EIP-7702 EOA code delegation is part of a separate [HIP-1340](https://hips.hedera.com/hip/hip-1340) and its implementation is deferred until a later time.
...
<Accordion title="Enhancements">
  * Fix image vulnerability (0.163) [#14258](https://github.com/hiero-ledger/hiero-mirror-node/pull/14258)
  * Add uptime.tf for synth-checks and their alert rules [#14208](https://github.com/hiero-ledger/hiero-mirror-node/pull/14208)
  * Improve rosetta memory management [#14198](https://github.com/hiero-ledger/hiero-mirror-node/pull/14198)
  * Encode name/value parameters in requestNormalizer [#14189](https://github.com/hiero-ledger/hiero-mirror-node/pull/14189)
  * Add a highly compressed zstd payload over grpc test [#14188](https://github.com/hiero-ledger/hiero-mirror-node/pull/14188)
  * Include access list in parser hash verification [#14187](https://github.com/hiero-ledger/hiero-mirror-node/pull/14187)
  * ci: Harden workflow permissions, validate gradle wrapper and pin base images [#14174](https://github.com/hiero-ledger/hiero-mirror-node/pull/14174)
  * Optimize code and handle corner cases [#14172](https://github.com/hiero-ledger/hiero-mirror-node/pull/14172)
  * Make stateproof merkle paths parsing generic [#14171](https://github.com/hiero-ledger/hiero-mirror-node/pull/14171)
  * Add a .sdkmanrc to manage Java version [#14163](https://github.com/hiero-ledger/hiero-mirror-node/pull/14163)
  * Sanitize log message content and optimize code [#14160](https://github.com/hiero-ledger/hiero-mirror-node/pull/14160)
  * Add limits to state overrides [#14159](https://github.com/hiero-ledger/hiero-mirror-node/pull/14159)
  * Improve error handling and optimize code [#14153](https://github.com/hiero-ledger/hiero-mirror-node/pull/14153)
  * Clean up redundant workaround for code deposit in acceptance tests [#14151](https://github.com/hiero-ledger/hiero-mirror-node/pull/14151)
  * Do shallow fetch in release-automation workflow [#14136](https://github.com/hiero-ledger/hiero-mirror-node/pull/14136)
  * HIP-1340 Add acceptance tests [#14135](https://github.com/hiero-ledger/hiero-mirror-node/pull/14135)
  * Enforce REQUIRE_CLEAN_TARGET in copy live environment script [#14127](https://github.com/hiero-ledger/hiero-mirror-node/pull/14127)
  * HIP-1340 Pectra + hedera-app bump to 0.77.0-rc.11 [#14119](https://github.com/hiero-ledger/hiero-mirror-node/pull/14119)
  * Fix gas estimation for Ethereum transactions with historical block [#14110](https://github.com/hiero-ledger/hiero-mirror-node/pull/14110)
</Accordion>

<Accordion title="Bug Fixes">
  * Make RecomputeEvmTransactionIndexMigration continue with large gaps (0.163) [#14244](https://github.com/hiero-ledger/hiero-mirror-node/pull/14244)
  * Fix native image build with Pectra (0.163) [#14242](https://github.com/hiero-ledger/hiero-mirror-node/pull/14242)
  * Fix rest-java native image [#14229](https://github.com/hiero-ledger/hiero-mirror-node/pull/14229)
  * Fix acceptance test log file path in k6 action [#14227](https://github.com/hiero-ledger/hiero-mirror-node/pull/14227)
  * Fix accidentally aborted acceptance tests [#14225](https://github.com/hiero-ledger/hiero-mirror-node/pull/14225)
  * Improve WRB verification [#14218](https://github.com/hiero-ledger/hiero-mirror-node/pull/14218)
  * Fix LedgerId merging [#14217](https://github.com/hiero-ledger/hiero-mirror-node/pull/14217)
  * Fix self-referential next link issue in rest-java api [#14213](https://github.com/hiero-ledger/hiero-mirror-node/pull/14213)
  * Move authorization list and access list padding from importer to rest [#14210](https://github.com/hiero-ledger/hiero-mirror-node/pull/14210)
  * Fix tests under non-zero shard and realm [#14209](https://github.com/hiero-ledger/hiero-mirror-node/pull/14209)
  * Harden protobuf parsing [#14191](https://github.com/hiero-ledger/hiero-mirror-node/pull/14191)
  * Synchronize ledger resolution in TssVerifierImpl [#14179](https://github.com/hiero-ledger/hiero-mirror-node/pull/14179)
  * Fix EVM transaction index to use gasUsed instead of a status exclude-list [#14176](https://github.com/hiero-ledger/hiero-mirror-node/pull/14176)
  * Migrate missing contract transactions with zero entity [#14161](https://github.com/hiero-ledger/hiero-mirror-node/pull/14161)
  * Track remote release branch in release-automation workflow [#14156](https://github.com/hiero-ledger/hiero-mirror-node/pull/14156)
  * Do shallow fetch in copy stackgres cluster workflow [#14132](https://github.com/hiero-ledger/hiero-mirror-node/pull/14132)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Bump Tomcat from 11.0.24 to 11.0.25 [#14222](https://github.com/hiero-ledger/hiero-mirror-node/pull/14222)
  * Bump qs from 6.15.3 to 6.16.0 in /rest/monitoring [#14220](https://github.com/hiero-ledger/hiero-mirror-node/pull/14220)
  * Bump google.golang.org/grpc from 1.83.0 to 1.83.1 in /pinger [#14204](https://github.com/hiero-ledger/hiero-mirror-node/pull/14204)
  * Bump google.golang.org/grpc from 1.83.0 to 1.83.1 in /rosetta [#14203](https://github.com/hiero-ledger/hiero-mirror-node/pull/14203)
  * Bump the dependencies group across 1 directory with 14 updates [#14202](https://github.com/hiero-ledger/hiero-mirror-node/pull/14202)
  * Bump various dependencies [#14200](https://github.com/hiero-ledger/hiero-mirror-node/pull/14200)
  * Bump Go from 1.26.7 to 1.27.0 [#14197](https://github.com/hiero-ledger/hiero-mirror-node/pull/14197)
  * Bump jest from 30.4.2 to 30.5.0 in /tools/mirror-report in the dependencies group [#14195](https://github.com/hiero-ledger/hiero-mirror-node/pull/14195)
  * Bump pretty-ms from 9.3.0 to 9.3.1 in /rest/monitoring in the dependencies group [#14194](https://github.com/hiero-ledger/hiero-mirror-node/pull/14194)
  * Revert hedera-cryptography-wraps to 3.15.0 [#14190](https://github.com/hiero-ledger/hiero-mirror-node/pull/14190)
  * Bump the dependencies group with 2 updates [#14183](https://github.com/hiero-ledger/hiero-mirror-node/pull/14183)
  * Bump github.com/sirupsen/logrus from 1.10.1 to 1.10.2 in /rosetta in the dependencies group [#14182](https://github.com/hiero-ledger/hiero-mirror-node/pull/14182)
  * Bump com.hedera.cryptography:hedera-cryptography-wraps from 3.15.0 to 3.15.2 in the dependencies group [#14170](https://github.com/hiero-ledger/hiero-mirror-node/pull/14170)
  * Bump the dependencies group with 8 updates [#14168](https://github.com/hiero-ledger/hiero-mirror-node/pull/14168)
  * Bump negotiator from 1.0.0 to 1.1.0 in /rest in the dependencies group [#14167](https://github.com/hiero-ledger/hiero-mirror-node/pull/14167)
  * Bump the dependencies group in /rosetta with 2 updates [#14165](https://github.com/hiero-ledger/hiero-mirror-node/pull/14165)
  * Bump github.com/hiero-ledger/hiero-sdk-go/v2 from 2.83.0 to 2.84.0 in /pinger in the dependencies group [#14164](https://github.com/hiero-ledger/hiero-mirror-node/pull/14164)
  * Bump solo version [#14158](https://github.com/hiero-ledger/hiero-mirror-node/pull/14158)
  * Bump the dependencies group with 2 updates [#14150](https://github.com/hiero-ledger/hiero-mirror-node/pull/14150)
  * Bump the dependencies group in /rest with 2 updates [#14148](https://github.com/hiero-ledger/hiero-mirror-node/pull/14148)
  * Bump the dependencies group in /rosetta with 2 updates [#14147](https://github.com/hiero-ledger/hiero-mirror-node/pull/14147)
  * Bump com.google.guava:guava from 33.6.0-jre to 33.7.1-jre [#14146](https://github.com/hiero-ledger/hiero-mirror-node/pull/14146)
  * Bump gradle-wrapper from 9.7.0 to 9.7.1 [#14145](https://github.com/hiero-ledger/hiero-mirror-node/pull/14145)
  * Bump io.hypersistence:hypersistence-utils-hibernate-71 from 3.15.4 to 3.15.5 [#14144](https://github.com/hiero-ledger/hiero-mirror-node/pull/14144)
  * Bump org.graalvm.nativeimage:svm from 25.0.4 to 25.0.4.1 [#14143](https://github.com/hiero-ledger/hiero-mirror-node/pull/14143)
  * Bump software.amazon.awssdk:bom from 2.51.1 to 2.54.0 [#14142](https://github.com/hiero-ledger/hiero-mirror-node/pull/14142)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.9 to 1.1.10 [#14141](https://github.com/hiero-ledger/hiero-mirror-node/pull/14141)
  * Bump com.github.luben:zstd-jni from 1.5.7-13 to 1.5.7-15 [#14140](https://github.com/hiero-ledger/hiero-mirror-node/pull/14140)
  * Bump io.cucumber:cucumber-bom from 7.34.6 to 7.34.7 [#14139](https://github.com/hiero-ledger/hiero-mirror-node/pull/14139)
  * Bump org.hiero.block-node:protobuf-sources from 0.40.0 to 0.40.1 [#14138](https://github.com/hiero-ledger/hiero-mirror-node/pull/14138)
  * Bump com.diffplug.spotless:spotless-plugin-gradle from 8.9.0 to 8.10.0 [#14137](https://github.com/hiero-ledger/hiero-mirror-node/pull/14137)
  * Bump Spring Boot from 4.1.0 to 4.1.1 [#14131](https://github.com/hiero-ledger/hiero-mirror-node/pull/14131)
  * Bump versions for v0.163.0-SNAPSHOT [#14126](https://github.com/hiero-ledger/hiero-mirror-node/pull/14126)
</Accordion>

## [v0.162.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.162.0)
...
There was some feature work completed as well, including support for [HIP-1261](https://hips.hedera.com/#hip-1261) simple fees when calculating gas price in contract REST APIs. [HIP-1080](https://hips.hedera.com/#hip-1080) Block Nodes saw streaming improvements and a refactor of block root hashing to use a fixed 16-slot sub Merkle tree.

Support for Kubernetes 1.35 was verified and all Hedera clusters have been upgraded.

<Accordion title="Enhancements">
  * Revert ContractLogSyntheticFlagBackfillMigration [#14116](https://github.com/hiero-ledger/hiero-mirror-node/pull/14116)
  * Blocknode streaming improvement [#14111](https://github.com/hiero-ledger/hiero-mirror-node/pull/14111)
  * Make `maxGasAllowance` configurable in debug transactions [#14109](https://github.com/hiero-ledger/hiero-mirror-node/pull/14109)
  * Enhance logging in rest and tools modules [#14108](https://github.com/hiero-ledger/hiero-mirror-node/pull/14108)
  * Exclude lightweight k6 tests by default [#14102](https://github.com/hiero-ledger/hiero-mirror-node/pull/14102)
  * Exclude NFT synthetic logs with wildcard serial number from REST API results [#14101](https://github.com/hiero-ledger/hiero-mirror-node/pull/14101)
  * Optimize contract storage lookup in web3 [#14099](https://github.com/hiero-ledger/hiero-mirror-node/pull/14099)
  * Bump K8s (1.35) and KIND (0.32.0) versions [#14098](https://github.com/hiero-ledger/hiero-mirror-node/pull/14098)
  * Enhance logging filter for data parsing [#14096](https://github.com/hiero-ledger/hiero-mirror-node/pull/14096)
  * Refactor block root hashing to use fixed 16-slot sub merkle tree [#14078](https://github.com/hiero-ledger/hiero-mirror-node/pull/14078)
  * Skip unknown request params [#14076](https://github.com/hiero-ledger/hiero-mirror-node/pull/14076)
  * Document web3 request filters [#14072](https://github.com/hiero-ledger/hiero-mirror-node/pull/14072)
  * Refactor the way throttle tokens are restored on invalid arguments [#14071](https://github.com/hiero-ledger/hiero-mirror-node/pull/14071)
  * Add memory, stack and storage limitations on the opcodes endpoint [#14065](https://github.com/hiero-ledger/hiero-mirror-node/pull/14065)
  * Add CI stage running modified tests with non-zero shard and realm [#14061](https://github.com/hiero-ledger/hiero-mirror-node/pull/14061)
  * Resolve alias on HCS transactions [#14057](https://github.com/hiero-ledger/hiero-mirror-node/pull/14057)
  * Adapt rest module to work with simple fee schedules [#14038](https://github.com/hiero-ledger/hiero-mirror-node/pull/14038)
  * Add workflow that compares gas estimation with actual contract results [#13988](https://github.com/hiero-ledger/hiero-mirror-node/pull/13988)
</Accordion>

<Accordion title="Bug Fixes">
  * Fix non-zero realm test failures [#14125](https://github.com/hiero-ledger/hiero-mirror-node/pull/14125)
  * Exclude `transaction_index=null` from contract results endpoints (0.161) [#14115](https://github.com/hiero-ledger/hiero-mirror-node/pull/14115)
  * Exclude `transaction_index=null` from contract results endpoints [#14113](https://github.com/hiero-ledger/hiero-mirror-node/pull/14113)
  * Exclude transaction_index=null from contract results endpoint [#14103](https://github.com/hiero-ledger/hiero-mirror-node/pull/14103)
  * Create new opcode context per processOpcodeCall in tests [#14100](https://github.com/hiero-ledger/hiero-mirror-node/pull/14100)
  * Improve token treasury update [#14066](https://github.com/hiero-ledger/hiero-mirror-node/pull/14066)
  * Fix missing transfer events from contracts/results [#14058](https://github.com/hiero-ledger/hiero-mirror-node/pull/14058)
  * Fix alias-addressed account resolution in the importer [#14026](https://github.com/hiero-ledger/hiero-mirror-node/pull/14026)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Bump Go, Node, and GraalVM [#14118](https://github.com/hiero-ledger/hiero-mirror-node/pull/14118)
  * Bump jackson, log4j2, and netty versions [#14114](https://github.com/hiero-ledger/hiero-mirror-node/pull/14114)
  * Bump the dependencies group with 2 updates [#14095](https://github.com/hiero-ledger/hiero-mirror-node/pull/14095)
  * Bump golang.org/x/text from 0.40.0 to 0.41.0 in /tools/bootstrap in the dependencies group [#14093](https://github.com/hiero-ledger/hiero-mirror-node/pull/14093)
  * Bump github.com/hiero-ledger/hiero-sdk-go/v2 from 2.82.0 to 2.83.0 in /pinger in the dependencies group [#14092](https://github.com/hiero-ledger/hiero-mirror-node/pull/14092)
  * Bump `@google-cloud`/logging from 12.0.0 to 12.0.1 in /tools/log-downloader in the dependencies group [#14091](https://github.com/hiero-ledger/hiero-mirror-node/pull/14091)
  * Bump the dependencies group in /rosetta with 2 updates [#14090](https://github.com/hiero-ledger/hiero-mirror-node/pull/14090)
  * Bump the dependencies group in /rest with 3 updates [#14089](https://github.com/hiero-ledger/hiero-mirror-node/pull/14089)
  * Bump org.cyclonedx:cyclonedx-gradle-plugin from 3.3.0 to 3.4.1 [#14088](https://github.com/hiero-ledger/hiero-mirror-node/pull/14088)
  * Bump com.hedera.hashgraph:sdk from 2.75.0 to 2.76.0 [#14087](https://github.com/hiero-ledger/hiero-mirror-node/pull/14087)
  * Bump com.github.luben:zstd-jni from 1.5.7-12 to 1.5.7-13 [#14086](https://github.com/hiero-ledger/hiero-mirror-node/pull/14086)
  * Bump gradle-wrapper from 9.6.1 to 9.7.0 [#14084](https://github.com/hiero-ledger/hiero-mirror-node/pull/14084)
  * Bump org.hiero.block-node:protobuf-sources from 0.39.0 to 0.40.0 [#14083](https://github.com/hiero-ledger/hiero-mirror-node/pull/14083)
  * Bump org.flywaydb:flyway-database-postgresql from 13.1.0 to 13.3.0 [#14082](https://github.com/hiero-ledger/hiero-mirror-node/pull/14082)
  * Bump org.apache.commons:commons-collections4 from 4.5.0 to 4.6.0 [#14080](https://github.com/hiero-ledger/hiero-mirror-node/pull/14080)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.7 to 1.1.9 [#14079](https://github.com/hiero-ledger/hiero-mirror-node/pull/14079)
  * Bump the dependencies group with 3 updates [#14056](https://github.com/hiero-ledger/hiero-mirror-node/pull/14056)
  * Bump `@google-cloud`/logging from 11.3.0 to 12.0.0 in /tools/log-downloader in the dependencies group [#14054](https://github.com/hiero-ledger/hiero-mirror-node/pull/14054)
  * Bump the dependencies group in /rest with 4 updates [#14053](https://github.com/hiero-ledger/hiero-mirror-node/pull/14053)
  * Bump the dependencies group in /rosetta with 2 updates [#14052](https://github.com/hiero-ledger/hiero-mirror-node/pull/14052)
  * Bump org.flywaydb:flyway-database-postgresql from 13.0.0 to 13.1.0 [#14051](https://github.com/hiero-ledger/hiero-mirror-node/pull/14051)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.6 to 1.1.7 [#14050](https://github.com/hiero-ledger/hiero-mirror-node/pull/14050)
  * Bump org.gaul:s3proxy from 3.3.0 to 4.0.0 [#14049](https://github.com/hiero-ledger/hiero-mirror-node/pull/14049)
  * Bump org.owasp:dependency-check-gradle from 12.2.2 to 13.0.0 [#14048](https://github.com/hiero-ledger/hiero-mirror-node/pull/14048)
  * Bump com.hedera.cryptography:hedera-cryptography-wraps from 3.14.0 to 3.15.0 [#14047](https://github.com/hiero-ledger/hiero-mirror-node/pull/14047)
  * Bump com.hedera.hashgraph:sdk from 2.74.0 to 2.75.0 [#14046](https://github.com/hiero-ledger/hiero-mirror-node/pull/14046)
  * Bump software.amazon.awssdk:bom from 2.49.6 to 2.51.1 [#14045](https://github.com/hiero-ledger/hiero-mirror-node/pull/14045)
  * Bump jooqVersion from 3.21.6 to 3.21.7 [#14044](https://github.com/hiero-ledger/hiero-mirror-node/pull/14044)
  * Bump versions for v0.162.0-SNAPSHOT [#14041](https://github.com/hiero-ledger/hiero-mirror-node/pull/14041)
</Accordion>

## [v0.161.3](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.161.3)

<Accordion title="Bug Fixes">
  * Exclude transaction_index=null from contract results endpoint (0.161) [#14115](https://github.com/hiero-ledger/hiero-mirror-node/pull/14115)
</Accordion>

## [v0.161.2](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.161.2)

<Accordion title="Bug Fixes">
  * Exclude transaction_index=null from contract results endpoint (0.161) [#14104](https://github.com/hiero-ledger/hiero-mirror-node/pull/14104)
</Accordion>

## [v0.161.1](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.161.1)

<Accordion title="Bug Fixes">
  * Improve token treasury update (0.161) [#14067](https://github.com/hiero-ledger/hiero-mirror-node/pull/14067)
</Accordion>

## [v0.161.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.161.0)
...
<Accordion title="Enhancements">
  * Improve regular expression evaluation time [#14040](https://github.com/hiero-ledger/hiero-mirror-node/pull/14040)
  * Fix Long overflow in range parameters [#14033](https://github.com/hiero-ledger/hiero-mirror-node/pull/14033)
  * Bootstrap improvement [#14027](https://github.com/hiero-ledger/hiero-mirror-node/pull/14027)
  * Fix infinite loop in FixEvmTransactionIndexMigration [#14010](https://github.com/hiero-ledger/hiero-mirror-node/pull/14010)
  * HIP-1081 Use block node server status details API for available blocks [#14004](https://github.com/hiero-ledger/hiero-mirror-node/pull/14004)
  * Optimize web3 code [#14003](https://github.com/hiero-ledger/hiero-mirror-node/pull/14003)
  * Adjust cluster-mgmt scripts to support single-zone deployments [#13999](https://github.com/hiero-ledger/hiero-mirror-node/pull/13999)
  * Limit BLOCKHASH opcode to standard 256-block range [#13996](https://github.com/hiero-ledger/hiero-mirror-node/pull/13996)
  * Adapt /network/fees endpoint to work with simple fee schedules [#13995](https://github.com/hiero-ledger/hiero-mirror-node/pull/13995)
  * Add per endpoint request timeout [#13993](https://github.com/hiero-ledger/hiero-mirror-node/pull/13993)
  * Improve test coverage [#13990](https://github.com/hiero-ledger/hiero-mirror-node/pull/13990)
  * Аdd stream input bound in importer [#13983](https://github.com/hiero-ledger/hiero-mirror-node/pull/13983)
  * Remove unused code [#13981](https://github.com/hiero-ledger/hiero-mirror-node/pull/13981)
  * Sunset HIP-679 and remove all related code [#13960](https://github.com/hiero-ledger/hiero-mirror-node/pull/13960)
</Accordion>

<Accordion title="Bug Fixes">
  * Fix missing contract_transaction rows when empty contract ID [#14039](https://github.com/hiero-ledger/hiero-mirror-node/pull/14039)
  * Fix rest/package-lock.json [#14023](https://github.com/hiero-ledger/hiero-mirror-node/pull/14023)
  * Limit the number of block node grpc buffer drain attempts [#14005](https://github.com/hiero-ledger/hiero-mirror-node/pull/14005)
  * Improve workflow security [#14001](https://github.com/hiero-ledger/hiero-mirror-node/pull/14001)
  * `test-native-images` workflow - add kind load per platform in TAG case [#13992](https://github.com/hiero-ledger/hiero-mirror-node/pull/13992)
  * Fix block stream parser metrics [#13991](https://github.com/hiero-ledger/hiero-mirror-node/pull/13991)
  * Fix `test-native-images` workflow when working with tags [#13986](https://github.com/hiero-ledger/hiero-mirror-node/pull/13986)
  * Change cryptoAllowance.feature to use different account [#13984](https://github.com/hiero-ledger/hiero-mirror-node/pull/13984)
  * Add platform flag to the "Test native images" workflow [#13982](https://github.com/hiero-ledger/hiero-mirror-node/pull/13982)
  * Reduce recordstream to blockstream switches in first stage cutover [#13958](https://github.com/hiero-ledger/hiero-mirror-node/pull/13958)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Bump the dependencies group with 2 updates [#14020](https://github.com/hiero-ledger/hiero-mirror-node/pull/14020)
  * Bump gorm.io/driver/postgres from 1.6.0 to 1.6.1 in /rosetta in the dependencies group [#14018](https://github.com/hiero-ledger/hiero-mirror-node/pull/14018)
  * Bump software.amazon.awssdk:bom from 2.49.3 to 2.49.6 [#14017](https://github.com/hiero-ledger/hiero-mirror-node/pull/14017)
  * Bump com.hedera.cryptography:hedera-cryptography-wraps from 3.13.0 to 3.14.0 [#14016](https://github.com/hiero-ledger/hiero-mirror-node/pull/14016)
  * Bump com.github.luben:zstd-jni from 1.5.7-11 to 1.5.7-12 [#14015](https://github.com/hiero-ledger/hiero-mirror-node/pull/14015)
  * Bump org.hiero.block-node:protobuf-sources from 0.38.1 to 0.39.0 [#14014](https://github.com/hiero-ledger/hiero-mirror-node/pull/14014)
  * Bump com.diffplug.spotless:spotless-plugin-gradle from 8.8.0 to 8.9.0 [#14013](https://github.com/hiero-ledger/hiero-mirror-node/pull/14013)
  * Bump Node.js from 24.18.0 to 24.18.1 [#14000](https://github.com/hiero-ledger/hiero-mirror-node/pull/14000)
  * Bump the dependencies group with 6 updates [#13979](https://github.com/hiero-ledger/hiero-mirror-node/pull/13979)
  * Bump github.com/hiero-ledger/hiero-sdk-go/v2 from 2.81.0 to 2.82.0 in /pinger in the dependencies group [#13978](https://github.com/hiero-ledger/hiero-mirror-node/pull/13978)
  * Bump the dependencies group in /rest with 9 updates [#13977](https://github.com/hiero-ledger/hiero-mirror-node/pull/13977)
  * Bump the dependencies group in /rosetta with 2 updates [#13976](https://github.com/hiero-ledger/hiero-mirror-node/pull/13976)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.5 to 1.1.6 [#13975](https://github.com/hiero-ledger/hiero-mirror-node/pull/13975)
  * Bump io.cucumber:cucumber-bom from 7.34.4 to 7.34.6 [#13974](https://github.com/hiero-ledger/hiero-mirror-node/pull/13974)
  * Bump software.amazon.awssdk:bom from 2.49.1 to 2.49.3 [#13973](https://github.com/hiero-ledger/hiero-mirror-node/pull/13973)
  * Bump org.openapitools:openapi-generator-gradle-plugin from 7.23.0 to 7.24.0 [#13972](https://github.com/hiero-ledger/hiero-mirror-node/pull/13972)
  * Bump com.gradleup.shadow:shadow-gradle-plugin from 9.6.0 to 9.6.1 [#13971](https://github.com/hiero-ledger/hiero-mirror-node/pull/13971)
  * Bump org.graalvm.nativeimage:svm from 25.0.3 to 25.0.4 [#13970](https://github.com/hiero-ledger/hiero-mirror-node/pull/13970)
  * Bump com.hedera.cryptography:hedera-cryptography-wraps from 3.12.0 to 3.13.0 [#13969](https://github.com/hiero-ledger/hiero-mirror-node/pull/13969)
  * Bump versions for v0.161.0-SNAPSHOT [#13965](https://github.com/hiero-ledger/hiero-mirror-node/pull/13965)
  * Bump consensusNodeVersion from 0.75.0-rc.5 to 0.76.1 [#13755](https://github.com/hiero-ledger/hiero-mirror-node/pull/13755)
</Accordion>

## [v0.160.1](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.160.1)

Fix infinite loop in FixEvmTransactionIndexMigration (0.160) [#14011]



## [v0.160.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.160.0)
...
<Accordion title="Enhancements">
  * Add per endpoint request timeout (0.160) [#13997](https://github.com/hiero-ledger/hiero-mirror-node/pull/13997)
  * Remove `AccountBalanceQuery` from acceptance tests [#13954](https://github.com/hiero-ledger/hiero-mirror-node/pull/13954)
  * Approve NPM scripts to avoid warning [#13914](https://github.com/hiero-ledger/hiero-mirror-node/pull/13914)
  * Test native images in CI [#13908](https://github.com/hiero-ledger/hiero-mirror-node/pull/13908)
  * Validate deployment workflow [#13906](https://github.com/hiero-ledger/hiero-mirror-node/pull/13906)
  * Fix contract_result and contract_log transaction_index to use EVM-only ordering [#13657](https://github.com/hiero-ledger/hiero-mirror-node/pull/13657)
</Accordion>

<Accordion title="Bug Fixes">
  * Change cryptoAllowance.feature to use different account (0.160.0) [#13998](https://github.com/hiero-ledger/hiero-mirror-node/pull/13998)
  * Fix monitor not publishing [#13964](https://github.com/hiero-ledger/hiero-mirror-node/pull/13964)
  * Fix block stream parsing of contractresult.amount [#13957](https://github.com/hiero-ledger/hiero-mirror-node/pull/13957)
  * Improve entity ID parsing [#13955](https://github.com/hiero-ledger/hiero-mirror-node/pull/13955)
  * Fix monitor node validation not retrying [#13948](https://github.com/hiero-ledger/hiero-mirror-node/pull/13948)
  * Use random healthy node provided by SDK [#13946](https://github.com/hiero-ledger/hiero-mirror-node/pull/13946)
  * Fix entity type keys in cache [#13929](https://github.com/hiero-ledger/hiero-mirror-node/pull/13929)
  * Fix missing curl on healthcheck [#13911](https://github.com/hiero-ledger/hiero-mirror-node/pull/13911)
  * Fix root hash calculation over merkle paths in StateProof [#13894](https://github.com/hiero-ledger/hiero-mirror-node/pull/13894)
  * Fix k6 dashboard summary table [#13889](https://github.com/hiero-ledger/hiero-mirror-node/pull/13889)
  * Decrement crypto allowance when spender is smart contract [#13808](https://github.com/hiero-ledger/hiero-mirror-node/pull/13808)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Update native image versions [#13953](https://github.com/hiero-ledger/hiero-mirror-node/pull/13953)
  * Bump google.golang.org/grpc from 1.81.1 to 1.82.1 in /rosetta [#13952](https://github.com/hiero-ledger/hiero-mirror-node/pull/13952)
  * Bump google.golang.org/grpc from 1.81.1 to 1.82.1 in /pinger [#13951](https://github.com/hiero-ledger/hiero-mirror-node/pull/13951)
  * Update security dependencies [#13949](https://github.com/hiero-ledger/hiero-mirror-node/pull/13949)
  * Bump the dependencies group across 1 directory with 3 updates [#13930](https://github.com/hiero-ledger/hiero-mirror-node/pull/13930)
  * Bump the dependencies group with 4 updates [#13927](https://github.com/hiero-ledger/hiero-mirror-node/pull/13927)
  * Bump `@google-cloud`/logging from 11.2.3 to 11.3.0 in /tools/log-downloader in the dependencies group [#13926](https://github.com/hiero-ledger/hiero-mirror-node/pull/13926)
  * Bump org.bouncycastle:bcpkix-jdk18on from 1.84 to 1.85 [#13924](https://github.com/hiero-ledger/hiero-mirror-node/pull/13924)
  * Bump com.hedera.cryptography:hedera-cryptography-wraps from 3.11.2 to 3.12.0 [#13922](https://github.com/hiero-ledger/hiero-mirror-node/pull/13922)
  * Bump software.amazon.awssdk:bom from 2.47.5 to 2.48.3 [#13921](https://github.com/hiero-ledger/hiero-mirror-node/pull/13921)
  * Bump org.cyclonedx:cyclonedx-gradle-plugin from 3.2.4 to 3.3.0 [#13920](https://github.com/hiero-ledger/hiero-mirror-node/pull/13920)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.4 to 1.1.5 [#13919](https://github.com/hiero-ledger/hiero-mirror-node/pull/13919)
  * Bump com.gradleup.shadow:shadow-gradle-plugin from 9.5.1 to 9.6.0 [#13918](https://github.com/hiero-ledger/hiero-mirror-node/pull/13918)
  * Bump org.hiero.block-node:protobuf-sources from 0.38.0 to 0.38.1 [#13917](https://github.com/hiero-ledger/hiero-mirror-node/pull/13917)
  * Bump Jackson versions [#13910](https://github.com/hiero-ledger/hiero-mirror-node/pull/13910)
  * Bump hedera-app to 0.75.1 [#13909](https://github.com/hiero-ledger/hiero-mirror-node/pull/13909)
  * Bump httpclient5 from 5.6.1 to 5.6.2 [#13907](https://github.com/hiero-ledger/hiero-mirror-node/pull/13907)
  * Bump the dependencies group with 3 updates [#13905](https://github.com/hiero-ledger/hiero-mirror-node/pull/13905)
  * Bump the dependencies group in /rest with 2 updates [#13902](https://github.com/hiero-ledger/hiero-mirror-node/pull/13902)
  * Bump parse-duration from 2.1.6 to 2.1.8 in /rest/monitoring in the dependencies group [#13901](https://github.com/hiero-ledger/hiero-mirror-node/pull/13901)
  * Bump com.gradleup.shadow:shadow-gradle-plugin from 9.4.3 to 9.5.1 [#13900](https://github.com/hiero-ledger/hiero-mirror-node/pull/13900)
  * Bump org.hiero.block-node:protobuf-sources from 0.37.0 to 0.38.0 [#13899](https://github.com/hiero-ledger/hiero-mirror-node/pull/13899)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.3 to 1.1.4 [#13898](https://github.com/hiero-ledger/hiero-mirror-node/pull/13898)
  * Bump com.hedera.hashgraph:sdk from 2.73.0 to 2.74.0 [#13897](https://github.com/hiero-ledger/hiero-mirror-node/pull/13897)
  * Bump org.flywaydb:flyway-database-postgresql from 12.10.0 to 12.11.0 [#13896](https://github.com/hiero-ledger/hiero-mirror-node/pull/13896)
  * Bump software.amazon.awssdk:bom from 2.46.21 to 2.47.5 [#13895](https://github.com/hiero-ledger/hiero-mirror-node/pull/13895)
  * Bump tool dependencies [#13891](https://github.com/hiero-ledger/hiero-mirror-node/pull/13891)
  * Bump Go from 1.26.4 to 1.26.5 [#13890](https://github.com/hiero-ledger/hiero-mirror-node/pull/13890)
  * Bump versions for v0.160.0-SNAPSHOT [#13882](https://github.com/hiero-ledger/hiero-mirror-node/pull/13882)
</Accordion>

## [v0.159.2](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.159.2)

<Accordion title="Bug Fixes">
  * Improve entity ID parsing (0.159) [#13956](https://github.com/hiero-ledger/hiero-mirror-node/pull/13956)
</Accordion>

## [v0.159.1](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.159.1)

<Accordion title="Bug Fixes">
  * Fix entity type keys in cache (#13929) [#13932](https://github.com/hiero-ledger/hiero-mirror-node/pull/13932)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Bump Jackson versions (0.159) [#13933](https://github.com/hiero-ledger/hiero-mirror-node/pull/13933)
</Accordion>
...
<Accordion title="Bug Fixes">
  * Fix slow query in grpc API (0.158) [#13871](https://github.com/hiero-ledger/hiero-mirror-node/pull/13871)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Bump vulnerable dependencies and fix web3 build (0.158) [#13872](https://github.com/hiero-ledger/hiero-mirror-node/pull/13872)
</Accordion>

## [v0.158.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.158.0)
...
<Accordion title="Enhancements">
  * Remove simple fees workaround in acceptance tests [#13790](https://github.com/hiero-ledger/hiero-mirror-node/pull/13790)
  * WRB differential test [#13764](https://github.com/hiero-ledger/hiero-mirror-node/pull/13764)
  * Disable testkube test artifactRequest when pushing metrics [#13744](https://github.com/hiero-ledger/hiero-mirror-node/pull/13744)
  * Log API response time in acceptance tests [#13728](https://github.com/hiero-ledger/hiero-mirror-node/pull/13728)
  * Common chart alerting cleanups [#13727](https://github.com/hiero-ledger/hiero-mirror-node/pull/13727)
  * Adjustments to a couple of alerts [#13709](https://github.com/hiero-ledger/hiero-mirror-node/pull/13709)
  * Implement state overrides for contract calls [#13545](https://github.com/hiero-ledger/hiero-mirror-node/pull/13545)
</Accordion>

<Accordion title="Bug Fixes">
  * Fix INSUFFICIENT_TX_FEE error on contract create (0.158.0) [#13832](https://github.com/hiero-ledger/hiero-mirror-node/pull/13832)
  * Fix public key recovery in native image (0.158) [#13837](https://github.com/hiero-ledger/hiero-mirror-node/pull/13837)
  * Add validation message in GRPC that can resolve for native image build (0.158) [#13825](https://github.com/hiero-ledger/hiero-mirror-node/pull/13825)
  * Fix broken lazy database pool connection in rosetta (0.158) [#13822](https://github.com/hiero-ledger/hiero-mirror-node/pull/13822)
  * Change hollow account Ethereum transaction signer [#13794](https://github.com/hiero-ledger/hiero-mirror-node/pull/13794)
  * Fix web3 native image [#13793](https://github.com/hiero-ledger/hiero-mirror-node/pull/13793)
  * Fix rest chainId property conversion [#13782](https://github.com/hiero-ledger/hiero-mirror-node/pull/13782)
  * Fix null from and make contract results main and synthetic query parallel [#13774](https://github.com/hiero-ledger/hiero-mirror-node/pull/13774)
  * Fix copy live environment script issues [#13772](https://github.com/hiero-ledger/hiero-mirror-node/pull/13772)
  * Fix ecdsa recover in native image [#13746](https://github.com/hiero-ledger/hiero-mirror-node/pull/13746)
  * Refactor contract/results synthetic result query to prevent full scan in v2 [#13737](https://github.com/hiero-ledger/hiero-mirror-node/pull/13737)
  * Fix importer native image [#13735](https://github.com/hiero-ledger/hiero-mirror-node/pull/13735)
  * Fix rest monitor check failure [#13734](https://github.com/hiero-ledger/hiero-mirror-node/pull/13734)
  * Fix pending reward deduction logic for accounts staking for over 365 days [#13706](https://github.com/hiero-ledger/hiero-mirror-node/pull/13706)
</Accordion>

<Accordion title="Dependency Upgrades">
  * Bump vulnerable dependencies (0.158) [#13839](https://github.com/hiero-ledger/hiero-mirror-node/pull/13839)
  * Bump the dependencies group with 3 updates [#13806](https://github.com/hiero-ledger/hiero-mirror-node/pull/13806)
  * Bump the dependencies group in /rosetta with 3 updates [#13803](https://github.com/hiero-ledger/hiero-mirror-node/pull/13803)
  * Bump software.amazon.awssdk:bom from 2.46.15 to 2.46.17 [#13802](https://github.com/hiero-ledger/hiero-mirror-node/pull/13802)
  * Bump com.asarkar.grpc:grpc-test from 2.0.0 to 2.0.1 [#13801](https://github.com/hiero-ledger/hiero-mirror-node/pull/13801)
  * Bump gradle-wrapper from 9.6.0 to 9.6.1 [#13798](https://github.com/hiero-ledger/hiero-mirror-node/pull/13798)
  * Bump io.cucumber:cucumber-bom from 7.34.3 to 7.34.4 [#13796](https://github.com/hiero-ledger/hiero-mirror-node/pull/13796)
  * Bump com.gradleup.shadow:shadow-gradle-plugin from 9.4.2 to 9.4.3 [#13795](https://github.com/hiero-ledger/hiero-mirror-node/pull/13795)
  * Bump Jackson 2 and Java versions [#13785](https://github.com/hiero-ledger/hiero-mirror-node/pull/13785)
  * Bump github.com/opencontainers/runc from 1.2.8 to 1.3.6 in /rosetta [#13770](https://github.com/hiero-ledger/hiero-mirror-node/pull/13770)
  * Bump the dependencies group with 2 updates [#13762](https://github.com/hiero-ledger/hiero-mirror-node/pull/13762)
  * Bump `@google-cloud`/logging from 11.2.2 to 11.2.3 in /tools/log-downloader in the dependencies group [#13760](https://github.com/hiero-ledger/hiero-mirror-node/pull/13760)
  * Bump the dependencies group in /rest with 4 updates [#13759](https://github.com/hiero-ledger/hiero-mirror-node/pull/13759)
  * Bump com.diffplug.spotless:spotless-plugin-gradle from 8.6.0 to 8.7.0 [#13758](https://github.com/hiero-ledger/hiero-mirror-node/pull/13758)
  * Bump software.amazon.awssdk:bom from 2.46.10 to 2.46.15 [#13757](https://github.com/hiero-ledger/hiero-mirror-node/pull/13757)
  * Bump gradle-wrapper from 9.5.1 to 9.6.0 [#13756](https://github.com/hiero-ledger/hiero-mirror-node/pull/13756)
  * Bump org.gaul:s3proxy from 3.1.0 to 3.2.0 [#13754](https://github.com/hiero-ledger/hiero-mirror-node/pull/13754)
  * Bump org.flywaydb:flyway-database-postgresql from 12.8.1 to 12.9.0 [#13753](https://github.com/hiero-ledger/hiero-mirror-node/pull/13753)
  * Bump jooqVersion from 3.21.5 to 3.21.6 [#13752](https://github.com/hiero-ledger/hiero-mirror-node/pull/13752)
  * Bump form-data from 2.5.5 to 2.5.6 in /tools/log-downloader [#13748](https://github.com/hiero-ledger/hiero-mirror-node/pull/13748)
  * Update vulnerable rest dependencies [#13745](https://github.com/hiero-ledger/hiero-mirror-node/pull/13745)
  * Update PostgreSQL in GCP Marketplace [#13729](https://github.com/hiero-ledger/hiero-mirror-node/pull/13729)
  * Bump versions for v0.158.0-SNAPSHOT [#13723](https://github.com/hiero-ledger/hiero-mirror-node/pull/13723)
  * Bump the dependencies group across 1 directory with 3 updates [#13722](https://github.com/hiero-ledger/hiero-mirror-node/pull/13722)
  * Bump com.hedera.cryptography:hedera-cryptography-wraps from 3.8.1 to 3.9.0 [#13714](https://github.com/hiero-ledger/hiero-mirror-node/pull/13714)
  * Bump org.graalvm.buildtools:native-gradle-plugin from 1.1.1 to 1.1.2 [#13712](https://github.com/hiero-ledger/hiero-mirror-node/pull/13712)
</Accordion>
...
## [v0.156.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.156.0)
...
## [v0.155.1](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.155.1)

<Accordion title="Bug Fixes">
  * Fix bad grammar in `RecordFileConsensusTimestampsRecalculateMigration` #13623
</Accordion>

## [v0.155.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.155.0)

[HIP-1261](https://hips.hedera.com/#hip-1261) Simple fees is now enabled by default on our `/api/v1/contracts/call` endpoint. This behavior matches the behavior of the consensus node after the recent rollout of v0.73.0 to mainnet.
...
Support for Ethereum Pectra via [HIP-1340](https://hips.hedera.com/#hip-1340) and [HIP-1341](https://hips.hedera.com/#hip-1341) was improved in this release. The importer can now persist the EOA code delegation information. Additionally, the contract REST APIs now work with account IDs since with the advent of EOA delegation accounts can behave in a similar way as contracts.
...
<Accordion title="Bug Fixes">
  ...
  * Adjust `record_file` consensus start and end timestamps migration (0.155) #13592
  * Fix native image builds (0.155) #13578
...
<Accordion title="Dependency Upgrades">
  ...
  * Bump `@protobufjs`/utf8 from 1.1.0 to 1.1.1 in /rest #13528
  * Bump github.com/hiero-ledger/hiero-sdk-go/v2 from 2.79.0 to 2.80.0 in /pinger in the dependencies group #13518
...
## [v0.154.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.154.0)
...
Support for [HIP-1427](https://hips.hedera.com/hip/hip-1427) Historical Record File Wrapping advanced with a change to allow record stream files with zero transactions inside. This was necessary as a side effect of aligning block stream and record stream blocks.
...
<Accordion title="Enhancements">
  ...
  * HIP-1137 Add associated_registered_nodes to `/api/v1/network/nodes` #13361
  * Show block nodes in registered nodes API response #13352
...
## [v0.153.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.153.0)
 
[HIP-1313](https://hips.hedera.com/hip/hip-1313) High-Volume Entity Creation is now fully delivered with this release. The `high_volume_pricing_multiplier` field was added to the `/api/v1/transactions`, `/api/v1/transactions/{id}`, and `/api/v1/accounts/{id}` REST APIs. This field shows the multiplier that was applied to the transaction fees if the high volume flag was set in the transaction body. Additionally, a new `high_volume_throttle` query parameter is added to the fee estimate API to estimate the effects of having a high volume multiplier applied. This parameter is measured in basis points and can be in the range 0 to 10000 where 10000 is equivalent to 100.00%. A `high_volume_multiplier` was added to the fee estimate response and all other fees in the response are adjusted accordingly.
 
A large focus of this release was geared towards block node related work. [HIP-1193](https://hips.hedera.com/hip/hip-1193) support was reworked to support the new intermediate cut-over approach of streaming wrapped record blocks (WRBs) from block nodes while falling back to the existing bucket in case of an error. Speaking of WRBs, [HIP-1427](https://hips.hedera.com/hip/hip-1427) saw further refinement with support for sidecar files, amendments/errata, and signature verification. [HIP-1137](https://hips.hedera.com/hip/hip-1137) saw an `associated_registered_nodes` field added to `/api/v1/network/nodes`. Finally, a new `/api/v1/network/registered-nodes` REST API was added. Below is an example response:
...
## [v0.152.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.152.0)
 
Having not been reset in over two years, testnet would take a long time for a mirror node to synchronize from genesis. To ease this burden, we now offer database snapshots for the testnet environment. The [bootstrap tool](https://github.com/hiero-ledger/hiero-mirror-node/blob/main/docs/database/bootstrap.md) has been updated to reflect this.
 
Work continues towards full block stream compatibility via support for a number of related HIPs. The new general service endpoint was added for [HIP-1137](https://hips.hedera.com/hip/hip-1137) Block Node Discoverability. Additionally, the importer can now automatically watch for registered node transactions and update its list of subscribed block node endpoints. The mirror node now has basic support for [HIP-1427](https://hips.hedera.com/hip/hip-1427) Wrapped Record Blocks as we work towards adding sidecars, signature verification, and amendments in the next release.
 
Support for [HIP-1261](https://hips.hedera.com/hip/hip-1261) Simple Fees continues to gain steam with the addition of a new state mode to the `/api/v1/network/fees` estimation API. This mode differs from the default intrinsic mode by querying state for the given transaction details. Work was also completed to support simple fees via the `/api/v1/contracts/call` REST API.
 
A new `delegation_address` field was added to the account REST APIs as defined in [HIP-1340](https://hips.hedera.com/hip/hip-1340) EOA Code Delegation. The contract result REST APIs saw the addition of a new `authorization_list` field to improve support for Ethereum's Pectra upgrade. Finally, the `/api/v1/contracts/call` saw initial support for Pectra code delegations. Most of this work is behind a feature flag and will be enabled at a later time when consensus nodes finalize their support for Pectra.
 
There has been a large push to reduce our application memory, CPU, and image sizes to improve our resource usage in [Solo](https://github.com/hiero-ledger/solo). Towards that end, we have added initial [GraalVM](https://www.graalvm.org) integration to compile our Java-based modules (gRPC, Importer, REST Java, and Web3) to native code. This dramatically improves our overall startup time for all modules from 59s to 14s. Memory-wise, it reduced the amount of memory consumed to 33% of its original. The overall memory footprint in Solo-based environments went from around 2 GiB down to 600 MiB. Preliminary results show a CPU reduction as well, but we're still quantifying exactly how much. In the next release, we'll start publishing official native images in GHCR so others can take advantage of these gains. Additionally, we integrated esbuild into the node.js based REST API to tree-shake its dependencies, resulting in a memory reduction from 285 MiB down to 150 MiB.
...
## [v0.151.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.151.0)

Support for [HIP-1261](https://hips.hedera.com/HIP/hip-1261) Simple Fees saw support for full intrinsic mode estimation added to our fee estimationPOST `/api/v1/network/fees` API. The next release should additionally bring support for stateful mode.
...
<Accordion title="Enhancements">
  ...
  * HIP-1340 Adapt CryptoUpdateTransactionHandler for code delegation #13065
  * Optimize the performance of opcode web3 endpoint #13062
  * HIP-1340 Adapt CryptoCreateTransactionHandler for code delegation #13061
  * Stored weibars in db and expose via API #13023
...
<Accordion title="Enhancements">
  ...
  * Add throttling to /opcodes endpoint #13016
  * Remove stateproof alpha REST API #13015
...
<Accordion title="Dependency Upgrades">
  ...
  * Update multer and @tootallnate/once #13084
  * Bump the dependencies group with 4 updates #13083
  ...
  * Remove @trufflesuite/bigint-buffer dependency #13006
  * Bump the dependencies group in /rest with 2 updates #13005
...
## [v0.147.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.147.0)
...
[HIP-1195](https://hips.hedera.com/hip/hip-1195) had some updates to make it compatible with the block stream. We also integrated the upstream changes to rename `LambdaSStore` to `HookStore`.
...
## [v0.146.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.146.0)

Support for [HIP-1259](https://hips.hedera.com/hip/hip-1259) fee collection account `0.0.802` was added. Once live on mainnet, this should help reduce the size of the mirror node database by sending fees to a single account on every transaction and instead distributing fees to nodes and system accounts once per day.

New block node specific metrics `hiero.mirror.importer.stream.latency` and `hiero.mirror.importer.stream.error` were added for [HIP-1081](https://hips.hedera.com/hip/hip-1081). These metrics previously existed for record streams and were implemented in block streams to reach feature parity. 
Support for streaming from the earliest available block was added. If `hiero.mirror.importer.startBlockNumber` is set to `-1` and the database is empty, then the importer will query the configured block node to determine what's the earliest block it has available to use. 
If a non-negative number is set then it will sync from that exact block as before. Finally, an issue with reading trailing non-transaction statechanges in an event was also addressed.

[HIP-1195](https://hips.hedera.com/hip/hip-1195) hooks had acceptance tests added to support end to end testing of the feature. An issue with duplicate keys was addressed by de-duplicating lambda storage updates.
...
hiero.mirror.web3.evm.modularizedTrafficPercent
```
Operators should determine if any of these properties were specified in their deployments and take appropriate action. While these properties were removed, a lot of them can still be set if needed by consensus node specific properties passed via `hiero.mirror.web3.evm.properties`.

**Full GitHub Release Notes**: [v0.146.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.146.0)

## [v0.145.1](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.145.1)

[HIP-1261](https://hips.hedera.com/hip/hip-1261) Simple Fees saw a new REST API added to support estimating network fees. The new POST `/api/v1/network/fees` REST API takes as input a serialized [Transaction](https://github.com/hiero-ledger/hiero-consensus-node/blob/main/hapi/hedera-protobuf-java-api/src/main/proto/services/transaction.proto) protobuf object in the request body with either `application/protobuf` or `application/x-protobuf` `Content-Type` header and produces a break down of estimated network fees. Not that this API is currently not implemented and just returns dummy data so it should not be used in production. Interested parties can use it to start integrating early so that they're ready for when we integrate the upstream fee estimation library in a future release.
...
## [v0.144.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.144.0)

This release implements a new REST API to support [HIP-1195](https://hips.hedera.com/hip/hip-1195) Hooks. The newly added `/api/v1/accounts/{id}/hooks/{hookId}/storage` returns the storage state for a hook. This endpoint is similar to the `/api/v1/contracts/{id}/state` REST API but for hook storage instead of contract storage. With this change, the hook implementation on mirror node is complete outside some acceptance test coverage still being worked on. Below is an example response:
...
[HIP-1056](https://hips.hedera.com/hip/hip-1056) continues to make progress as we incorporated the consensus node 0.68 protobuf. This includes support for `BlockFooter`, `BlockEnd`, multiple `BlockProof` items, and block items without transaction results.

## [v0.143.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.143.0)
...
## [v0.142.0](https://github.com/hiero-ledger/hiero-mirror-node/releases/tag/v0.142.0)

Support for [<u>HIP-1299</u>](https://hips.hedera.com/hip/hip-1299) node account ID updates was finalized in this release. When a node updates their account ID, it will now be reflected instantly in all APIs including the `getNodes` gRPC API, the `/network/status` Rosetta API, and the `/api/v1/network/nodes` REST API.

We now include support for [<u>HIP-1215</u>](https://hips.hedera.com/hip/hip-1215) generalized scheduled contract calls. The importer was adapted to handle scheduled contract calls that can be triggered in isolation without another unrelated user transaction preceding it. The latest consensus node library v0.68 was integrated, bringing with it support for the new system contracts defined in HIP-1215. This includes the `scheduleCall`, `scheduleCallWithPayer`, `executeCallOnPayerSignature`, `deleteSchedule`, and `hasScheduleCapacity` functions defined in `IHederaScheduleService`.

[<u>HIP-1056</u>](https://hips.hedera.com/hip/hip-1056) block streams continues to see progress with support for calculating the ethereum transaction hash and reconstructing the contract bytecode added. A large number of other bugs were addressed as a result of our differential testing.

The code base now integrates the [<u>JSpecify</u>](https://jspecify.dev/) standard. JSpecify provides standard nullability annotations and static code analysis tools to help reduce the use of nulls in your code. Existing null annotations from javax, Jakarta, Spring, findbugs, etc. were converted to the equivalent JSpecify annotation. The Gradle build was updated to integrate [<u>NullAway</u>](https://github.com/uber/NullAway) which will fail the build if a potential `NullPointerException` is detected. Currently it's set to assume null by default as we work towards a non-null by default throughout the code base.
...
This is a testing focused release with a number of changes that improve our test coverage. A new GitHub Actions workflow was added to build and test our acceptance tests end-to-end. This workflow leverages [Solo](https://github.com/hiero-ledger/solo/) to stand up a consensus node and mirror node in Kubernetes with the proper configuration. In addition, we also run the same suite of tests but using block node instead of record streams. A similar workflow was added to the consensus node repository as part of their extended test suite to gate their release process.
...
configuring and executing a [script](https://github.com/hashgraph/hedera-mirror-node/blob/v0.96.0/hedera-mirror-importer/src/main/resources/db/scripts/init-temp-schema.sh) **_before_** the upgrade.
...
With the recent [testnet reset](/networks/testnet#test-network-resets) that occurred on 2023-07-27, a new cloud storage bucket was created to store the stream files generated by the consensus nodes. This release will now use that updated bucket name by default when the network is set to testnet.
