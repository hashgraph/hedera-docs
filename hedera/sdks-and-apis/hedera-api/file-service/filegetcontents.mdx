...
description: "Get the contents of a file. The content field is empty (no bytes) if the file is empty. Response when the client sends the node FileGetContentsQuery"
---
