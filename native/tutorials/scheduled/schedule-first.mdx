...
description: "Create and sign your first Hedera scheduled transaction using the Hedera SDK, enabling multi-party signing of any Hedera transaction with low fees."
---
