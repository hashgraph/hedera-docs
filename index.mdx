...
description: "Build on Hedera with developer guides, SDK references, EVM and Solidity tutorials, mirror node REST APIs, protobuf specs, and node operator docs."
mode: "custom"
---
...
{/* ═══════════════════════════════════════════════════════════════════════════
    ...
    Root home page uses `mode: custom` (no side nav), so the "Explore the docs"
    directory grid below is the primary navigation entry point — unlike tab
    landing pages where the side nav covers that role.
    ═══════════════════════════════════════════════════════════════════════════ */}
