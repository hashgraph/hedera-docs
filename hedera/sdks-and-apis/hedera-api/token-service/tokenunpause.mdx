---
title: "TokenUnpause"
description: 'TokenUnpause transaction protobuf reference for unpausing a Hedera Token Service token; must be signed by the token pause key to resume operations.'
---
