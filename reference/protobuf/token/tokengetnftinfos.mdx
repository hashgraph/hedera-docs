...
description: "Hedera protobuf reference for the TokenGetNftInfos query used to retrieve information for a range of non-fungible HTS token serials of a Hedera token."
---
...
| `tokenID` | [TokenID](/reference/protobuf/basic-types/tokenid)           | The ID of the token for which information is requested                                                                                             |
...
| `tokenID` | [TokenID](/reference/protobuf/basic-types/tokenid)                        | The Token with type `NON_FUNGIBLE` that this record is for                                                       |
| `nfts`    | repeated [TokenNftInfo](/reference/protobuf/token/tokengetnftinfo#tokennftinfo) | List of NFTs associated to the specified token                                                                   |
