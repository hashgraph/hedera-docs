...
description: "Wrap and unwrap HBAR as an ERC-20 token with the WHBAR contract on Hedera to integrate native HBAR into DeFi protocols and EVM-based dApps."
---
