  ...
  <div className="landing-grid">
    ...
    <a href="/native/quickstart/go" className="landing-card">
      ...
      <div>
        ...
        <div className="landing-card-desc">`go get github.com/hiero-ledger/hiero-sdk-go/v2@latest`.</div>
      </div>
    </a>
...
<div className="landing-section">
  ...
  <div className="landing-grid landing-grid--wide">
    ...
    <a href="/native/local-dev/index" className="landing-card">
      <div className="landing-card-icon">
      ...
      <div>
        ...
        <div className="landing-card-desc">Run a full Hedera network on your laptop: consensus, mirror, relay, explorer.</div>
      </div>
    </a>
    ...
    <a href="/native/local-dev/setup-cli-npm" className="landing-card">
      ...
      <div>
        <div className="landing-card-title">Solo CLI Setup</div>
        <div className="landing-card-desc">Install Solo via npm, deploy a network, and verify it from your terminal.</div>
      </div>
    </a>

    <a href="/native/fundamentals/local-network" className="landing-card">
      <div className="landing-card-icon">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
      </div>
      <div>
        <div className="landing-card-title">Connect an SDK</div>
        <div className="landing-card-desc">Point the JavaScript, Java, or Go SDK at your local network.</div>
      </div>
    </a>
