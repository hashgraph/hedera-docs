...
description: "Applicable only to tokens of type NONFUNGIBLEUNIQUE. Gets info on NFTs N through M on the list of NFTs associated with a given NONFUNGIBLEUNIQUE Token."
---
