...
description: "Delete a pending Hedera scheduled transaction with ScheduleDeleteTransaction using the admin key, preventing execution before its expiration time."
---
