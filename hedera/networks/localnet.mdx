---
title: Localnet
description: "The Hedera Localnet provides developers with a comprehensive framework for locally testing and refining Hedera-based applications."
...
* [**Mirror Node**](/hedera/support-and-community/glossary#mirror-nodes)**:** Provides access to the historical data, transaction records, and the current state of the network without participating in consensus. This is useful for querying and analytics.
* [**JSON-RPC Relay**](/hedera/support-and-community/glossary#json-rpc-relay): Offers a local JSON-RPC implementation of the [Ethereum](/hedera/support-and-community/glossary#ethereum) JSON-RPC APIs for Hedera to enable interactions with smart contracts and accounts. This is particularly useful for developers familiar with Ethereum tooling and ecosystem.
* [**Mirror Node Explorer**](/hedera/support-and-community/glossary#network-explorer): A web-based interface that allows developers to audit transactions, accounts, and other network activities visually.
...
➡ [**Single Node Configuration**](/hedera/networks/localnet/single-node-configuration)

➡ [**Multinode Configuration**](/hedera/networks/localnet/multinode-configuration)
...
* [**Run a Local Node in Gitpod**](/hedera/tutorials/local-node/how-to-run-hedera-local-node-in-a-cloud-development-environment-cde/gitpod) **\[tutorial]**
* [**Run a Local Node in Codespaces**](/hedera/tutorials/local-node/how-to-run-hedera-local-node-in-a-cloud-development-environment-cde/codespaces) **\[tutorial]**
