...
description: "Learn how Hedera separates current state from transaction history, how the replicated state machine works, and how nodes apply consensus-ordered transactions."
---
