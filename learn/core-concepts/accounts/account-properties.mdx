...
description: "Reference for every Hedera account property: account ID, keys, balance, memo, auto-renew period, staking, max automatic token associations, and more."
---
...
* `CryptoTransfer` Transactions: When transferring value via the SDK, any of the following account identifiers can be used:
  * Standard Hedera account ID, on mainnet `0.0.<num>` (e.g., `0.0.1234`)
...
<Accordion title="EVM Address from Public Key Account ID Example">
