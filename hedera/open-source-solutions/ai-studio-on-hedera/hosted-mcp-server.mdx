...
description: "The Hedera Hosted MCP Server provides a managed, remote instance of the Hedera Agent Kit exposing its tools via the Model Context Protocol (MCP)."
