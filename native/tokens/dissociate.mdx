...
description: "Dissociate Hedera Token Service tokens from an account with TokenDissociateTransaction so the account no longer holds a relationship with those token IDs."
---
