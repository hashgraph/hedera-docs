...
description: "A ScheduleCreateTransaction is a consensus node transaction that creates a schedule entity on the Hedera network. The entity ID for a schedule transaction is."
---
