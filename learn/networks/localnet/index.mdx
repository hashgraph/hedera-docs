---
title: "Localnet"
description: "Run a Hedera localnet for local development and testing using Local Node or Solo, then progress to previewnet and testnet before deploying to mainnet."
---
