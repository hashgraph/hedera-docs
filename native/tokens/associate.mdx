...
description: "Associate fungible tokens or NFTs with a Hedera account using TokenAssociateTransaction so the account can hold and transfer Hedera Token Service assets."
---
