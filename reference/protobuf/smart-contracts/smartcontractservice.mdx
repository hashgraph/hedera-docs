...
description: "Hedera protobuf reference describing the SmartContractService gRPC definition and its endpoints for deploying, calling, updating, and querying smart contracts."
---
