...
description: "Send fungible tokens or NFTs to multiple Hedera accounts in one TokenAirdrop transaction, with pending airdrops when auto-association slots are unavailable."
---
