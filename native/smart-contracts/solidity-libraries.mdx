...
description: "Hedera service Solidity libraries for HTS, HCS, and response codes that let smart contracts call native services like token transfers from Solidity code."
---
...
<Card
  title="Fees"
  href="/learn/networks/mainnet/fees"
/>
