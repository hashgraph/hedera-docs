...
An excerpt from the [NFT minting tutorial](/hedera/tutorials/token/create-and-transfer-your-first-nft#2.-mint-a-new-nft) shows this connection when minting a new NFT.
