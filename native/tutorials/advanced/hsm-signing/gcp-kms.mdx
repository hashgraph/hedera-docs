...
description: "Use a Google Cloud HSM-backed secp256k1 key to sign Hedera transactions from a Node.js app, keeping private keys protected inside Google Cloud KMS."
---
