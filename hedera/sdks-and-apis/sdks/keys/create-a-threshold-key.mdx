...
description: 'Create a Hedera threshold key combining multiple Ed25519 or ECDSA secp256k1 keys, requiring a configurable number of signatures to authorize a transaction.'
---
