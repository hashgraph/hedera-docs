...
<iframe width="1124" height="632" src="https://www.youtube.com/embed/UBlppu3sJVg" title="Managing an ERC-721 Token Using Hardhat - Access Control, Token URI, Pausing, &amp; Transferring" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<Columns cols={2}>
  ...
  <Card
    title="Editor: Luis, Sr Software Developer"
    arrow
  >
