...
description: "Build LLM-powered applications that interact with the Hedera Network using Python. Create conversational agents that can understand user requests in natural."
---
...
> **Note**: See also the [JavaScript SDK documentation](/hedera/open-source-solutions/ai-studio-on-hedera/hedera-ai-agent-kit/hedera-agent-kit-js) for the JS/TypeScript version.
