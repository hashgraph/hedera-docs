...
description: "Hedera protobuf reference for the SchedulableTransactionBody message describing the subset of Hedera transaction types that can be wrapped in a schedule."
---
