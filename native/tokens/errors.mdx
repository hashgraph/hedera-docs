...
description: "Reference of Hedera Token Service response codes including INVALID_TOKEN_ID, TOKEN_WAS_DELETED, ACCOUNT_FROZEN_FOR_TOKEN, and token association errors."
---
