...
description: "Network response messages and error codes returned by the Hedera SDK for account and HBAR transfer operations, with their meanings and causes."
---
