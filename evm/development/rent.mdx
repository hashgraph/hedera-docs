...
description: "Smart contract rent on Hedera, not yet enabled, combines contract auto-renewal with storage payments for key-value pairs beyond the 100 free per contract."
---
...
<Accordion title="Why do contracts have to pay rent on Hedera?">
...
<Accordion title="Do all entities on Hedera have to pay rent or just contracts?">
...
<Accordion title="What charges are included in contract rent?">
...
<Frame>
  <img src="/images/core-concepts/smart-contracts/smart-contract-rent/smart-contract-rent-1.png" />
</Frame>
</Accordion>

<Accordion title="What are the steps in the renewal process? And what happens if a contract doesn’t pay rent?">
...
<Frame>
  <img src="/images/core-concepts/smart-contracts/smart-contract-rent/smart-contract-rent-2.png" />
</Frame>
</Accordion>

<Accordion title="How long is the grace period for expired contracts?">
The grace period between entity expiration and deletion is 30 days.
</Accordion>

<Accordion title="Who pays for the contract’s renewal and storage fees?">
...
<Accordion title="What happens if I call a contract that is expired?">
Calling an `expired` contract will resolve to `CONTRACT_EXPIRED_AND_AWAITING_REMOVAL`.
</Accordion>

<Accordion title="When a contract is expired and deleted from the network, what happens to its account and assets?">
...
<Accordion title="For how long can I renew my contract?">
...
<Accordion title="If I change the autoRenewPeriod of my contract from 30 to 90 days, what will the cost of my transaction be?">
...
<Accordion title="Where can I seen when a contract will expire?">
...
<Accordion title="Where do the auto-renewal transactions appear? Can these be seen on network explorers like HashScan?">
...
<Accordion title="Can the autoRenewAccount for a contract be set to another contract ID?">
Yes, that is possible for contracts.
</Accordion>

<Accordion title="What are the key-value pair thresholds that I should be aware of that impact the size of the storage payment?">
...
<Accordion title="For smart contracts created via CREATE2, how can I specify rent-related properties likeautorenewAccount and autorenewPeriod?">
