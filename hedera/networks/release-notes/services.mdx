...
description: "Visit the Hedera status page for the latest versions supported on each network. track RecordFileItem and log proof types in SimulatedBlockNodeServer #24946."
---
