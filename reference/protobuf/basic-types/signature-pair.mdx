---
title: "SignaturePair"
description: "Hedera protobuf reference for the SignaturePair message, pairing a public key prefix with its signature to authorize a Hedera Hashgraph transaction."
---
