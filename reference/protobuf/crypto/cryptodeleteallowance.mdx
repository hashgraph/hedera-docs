...
description: "Hedera protobuf reference for the CryptoDeleteAllowance message used to remove previously approved NFT allowances granted by an owner to a spender account."
---
