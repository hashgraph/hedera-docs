...
This is the example bytecode output, produced in hexadecimal format, when the [`HelloHedera`](broken-reference) smart contract source code is compiled.
...
This is the example ABI output produced when the [`HelloHedera`](broken-reference) smart contract is compiled.
