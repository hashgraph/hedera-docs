...
description: "In a digital world, real-world assets (RWAs) like stocks, bonds, and real estate are being turned into digital securities through asset tokenization."
...
to offer a comprehensive solution for managing [security tokens](/hedera/support-and-community/glossary#security-token). Additionally, ATS supports [ERC-3643](https://docs.hedera.com/hedera/support-and-community/glossary#erc-3643) integration for enhanced compliance and identity management through optional configuration of compliance smart contracts and identity registries. It
