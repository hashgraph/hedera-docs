...
description: "Use a Solidity contract to create, mint, and transfer Hedera NFTs by calling the HTS system contract through HederaTokenService.sol helper libraries."
---
