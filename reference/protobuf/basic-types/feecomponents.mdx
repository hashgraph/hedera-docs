---
title: "FeeComponents"
description: "FeeComponents is a Hedera protobuf message defining the node, network, and service fee components used to compute transaction and query fees."
---
