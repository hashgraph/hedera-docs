...
>
  The Hedera Foundation supports the growth of the Hedera ecosystem by funding projects, partnerships, and initiatives that drive adoption of the Hedera network.
</Card>
<Card
  title="Hashgraph"
...
>
  MetaMask is a web3 wallet to manage <a href="/hedera/support-and-community/glossary#digital-asset">digital assets</a>, interact with dApps, and participate in tokenized ecosystems on the Ethereum and EVM-compatible networks.
</Card>
<Card
  title="GFT"
