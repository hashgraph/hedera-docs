---
title: "Schedule ID"
description: "Hedera ScheduleId reference: the shard.realm.num identifier returned for a scheduled transaction, with constructors and string conversions for the SDK."
---
