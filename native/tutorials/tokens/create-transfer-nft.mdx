...
description: "Use the Hedera Token Service to create a non-fungible token class, mint NFT serial numbers with metadata, and transfer them between Hedera accounts."
---
