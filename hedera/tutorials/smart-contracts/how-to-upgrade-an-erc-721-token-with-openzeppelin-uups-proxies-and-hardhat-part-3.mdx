...
* ⚠️ **Complete** [**tutorial part 1**](/hedera/tutorials/smart-contracts/how-to-mint-and-burn-an-erc-721-token-using-hardhat-and-ethers-part-1) **as we continue from this example. Part 2 is optional.**
...
2. [Create Your Initial Upgradeable ERC-721 Contract](#step-2-create-your-initial-upgradeable-erc-721-contract)
3. [Deploy Your Upgradeable Contract](#step-3-deploy-your-upgradeable-contract)
4. [Upgrade Your ERC-721 Contract](#step-4-upgrade-your-erc-721-contract)
5. [Deploy the Upgrade and Verify](#step-5-deploy-the-upgrade-and-verify)
...
<iframe width="1124" height="632" src="https://www.youtube.com/embed/vI-9WTFMy7U" title="How To Upgrade an ERC-721 Token With OpenZeppelin UUPS Proxies &amp; Hardhat" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
