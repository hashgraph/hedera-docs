...
description: "Create a fungible token on Hedera with the Token Service, associate it with a second account, and transfer balances between accounts in a hands-on tutorial."
---
