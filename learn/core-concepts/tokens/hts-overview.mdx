...
description: "Overview of the Hedera Token Service (HTS) — native fungible tokens and NFTs with built-in compliance, atomic swaps, custom fees, and 10,000 TPS throughput."
