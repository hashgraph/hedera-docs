...
description: "Hedera protobuf reference for the TokenFreezeAccount transaction used by an HTS freeze key holder to freeze an account's holdings of a specific Hedera token."
---
