...
description: "Manually sign a Hedera transaction with one or more private keys after freezing, supporting multi-key accounts and offline signing workflows in the SDK."
---
