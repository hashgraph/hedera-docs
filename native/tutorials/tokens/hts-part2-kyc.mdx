---
title: "Hedera Token Service Part 2: KYC, update, and scheduled tx"
description: "Part 2 of the HTS tutorial series: grant and revoke KYC, update token properties with the admin key, and schedule HTS transfers using the Hedera SDK."
