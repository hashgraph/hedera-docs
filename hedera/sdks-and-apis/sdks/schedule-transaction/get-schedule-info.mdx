...
description: "For obtaining schedule information and historical data, consider using the Mirror Node REST API endpoint Get Schedule by ID which offers several advantages:"
---
