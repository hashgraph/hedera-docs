---
title: "FileUpdate"
description: "Hedera protobuf reference for the FileUpdate transaction used to modify a Hedera File Service file's contents, keys, expiration time, or memo field."
---
...
| ---------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| `fileID`         | [FileID](/reference/protobuf/basic-types/fileid)         | The ID of the file to update                                       |
| `expirationTime` | [Timestamp](/reference/protobuf/miscellaneous/timestamp) | The new expiry time (ignored if not later than the current expiry) |
| `keys`           | [KeyList](/reference/protobuf/basic-types/keylist)       | The new list of keys that can modify or delete the file            |
