...
2. [Creating the ERC-721 Contract](#step-2-creating-the-erc-721-contract)
3. [Deploy Your Smart Contract](#step-3-deploy-your-erc-721-smart-contract)
4. [Minting an NFT](#step-4-minting-an-nft)
5. [Adding the Burn Functionality](#step-5-adding-the-burn-functionality)
6. [Burning an NFT](#step-6-burning-an-nft)
7. [Run tests](#step-7-run-tests-optional)
...
<iframe width="1124" height="632" src="https://www.youtube.com/embed/B23aVhaCARU" title="How to Mint &amp; Burn an ERC-721 Token Using Hardhat &amp; Ethers" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
