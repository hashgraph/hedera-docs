---
title: "Fork Hedera with Foundry: basic ERC-20 contract (Part 1)"
description: "Fork Hedera testnet with Foundry to deploy an ERC-20 contract, read balances and metadata, and run forge tests against existing on-chain contracts."
