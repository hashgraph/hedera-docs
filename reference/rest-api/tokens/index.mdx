---
title: "Tokens"
description: "Mirror node REST API endpoints for Hedera tokens (HTS), covering fungible and NFT details, balances, supply, NFT metadata, and token transaction history."
---
