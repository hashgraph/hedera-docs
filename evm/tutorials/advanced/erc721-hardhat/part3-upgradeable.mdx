---
title: "Upgrade an ERC-721 with UUPS proxies and Hardhat (Part 3)"
description: "Make a Hedera ERC-721 NFT contract upgradeable using OpenZeppelin's UUPS proxy pattern and Hardhat, then deploy and verify the upgrade end to end."
---
