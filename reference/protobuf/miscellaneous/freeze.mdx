---
title: "Freeze"
description: "Hedera protobuf reference for the Freeze transaction used by network administrators to schedule a network freeze, upgrade, or maintenance window on Hedera."
---
...
| -------- | ----------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| `freeze` | Transaction | [TransactionResponse](/reference/protobuf/miscellaneous/transactionresponse) | Freezes the nodes by submitting the transaction. The grpc server returns the TransactionResponse |
