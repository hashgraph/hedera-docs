...
description: 'Reference for Hedera SDK specialized types including AccountId, ContractId, FileId, TokenId, and the shard, realm, and number components of entity IDs.'
---
