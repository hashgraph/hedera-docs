...
description: "Managing token decimals is critical when working with HBAR, HTS tokens, and ERC tokens on Hedera, as each system has distinct precision standards."
---
...
Reference: [**Smart Contracts Gas and Fees**](/hedera/core-concepts/smart-contracts/gas-and-fees)

***

### **Additional Resources**

* [**ERC-20 Token Standard**](/hedera/core-concepts/smart-contracts/tokens-managed-by-smart-contracts/erc-20-fungible-tokens)
* [**Hedera Token Service Documentation**](/hedera/core-concepts/tokens)
* [**HBAR Decimal Places Documentation**](/hedera/sdks-and-apis/sdks/hbars#hbar-decimal-places)
* [**Token Managed by Smart Contracts**](/hedera/core-concepts/smart-contracts/tokens-managed-by-smart-contracts)
