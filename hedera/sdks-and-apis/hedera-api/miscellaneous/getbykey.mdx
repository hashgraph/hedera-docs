---
title: "GetByKey"
description: "the ID for a single entity (account, claim, file, or smart contract instance). Get all accounts, claims, files, and smart contract instances whose associated."
---
