---
title: "FeeData"
description: "Hedera protobuf reference for the FeeData message, which aggregates node, network, and service FeeComponents used to charge a Hashgraph transaction."
---
