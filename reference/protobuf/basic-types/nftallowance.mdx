---
title: "NftAllowance"
description: "Hedera protobuf reference for the NftAllowance message, defining an approved non-fungible token transfer allowance granted by an owner to a spender."
---
