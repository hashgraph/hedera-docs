---
title: "Overview"
description: "The Hiero CLI is a command‑line interface that offers a simple way to interact with the Hedera network. It consolidates many common network operations into."
---
...
For a visual map of which Hedera capabilities the CLI covers today (and known gaps), see [Feature coverage and gaps](/hedera/open-source-solutions/hiero-cli/feature-coverage-gap-report).
...
<Card
  title="Swap Plugin"
  icon="puzzle-piece-simple"
  href="/hedera/open-source-solutions/hiero-cli/plugins/swap-plugin"
  horizontal
>
