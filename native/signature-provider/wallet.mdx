---
title: "Wallet"
description: "Wallet class in the Hedera JavaScript SDK that extends Signer, combining an account ID, private key, and Provider to sign and submit transactions."
---
