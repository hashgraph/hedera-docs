...
description: "Create and mint a Hedera NFT collection with royalty fees from a Solidity smart contract using the HTS system contract, IPFS metadata, and Hardhat."
---
