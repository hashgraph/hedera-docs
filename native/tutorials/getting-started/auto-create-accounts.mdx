...
description: "Auto-create Hedera accounts by sending HBAR or HTS tokens to a public-key alias, leveraging HIP-32 and HIP-542 to skip explicit account creation steps."
