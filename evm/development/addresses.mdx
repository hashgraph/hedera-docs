...
description: "Compare the EVM address and native contract ID used to reference a Hedera smart contract, and when to use each with Hardhat, MetaMask, or HashScan."
---
