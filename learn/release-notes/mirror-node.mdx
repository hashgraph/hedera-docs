...
description: "Release notes for the Hedera mirror node, covering REST API updates, performance improvements, breaking changes, and supported network versions."
---
