...
description: "The hashgraph consensus algorithm powers Hedera with fast, fair, and secure distributed consensus using gossip about gossip and virtual voting."
---
