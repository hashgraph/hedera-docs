...
description: "Part 1 of the Hedera Token Service series: mint and transfer NFTs on Hedera using the JavaScript SDK without writing or deploying a smart contract."
