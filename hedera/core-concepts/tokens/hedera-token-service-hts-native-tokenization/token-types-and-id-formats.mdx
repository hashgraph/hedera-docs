...
description: "The Hedera Token Service (HTS) supports multiple token types, enabling you to represent a wide range of digital assets-whether they're identical units of."
---
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-types-and-id-formats/token-types-and-id-formats-1.png" />
</Frame>
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-types-and-id-formats/token-types-and-id-formats-2.png" />
</Frame>
...
📌 `<shardNum>.<realmNum>.<tokenNum>/`*`<serialNum>`*
...
<Frame>
  <img src="/images/core-concepts/tokens/hedera-token-service-hts-native-tokenization/token-types-and-id-formats/token-types-and-id-formats-3.png" />
</Frame>
