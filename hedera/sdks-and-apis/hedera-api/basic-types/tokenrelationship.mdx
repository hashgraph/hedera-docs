...
description: "TokenRelationship protobuf type describing a token's relationship to a Hedera account, including balance, KYC, freeze, and auto-association data."
---
