...
description: "When referring to the Hedera native currency, use the singular form of the noun HBAR. For example:. Do not use the plural form of the noun, as this style."
---
