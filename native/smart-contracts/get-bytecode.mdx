...
description: "Retrieve a Hedera smart contract's runtime EVM bytecode with ContractByteCodeQuery, using the contract ID to fetch the deployed bytes from the network."
---
