...
description: "Part 1 of the HTS tutorial series: configure, mint, and transfer NFTs on Hedera without smart contracts, using fast and low-fee Hedera Token Service calls."
