...
description: "Structure Hedera fungible token and NFT metadata using the HIP-412 Token Metadata JSON Schema V2 for consistent, validated, marketplace-ready metadata."
---
