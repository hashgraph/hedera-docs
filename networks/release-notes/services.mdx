---
title: "Hedera consensus node release notes"
description: "Release notes for Hedera consensus node (services) versions, covering new features, protocol changes, performance updates, and network upgrade details."
---
...
### [**Build 0.77.2**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.77.2)

<Accordion title="What's Changed">

### **Bug Fixes**

  * enforce file-update authorization at ingest and charge failed attempts [#27135](https://github.com/hiero-ledger/hiero-consensus-node/pull/27135) by [@joshmarinacci](https://github.com/joshmarinacci)

  **Full Release Notes**: [**v0.77.2**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.77.2)

</Accordion>

### [**Build 0.77.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.77.1)

<Accordion title="What's Changed">

### **Bug Fixes**

  * fix failing XTS in 77 [#27212](https://github.com/hiero-ledger/hiero-consensus-node/pull/27212) by [@petreze](https://github.com/petreze)

  **Full Release Notes**: [**v0.77.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.77.1)

</Accordion>

### [**Build 0.77.0**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.77.0)

<Accordion title="What's Changed">

### **Features**

  * Rework block root hashing to a fixed 16-slot merkle tree [#26918](https://github.com/hiero-ledger/hiero-consensus-node/pull/26918) by [@derektriley](https://github.com/derektriley)
  * (0.77) SystemContracts input size limit [#26426](https://github.com/hiero-ledger/hiero-consensus-node/pull/26426) [#26652](https://github.com/hiero-ledger/hiero-consensus-node/pull/26652) by [@akdev](https://github.com/akdev)
  * improve BN comms coverage [#26428](https://github.com/hiero-ledger/hiero-consensus-node/pull/26428) by [@petreze](https://github.com/petreze)
  * #26310 - encapsulate virtual pipeline
  * enable all wraps and cutover HapiTests in XTS [#26268](https://github.com/hiero-ledger/hiero-consensus-node/pull/26268) by [@petreze](https://github.com/petreze)
  * EIP-3860 add support for init code limit validation [#26308](https://github.com/hiero-ledger/hiero-consensus-node/pull/26308) by [@stoyanov-st](https://github.com/stoyanov-st)
  * #26258 - reuse virtual map constructor
  * #26256 - add hashAsync() to VirtualHasher
  * Take weights into account when checking if node has fallen behind [#26218](https://github.com/hiero-ledger/hiero-consensus-node/pull/26218) by [@abies](https://github.com/abies)
  * Support for Ethereum Pectra Release [#25309](https://github.com/hiero-ledger/hiero-consensus-node/pull/25309) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * Remove unchecked submit [#26162](https://github.com/hiero-ledger/hiero-consensus-node/pull/26162) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * #26164 - Extract VirtualMapSyncConfig from ReconnectConfig
  * #26115 - skip WRAPS proving key download when artifacts already present [#26144](https://github.com/hiero-ledger/hiero-consensus-node/pull/26144) by [@ibankov](https://github.com/ibankov)
  * #26089 - remove rate limiter on teacher reconnect
  * #25318 - cleanup reconnect metrics
  * add enhanced observability for block streaming [#25861](https://github.com/hiero-ledger/hiero-consensus-node/pull/25861) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * 25739 - improve workgroup error handling
  * switch block stream and TSS configs defaults for `0.77` [#25928](https://github.com/hiero-ledger/hiero-consensus-node/pull/25928) by [@petreze](https://github.com/petreze)
  * #26023 - file exporter for new metrics framework
  * 25950 - move hashChunkHeight from VirtualMapConfig to MerkleDbConfig
  * 25821: New MerkleDb LongList implementation based on memory segments mapped from a specified file [#25903](https://github.com/hiero-ledger/hiero-consensus-node/pull/25903) by [@artemananiev](https://github.com/artemananiev)
  * 25754 - simplify reconnect tasks termination
  * Change default number of max other parents to 4 [#25669](https://github.com/hiero-ledger/hiero-consensus-node/pull/25669) by [@abies](https://github.com/abies)
  * switch dispatcher and queries to simple fees [#25888](https://github.com/hiero-ledger/hiero-consensus-node/pull/25888) by [@aderevets](https://github.com/aderevets)
  * Support Free Simple Fees [#25704](https://github.com/hiero-ledger/hiero-consensus-node/pull/25704) by [@joshmarinacci](https://github.com/joshmarinacci)

### **Bug Fixes**

  * Block royalty payments even when receiver is exempt from in-scope fallback fee [#27188](https://github.com/hiero-ledger/hiero-consensus-node/pull/27188) by [@joshmarinacci](https://github.com/joshmarinacci)
  * ContractValidationRule order fix [#27127](https://github.com/hiero-ledger/hiero-consensus-node/pull/27127) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Modify the language around folding beneficiary mappings into the root builder at staking finalization [#27211](https://github.com/hiero-ledger/hiero-consensus-node/pull/27211) by [@joshmarinacci](https://github.com/joshmarinacci)
  * don't advance beneficiary stake metadata for rewards redirected from a deleted account [#27181](https://github.com/hiero-ledger/hiero-consensus-node/pull/27181) by [@joshmarinacci](https://github.com/joshmarinacci)
  * deleting a rewardable stakee no longer freezes its indirect stakers [#27180](https://github.com/hiero-ledger/hiero-consensus-node/pull/27180) by [@joshmarinacci](https://github.com/joshmarinacci)
  * isolate scheduled-transaction failures in the expiry scan [#27137](https://github.com/hiero-ledger/hiero-consensus-node/pull/27137) by [@joshmarinacci](https://github.com/joshmarinacci)
  * replay processed inner fees when a later inner exceeds the record limit [#27136](https://github.com/hiero-ledger/hiero-consensus-node/pull/27136) by [@joshmarinacci](https://github.com/joshmarinacci)
  * guard exchange-rate fee conversion against non-positive centEquiv and overflow [#27168](https://github.com/hiero-ledger/hiero-consensus-node/pull/27168) by [@joshmarinacci](https://github.com/joshmarinacci)
  * require a node-controlled payer for NODE-category transactions [#27174](https://github.com/hiero-ledger/hiero-consensus-node/pull/27174) by [@joshmarinacci](https://github.com/joshmarinacci)
  * enforce contract trace-data limit for batch and scheduled calls [#27134](https://github.com/hiero-ledger/hiero-consensus-node/pull/27134) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Cherry-pick stale createdContractIds, atomic batch rollback fixes [#27162](https://github.com/hiero-ledger/hiero-consensus-node/pull/27162) by [@joshmarinacci](https://github.com/joshmarinacci)
  * reject duplicate non-repeated fields when extracting query payment bytes [#27133](https://github.com/hiero-ledger/hiero-consensus-node/pull/27133) by [@joshmarinacci](https://github.com/joshmarinacci)
  * reject token transfers in query payments [#27157](https://github.com/hiero-ledger/hiero-consensus-node/pull/27157) by [@joshmarinacci](https://github.com/joshmarinacci)
  * validate migration-root-hash vote bodies and harden vote tallying and storage ordering [#27132](https://github.com/hiero-ledger/hiero-consensus-node/pull/27132) by [@joshmarinacci](https://github.com/joshmarinacci)
  * fold beneficiary mappings into the root builder at staking finalization [#27131](https://github.com/hiero-ledger/hiero-consensus-node/pull/27131) by [@joshmarinacci](https://github.com/joshmarinacci)
  * handle two bugs in reclaiming throttle capacity [#27130](https://github.com/hiero-ledger/hiero-consensus-node/pull/27130) by [@joshmarinacci](https://github.com/joshmarinacci)
  * make prng and exchange rate contracts stateless [#27129](https://github.com/hiero-ledger/hiero-consensus-node/pull/27129) by [@joshmarinacci](https://github.com/joshmarinacci)
  * optimise pre handle workflow [#27128](https://github.com/hiero-ledger/hiero-consensus-node/pull/27128) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Cherry-Pick (77): strip DAB nodeId suffix in toSpecProperties() [#27094](https://github.com/hiero-ledger/hiero-consensus-node/pull/27094) by [@mhess-swl](https://github.com/mhess-swl)
  * (0.77) unblock BN Comms, BN regression and cutover XTS panels [#27010](https://github.com/hiero-ledger/hiero-consensus-node/pull/27010) by [@petreze](https://github.com/petreze)
  * 77 Cherry-pick: Install WRAPS proving keys atomically and gate prover readiness on a verified key- #27008 [#27009](https://github.com/hiero-ledger/hiero-consensus-node/pull/27009) by [@mhess-swl](https://github.com/mhess-swl)
  * 26969: (0.77) v0.77.0-rc.7: ISS reported despite 100% node agreement on state hash [#26970](https://github.com/hiero-ledger/hiero-consensus-node/pull/26970) by [@artemananiev](https://github.com/artemananiev)
  * cherry-pick: Throttle utilization metrics report zero [#26697](https://github.com/hiero-ledger/hiero-consensus-node/pull/26697) by [@derektriley](https://github.com/derektriley)
  * Cherry-pick: libsodium rollback [#26731](https://github.com/hiero-ledger/hiero-consensus-node/pull/26731) [#26765](https://github.com/hiero-ledger/hiero-consensus-node/pull/26765) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * (0.77) stabilize tests by increasing the staking period and give more room for wrap proof construction [#26515](https://github.com/hiero-ledger/hiero-consensus-node/pull/26515) [#26681](https://github.com/hiero-ledger/hiero-consensus-node/pull/26681) by [@petreze](https://github.com/petreze)
  * (0.77) Refresh stale TSS controllers after reconnect [#26625](https://github.com/hiero-ledger/hiero-consensus-node/pull/26625) [#26627](https://github.com/hiero-ledger/hiero-consensus-node/pull/26627) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * (0.77) Ensure deterministic vote replay around reconnect [#26564](https://github.com/hiero-ledger/hiero-consensus-node/pull/26564) [#26567](https://github.com/hiero-ledger/hiero-consensus-node/pull/26567) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * update solo version to v0.79.1 [#26707](https://github.com/hiero-ledger/hiero-consensus-node/pull/26707) by [@andrewb1269](https://github.com/andrewb1269)
  * (0.77) XTS fixes for BN Comms and JRS [#26455](https://github.com/hiero-ledger/hiero-consensus-node/pull/26455) [#26671](https://github.com/hiero-ledger/hiero-consensus-node/pull/26671) by @gkozyryatskyy, @akdev
  * (0.77) Ops duration throttling for insufficient gas tx [#26438](https://github.com/hiero-ledger/hiero-consensus-node/pull/26438) [#26669](https://github.com/hiero-ledger/hiero-consensus-node/pull/26669) by @gkozyryatskyy, @akdev
  * (0.77) Clip trace data [#26434](https://github.com/hiero-ledger/hiero-consensus-node/pull/26434) [#26651](https://github.com/hiero-ledger/hiero-consensus-node/pull/26651) by @tinker-michaelj, @akdev
  * (0.77) Fix jumpstart migration PBJ parsing [#26422](https://github.com/hiero-ledger/hiero-consensus-node/pull/26422) [#26650](https://github.com/hiero-ledger/hiero-consensus-node/pull/26650) by [@akdev](https://github.com/akdev)
  * (0.77) Non-deterministic gossip CA certificate validation [#26424](https://github.com/hiero-ledger/hiero-consensus-node/pull/26424) [#26649](https://github.com/hiero-ledger/hiero-consensus-node/pull/26649) by [@akdev](https://github.com/akdev)
  * (0.77) Refactor access list encoding [#26423](https://github.com/hiero-ledger/hiero-consensus-node/pull/26423) [#26647](https://github.com/hiero-ledger/hiero-consensus-node/pull/26647) by [@akdev](https://github.com/akdev)
  * 26655: (0.77) Increase AsyncInputStream max message size limit [#26657](https://github.com/hiero-ledger/hiero-consensus-node/pull/26657) by [@artemananiev](https://github.com/artemananiev)
  * improve how the connection worker loop handles pending requests [#26586](https://github.com/hiero-ledger/hiero-consensus-node/pull/26586) by [@timfn-hg](https://github.com/timfn-hg)
  * (0.77) Resilient vote replay [#26526](https://github.com/hiero-ledger/hiero-consensus-node/pull/26526) [#26544](https://github.com/hiero-ledger/hiero-consensus-node/pull/26544) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Clear jumpstart hash queue [#26364](https://github.com/hiero-ledger/hiero-consensus-node/pull/26364) by [@derektriley](https://github.com/derektriley)
  * fail hard on an unparseable simple fee schedule at node (re)initialization [#26269](https://github.com/hiero-ledger/hiero-consensus-node/pull/26269) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * Use nGen for setting last self event instead of sequence number [#26376](https://github.com/hiero-ledger/hiero-consensus-node/pull/26376) by [@poulok](https://github.com/poulok)
  * Close initial state in test framework [#26374](https://github.com/hiero-ledger/hiero-consensus-node/pull/26374) by [@netopyr](https://github.com/netopyr)
  * fix airdrop create and claim [#26363](https://github.com/hiero-ledger/hiero-consensus-node/pull/26363) by [@aderevets](https://github.com/aderevets)
  * Optimisation to Ethereum transaction validation [#26227](https://github.com/hiero-ledger/hiero-consensus-node/pull/26227) by [@stoyanov-st](https://github.com/stoyanov-st)
  * fix airdrop create and claim [#26254](https://github.com/hiero-ledger/hiero-consensus-node/pull/26254) by [@aderevets](https://github.com/aderevets)
  * clear stale createdContractIds and suppress `STATE_CHANGES` sidecars for `REVERTED_SUCCESS` batch transactions [#26332](https://github.com/hiero-ledger/hiero-consensus-node/pull/26332) by [@mhess-swl](https://github.com/mhess-swl)
  * Fix consensus optimization bug [#26319](https://github.com/hiero-ledger/hiero-consensus-node/pull/26319) by [@poulok](https://github.com/poulok)
  * Use shard/realm from parsed state key in EntityIdUniquenessValidator [#26288](https://github.com/hiero-ledger/hiero-consensus-node/pull/26288) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * Revert "chore: Remove nGen [#26169](https://github.com/hiero-ledger/hiero-consensus-node/pull/26169)" [#26309](https://github.com/hiero-ledger/hiero-consensus-node/pull/26309) by [@poulok](https://github.com/poulok)
  * Refactor System Contract handling [#26284](https://github.com/hiero-ledger/hiero-consensus-node/pull/26284) by [@stoyanov-st](https://github.com/stoyanov-st)
  * StateProof adjustment to leaf to be proven and single-child SiblingNode [#26225](https://github.com/hiero-ledger/hiero-consensus-node/pull/26225) by [@derektriley](https://github.com/derektriley)
  * Fix wiring type mismatch silent error [#26255](https://github.com/hiero-ledger/hiero-consensus-node/pull/26255) by [@poulok](https://github.com/poulok)
  * Fix consensus restart tests [#26246](https://github.com/hiero-ledger/hiero-consensus-node/pull/26246) by [@poulok](https://github.com/poulok)
  * Disable Code Delegation Atomic Batch tests [#26251](https://github.com/hiero-ledger/hiero-consensus-node/pull/26251) by [@stoyanov-st](https://github.com/stoyanov-st)
  * throttle metrics [#26231](https://github.com/hiero-ledger/hiero-consensus-node/pull/26231) by [@petreze](https://github.com/petreze)
  * fail fast on block-stream hashing failure instead of deadlocking [#26239](https://github.com/hiero-ledger/hiero-consensus-node/pull/26239) by [@AlexKehayov](https://github.com/AlexKehayov)
  * validate full shard.realm.num in Authorizer [#26213](https://github.com/hiero-ledger/hiero-consensus-node/pull/26213) by [@AlexKehayov](https://github.com/AlexKehayov)
  * proper bucket throttle for ethereum txn [#26220](https://github.com/hiero-ledger/hiero-consensus-node/pull/26220) by [@petreze](https://github.com/petreze)
  * Fix for speedometer stddev unit tests [#26234](https://github.com/hiero-ledger/hiero-consensus-node/pull/26234) by [@abies](https://github.com/abies)
  * Throttle IndexOutOfBound possibility [#26212](https://github.com/hiero-ledger/hiero-consensus-node/pull/26212) by [@petreze](https://github.com/petreze)
  * reject NODE-category transactions whose payer is not node-controlled [#26160](https://github.com/hiero-ledger/hiero-consensus-node/pull/26160) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * pass the configured mirror-node version to solo in the XTS mirror-node regression panel [#26219](https://github.com/hiero-ledger/hiero-consensus-node/pull/26219) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * make translator entity watermarks per-type [#26194](https://github.com/hiero-ledger/hiero-consensus-node/pull/26194) by [@aderevets](https://github.com/aderevets)
  * Optimise Token Uri system contract call [#26210](https://github.com/hiero-ledger/hiero-consensus-node/pull/26210) by [@stoyanov-st](https://github.com/stoyanov-st)
  * Refactor HSCS account screening flow [#26191](https://github.com/hiero-ledger/hiero-consensus-node/pull/26191) by [@stoyanov-st](https://github.com/stoyanov-st)
  * refine delegated NFT allowance handling and validation [#26181](https://github.com/hiero-ledger/hiero-consensus-node/pull/26181) by [@petreze](https://github.com/petreze)
  * 26067: Intermittent Blockstream Diff Testing for Previewnet Node failure [#26068](https://github.com/hiero-ledger/hiero-consensus-node/pull/26068) by [@thenswan](https://github.com/thenswan)
  * correct bonneville SDIV/SMOD signed arithmetic [#26161](https://github.com/hiero-ledger/hiero-consensus-node/pull/26161) by [@aderevets](https://github.com/aderevets)
  * do not embed TSS private keys in startup network export under PROD [#26085](https://github.com/hiero-ledger/hiero-consensus-node/pull/26085) by [@AlexKehayov](https://github.com/AlexKehayov)
  * require explicit opt-in to allow uncheckedSubmit [#26126](https://github.com/hiero-ledger/hiero-consensus-node/pull/26126) by [@AlexKehayov](https://github.com/AlexKehayov)
  * Flush platform status before replay [#26118](https://github.com/hiero-ledger/hiero-consensus-node/pull/26118) by [@poulok](https://github.com/poulok)
  * Fix for flaky ReconnectTest [#26042](https://github.com/hiero-ledger/hiero-consensus-node/pull/26042) by [@netopyr](https://github.com/netopyr)
  * disable the pause detector [#26102](https://github.com/hiero-ledger/hiero-consensus-node/pull/26102) by [@joshmarinacci](https://github.com/joshmarinacci)
  * main branch
  * Key material security posture [#25946](https://github.com/hiero-ledger/hiero-consensus-node/pull/25946) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Include all effective payers for fractional fee assessed records [#25717](https://github.com/hiero-ledger/hiero-consensus-node/pull/25717) by [@Neeharika-Sompalli](https://github.com/Neeharika-Sompalli)
  * 25937: MerkleDb state folder name should be fixed [#25992](https://github.com/hiero-ledger/hiero-consensus-node/pull/25992) by [@artemananiev](https://github.com/artemananiev)
  * flush blocks on catastrophic failure instead of stopping on ISS [#25848](https://github.com/hiero-ledger/hiero-consensus-node/pull/25848) by [@AlexKehayov](https://github.com/AlexKehayov)
  * tss.wrapsProvingKeyPath default conflicts with WRAPS artifacts extraction directory [#26019](https://github.com/hiero-ledger/hiero-consensus-node/pull/26019) by [@derektriley](https://github.com/derektriley)
  * cherry-pick (main): signSchedule(address,bytes) signatureMap size limit [#25977](https://github.com/hiero-ledger/hiero-consensus-node/pull/25977) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * #25986 - OpenMetricsWriter to use ROOT locale
  * treat empty-KeyList token keys as absent (disabled) instead of permissionless [#25823](https://github.com/hiero-ledger/hiero-consensus-node/pull/25823) by [@ibankov](https://github.com/ibankov)
  * Revert "feat: Support Free Simple Fees [#25704](https://github.com/hiero-ledger/hiero-consensus-node/pull/25704)" [#25932](https://github.com/hiero-ledger/hiero-consensus-node/pull/25932) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Feature/token association refactoring [#25619](https://github.com/hiero-ledger/hiero-consensus-node/pull/25619) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * resolve relative paths before WRAPS artifacts path consistency check [#25907](https://github.com/hiero-ledger/hiero-consensus-node/pull/25907) by [@ibankov](https://github.com/ibankov)

### **Other Changes**

  * bump pandaswhocode/initialize-github-job to v1.2.2 [#26396](https://github.com/hiero-ledger/hiero-consensus-node/pull/26396) by [@nathanklick](https://github.com/nathanklick)
  * Upgrade jackson to 2.22.1 [#26365](https://github.com/hiero-ledger/hiero-consensus-node/pull/26365) by [@poulok](https://github.com/poulok)
  * Revert build(deps): bump gradle-wrapper from 9.5.1 to 9.6.0 [#26000](https://github.com/hiero-ledger/hiero-consensus-node/pull/26000) [#26348](https://github.com/hiero-ledger/hiero-consensus-node/pull/26348) by @dependabot[bot], @andrewb1269
  * bump slackapi/slack-github-action from 2.0.0 to 3.0.5 [#20460](https://github.com/hiero-ledger/hiero-consensus-node/pull/20460) by @dependabot[bot]
  * bump net.java.dev.jna:jna from 5.18.1 to 5.19.0 in /hiero-dependency-versions [#25835](https://github.com/hiero-ledger/hiero-consensus-node/pull/25835) by @dependabot[bot]
  * bump com.github.docker-java:docker-java-api from 3.7.0 to 3.7.1 in /hiero-dependency-versions [#25837](https://github.com/hiero-ledger/hiero-consensus-node/pull/25837) by @dependabot[bot]
  * bump gradle-wrapper from 9.5.1 to 9.6.0 [#26000](https://github.com/hiero-ledger/hiero-consensus-node/pull/26000) by @dependabot[bot]
  * bump bouncycastle from 1.83 to 1.84 in /hiero-dependency-versions [#25836](https://github.com/hiero-ledger/hiero-consensus-node/pull/25836) by @dependabot[bot]
  * remove accidentally added flaky test configuration [#26243](https://github.com/hiero-ledger/hiero-consensus-node/pull/26243) by [@jjohannes](https://github.com/jjohannes)
  * update 'org.hiero.gradle.build' to 0.7.11 [#26193](https://github.com/hiero-ledger/hiero-consensus-node/pull/26193) by [@jjohannes](https://github.com/jjohannes)
  * activate Gradle project isolation for faster build startup [#25397](https://github.com/hiero-ledger/hiero-consensus-node/pull/25397) by [@jjohannes](https://github.com/jjohannes)
  * bump io.netty:netty-bom from 4.2.13.Final to 4.2.15.Final in /hiero-dependency-versions [#25839](https://github.com/hiero-ledger/hiero-consensus-node/pull/25839) by @dependabot[bot]
  * bump com.github.ben-manes.caffeine:caffeine from 3.2.0 to 3.2.4 in /hiero-dependency-versions [#25838](https://github.com/hiero-ledger/hiero-consensus-node/pull/25838) by @dependabot[bot]
  * bump step-security/publish-unit-test-result-action from 2.22.0 to 2.23.0 [#25843](https://github.com/hiero-ledger/hiero-consensus-node/pull/25843) by @dependabot[bot]
  * bump step-security/auto-unapprove from 1.0.2 to 1.0.3 [#25844](https://github.com/hiero-ledger/hiero-consensus-node/pull/25844) by @dependabot[bot]
  * Atomic batch EVM tx restriction [#27185](https://github.com/hiero-ledger/hiero-consensus-node/pull/27185) by [@joshmarinacci](https://github.com/joshmarinacci)
  * streamMode=BOTH block size circuit breaker [#27171](https://github.com/hiero-ledger/hiero-consensus-node/pull/27171) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Mainnet and Testnet jumpstart and disable TSS [#27033](https://github.com/hiero-ledger/hiero-consensus-node/pull/27033) by [@derektriley](https://github.com/derektriley)
  * Update BN Version to v0.41.0-rc1 and MN to 0.162.0-rc1 [#26948](https://github.com/hiero-ledger/hiero-consensus-node/pull/26948) by [@derektriley](https://github.com/derektriley)
  * Truncate wrapped-record-hashes.pb file and enable writing of hashes [#26747](https://github.com/hiero-ledger/hiero-consensus-node/pull/26747) [#26834](https://github.com/hiero-ledger/hiero-consensus-node/pull/26834) by [@derektriley](https://github.com/derektriley)
  * (0.77) fix BN suite on main [#26459](https://github.com/hiero-ledger/hiero-consensus-node/pull/26459) [#26680](https://github.com/hiero-ledger/hiero-consensus-node/pull/26680) by [@petreze](https://github.com/petreze)
  * (0.77) Reduce block buffer size from 150 to 30 blocks [#26425](https://github.com/hiero-ledger/hiero-consensus-node/pull/26425) [#26648](https://github.com/hiero-ledger/hiero-consensus-node/pull/26648) by [@akdev](https://github.com/akdev)
  * Update wrapsVoteJitterPerRank and pipelineOperationTimeout [#26563](https://github.com/hiero-ledger/hiero-consensus-node/pull/26563) by [@derektriley](https://github.com/derektriley)
  * Pin container versions [#26421](https://github.com/hiero-ledger/hiero-consensus-node/pull/26421) by [@netopyr](https://github.com/netopyr)
  * Stabilize ToxiProxy communication [#26370](https://github.com/hiero-ledger/hiero-consensus-node/pull/26370) by [@netopyr](https://github.com/netopyr)
  * Move simple methods out of PlatformCoordinator [#26393](https://github.com/hiero-ledger/hiero-consensus-node/pull/26393) by [@netopyr](https://github.com/netopyr)
  * Avoid repeating preview block stream overwrite [#26394](https://github.com/hiero-ledger/hiero-consensus-node/pull/26394) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Add thread dump functionality to Otter [#26369](https://github.com/hiero-ledger/hiero-consensus-node/pull/26369) by [@netopyr](https://github.com/netopyr)
  * Cleanup tests and testFixtures in platform-core [#26335](https://github.com/hiero-ledger/hiero-consensus-node/pull/26335) by [@netopyr](https://github.com/netopyr)
  * Add a main class for running the Hashgraph GUI from PCES files [#26361](https://github.com/hiero-ledger/hiero-consensus-node/pull/26361) by [@poulok](https://github.com/poulok)
  * Remove model lifecycle methods from PlatformCoordinator [#26366](https://github.com/hiero-ledger/hiero-consensus-node/pull/26366) by [@netopyr](https://github.com/netopyr)
  * do not upload the proving key into log zips [#26334](https://github.com/hiero-ledger/hiero-consensus-node/pull/26334) by [@petreze](https://github.com/petreze)
  * remove duplicate codeowner team [#26331](https://github.com/hiero-ledger/hiero-consensus-node/pull/26331) by [@andrewb1269](https://github.com/andrewb1269)
  * Improve KB freshness checker [#26298](https://github.com/hiero-ledger/hiero-consensus-node/pull/26298) by [@netopyr](https://github.com/netopyr)
  * Revert "chore: Remove config.txt file [#26249](https://github.com/hiero-ledger/hiero-consensus-node/pull/26249)" [#26333](https://github.com/hiero-ledger/hiero-consensus-node/pull/26333) by @Grigorov-Georgi, @ibankov
  * migrate to hiero-cryptography Libsodium [#26202](https://github.com/hiero-ledger/hiero-consensus-node/pull/26202) by [@anthony-swirldslabs](https://github.com/anthony-swirldslabs)
  * update codeowners for gradle files [#26272](https://github.com/hiero-ledger/hiero-consensus-node/pull/26272) by [@andrewb1269](https://github.com/andrewb1269)
  * Fix Yahcli Subprocess test failure artifact uploading [#26294](https://github.com/hiero-ledger/hiero-consensus-node/pull/26294) by [@derektriley](https://github.com/derektriley)
  * Decrease merkledb initial size for container otter tests [#26279](https://github.com/hiero-ledger/hiero-consensus-node/pull/26279) by [@poulok](https://github.com/poulok)
  * Remove config.txt file [#26249](https://github.com/hiero-ledger/hiero-consensus-node/pull/26249) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * removing HashCompareHandshake dead code [#26245](https://github.com/hiero-ledger/hiero-consensus-node/pull/26245) by [@Jeffrey-morgan34](https://github.com/Jeffrey-morgan34)
  * Final cleanup of state module [#26248](https://github.com/hiero-ledger/hiero-consensus-node/pull/26248) by [@netopyr](https://github.com/netopyr)
  * Add additional metrics for block streaming [#26203](https://github.com/hiero-ledger/hiero-consensus-node/pull/26203) by [@timfn-hg](https://github.com/timfn-hg)
  * Merge consensus-state-management into consensus-state [#26238](https://github.com/hiero-ledger/hiero-consensus-node/pull/26238) by [@netopyr](https://github.com/netopyr)
  * Remove nGen [#26169](https://github.com/hiero-ledger/hiero-consensus-node/pull/26169) by [@poulok](https://github.com/poulok)
  * Prevent possible NPE in ConsensusSubmitMessageFeeCalculator [#26221](https://github.com/hiero-ledger/hiero-consensus-node/pull/26221) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * KB freshness [#26217](https://github.com/hiero-ledger/hiero-consensus-node/pull/26217) by [@netopyr](https://github.com/netopyr)
  * bump mirror-node version to 0.158.0 for the XTS Mirror Node Regression panel [#26230](https://github.com/hiero-ledger/hiero-consensus-node/pull/26230) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * Update cGen to use seq num instead of nGen [#26168](https://github.com/hiero-ledger/hiero-consensus-node/pull/26168) by [@poulok](https://github.com/poulok)
  * Update consensus to use event seq num instead of ngen [#26157](https://github.com/hiero-ledger/hiero-consensus-node/pull/26157) by [@poulok](https://github.com/poulok)
  * Added benchmark for Speedometer and small improvement to speed [#26146](https://github.com/hiero-ledger/hiero-consensus-node/pull/26146) by [@abies](https://github.com/abies)
  * Remove countOfCryptographicKeys method [#26208](https://github.com/hiero-ledger/hiero-consensus-node/pull/26208) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * Revert healthLogThreshold to 5s [#26184](https://github.com/hiero-ledger/hiero-consensus-node/pull/26184) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * make restartWrapsSigning consistent [#26185](https://github.com/hiero-ledger/hiero-consensus-node/pull/26185) by [@petreze](https://github.com/petreze)
  * State Management Module reviewer follow up [#26190](https://github.com/hiero-ledger/hiero-consensus-node/pull/26190) by [@poulok](https://github.com/poulok)
  * Revert "chore: replace LazySodium with Hiero Libsodium [#26122](https://github.com/hiero-ledger/hiero-consensus-node/pull/26122)" [#26172](https://github.com/hiero-ledger/hiero-consensus-node/pull/26172) by [@anthony-swirldslabs](https://github.com/anthony-swirldslabs)
  * create state management module [#26134](https://github.com/hiero-ledger/hiero-consensus-node/pull/26134) by [@netopyr](https://github.com/netopyr)
  * fix solo adhoc e2e cutover script [#26080](https://github.com/hiero-ledger/hiero-consensus-node/pull/26080) by [@petreze](https://github.com/petreze)
  * Combine handle and pre handle flushing [#26137](https://github.com/hiero-ledger/hiero-consensus-node/pull/26137) by [@poulok](https://github.com/poulok)
  * #26132- improve config usage in merkledb and vmap
  * Update references to swirlds-docker [#26149](https://github.com/hiero-ledger/hiero-consensus-node/pull/26149) by [@rbarker-dev](https://github.com/rbarker-dev)
  * minor hardening fixes for block node communication [#26138](https://github.com/hiero-ledger/hiero-consensus-node/pull/26138) by [@timfn-hg](https://github.com/timfn-hg)
  * replace LazySodium with Hiero Libsodium [#26122](https://github.com/hiero-ledger/hiero-consensus-node/pull/26122) by [@anthony-swirldslabs](https://github.com/anthony-swirldslabs)
  * bump up the Block Node version in test infra [#26124](https://github.com/hiero-ledger/hiero-consensus-node/pull/26124) by [@petreze](https://github.com/petreze)
  * Migrate transaction handling module [#26112](https://github.com/hiero-ledger/hiero-consensus-node/pull/26112) by [@netopyr](https://github.com/netopyr)
  * Update sync sorting to use sequence number instead of nGen [#26110](https://github.com/hiero-ledger/hiero-consensus-node/pull/26110) by [@poulok](https://github.com/poulok)
  * Revert feat: switch block stream and TSS configs defaults for 0.77 [#26116](https://github.com/hiero-ledger/hiero-consensus-node/pull/26116) by [@derektriley](https://github.com/derektriley)
  * Keep HAPI Test (Restart) happy w/ non-recursive proofs [#26051](https://github.com/hiero-ledger/hiero-consensus-node/pull/26051) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Cleanup of ISS error log suppress [#26079](https://github.com/hiero-ledger/hiero-consensus-node/pull/26079) by [@netopyr](https://github.com/netopyr)
  * fixate configs in bn suite [#26101](https://github.com/hiero-ledger/hiero-consensus-node/pull/26101) by [@petreze](https://github.com/petreze)
  * move state test fixtures into consensus-state [#26097](https://github.com/hiero-ledger/hiero-consensus-node/pull/26097) by [@netopyr](https://github.com/netopyr)
  * Update BN XTS Regression Panel w MN 0.157.0+ support [#26098](https://github.com/hiero-ledger/hiero-consensus-node/pull/26098) by [@Nana-EC](https://github.com/Nana-EC)
  * remove XTS BLOCKS override tests [#26061](https://github.com/hiero-ledger/hiero-consensus-node/pull/26061) by [@petreze](https://github.com/petreze)
  * bump PandasWhoCode/initialize-github-job to v1.1.2 in BN XTS regression panel [#26064](https://github.com/hiero-ledger/hiero-consensus-node/pull/26064) by [@Nana-EC](https://github.com/Nana-EC)
  * Introduce ISS detection module [#25988](https://github.com/hiero-ledger/hiero-consensus-node/pull/25988) by [@netopyr](https://github.com/netopyr)
  * cleanup node integration fee tests [#26012](https://github.com/hiero-ledger/hiero-consensus-node/pull/26012) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * Update references to jrs-legacy [#26058](https://github.com/hiero-ledger/hiero-consensus-node/pull/26058) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Clean misc and cross service fee tests 25859 [#25998](https://github.com/hiero-ledger/hiero-consensus-node/pull/25998) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * Bump helidon version to 4.5.0 [#26021](https://github.com/hiero-ledger/hiero-consensus-node/pull/26021) by [@derektriley](https://github.com/derektriley)
  * Update PBJ version and add tests [#25990](https://github.com/hiero-ledger/hiero-consensus-node/pull/25990) by [@Neeharika-Sompalli](https://github.com/Neeharika-Sompalli)
  * return plaftform.wiriting.healthLogThreshold=3s to Token, Restart and MiscRecords hapi tests [#26007](https://github.com/hiero-ledger/hiero-consensus-node/pull/26007) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * Move Platform state machine to consensus-utilities [#26003](https://github.com/hiero-ledger/hiero-consensus-node/pull/26003) by [@netopyr](https://github.com/netopyr)
  * Move ScratchPad to consensus-utility [#25981](https://github.com/hiero-ledger/hiero-consensus-node/pull/25981) by [@netopyr](https://github.com/netopyr)
  * Always throttle CryptoGetAccountBalance [#25952](https://github.com/hiero-ledger/hiero-consensus-node/pull/25952) by [@derektriley](https://github.com/derektriley)
  * Sig map override in dispatchComputeFees [#25968](https://github.com/hiero-ledger/hiero-consensus-node/pull/25968) by [@derektriley](https://github.com/derektriley)
  * Minor Version Roll to 0.77.0-SNAPSHOT
  * increase TC-03 Publisher Handshake Protocol coverage [#25766](https://github.com/hiero-ledger/hiero-consensus-node/pull/25766) by [@AlexKehayov](https://github.com/AlexKehayov)
  * Remove dead code for connection handling [#25941](https://github.com/hiero-ledger/hiero-consensus-node/pull/25941) by [@abies](https://github.com/abies)
  * Move branch detection into event intake module [#25906](https://github.com/hiero-ledger/hiero-consensus-node/pull/25906) by [@netopyr](https://github.com/netopyr)
  * remove application callbacks [#25879](https://github.com/hiero-ledger/hiero-consensus-node/pull/25879) by [@netopyr](https://github.com/netopyr)
  * broken TCK & JS SDK XTS tests [#27154](https://github.com/hiero-ledger/hiero-consensus-node/pull/27154) by [@joshmarinacci](https://github.com/joshmarinacci)
  * bump bouncycastle to 1.85 [#26963](https://github.com/hiero-ledger/hiero-consensus-node/pull/26963) by [@joshmarinacci](https://github.com/joshmarinacci)
  * upgrade io.netty:netty-codec-http to 4.2.17.Final [#26911](https://github.com/hiero-ledger/hiero-consensus-node/pull/26911) [#26952](https://github.com/hiero-ledger/hiero-consensus-node/pull/26952) by @anthony-swirldslabs, @joshmarinacci
  * bump TCK and JS SDK versions [#26882](https://github.com/hiero-ledger/hiero-consensus-node/pull/26882) by [@joshmarinacci](https://github.com/joshmarinacci)
  * bump TCK and JS SDK versions
  * pin redis version [#26624](https://github.com/hiero-ledger/hiero-consensus-node/pull/26624) [#26629](https://github.com/hiero-ledger/hiero-consensus-node/pull/26629) by [@andrewb1269](https://github.com/andrewb1269)
  * (0.77) bump TCK version to v0.12.3 for the SDK TCK Regression panel [#26552](https://github.com/hiero-ledger/hiero-consensus-node/pull/26552) [#26561](https://github.com/hiero-ledger/hiero-consensus-node/pull/26561) by @Fantomasa, @petreze
  * fix determinism cache key bug [#26491](https://github.com/hiero-ledger/hiero-consensus-node/pull/26491) [#26492](https://github.com/hiero-ledger/hiero-consensus-node/pull/26492) by [@andrewb1269](https://github.com/andrewb1269)
  * Improve install [#26395](https://github.com/hiero-ledger/hiero-consensus-node/pull/26395) by [@joshmarinacci](https://github.com/joshmarinacci)
  * install deterministic-zip through checksum-verified action [#26400](https://github.com/hiero-ledger/hiero-consensus-node/pull/26400) by [@nathanklick](https://github.com/nathanklick)
  * use correct github.event.repository.fork [#26276](https://github.com/hiero-ledger/hiero-consensus-node/pull/26276) by [@joshmarinacci](https://github.com/joshmarinacci)
  * replace context values with env vars [#26351](https://github.com/hiero-ledger/hiero-consensus-node/pull/26351) by [@joshmarinacci](https://github.com/joshmarinacci)
  * remove xts cancelled messages from operations channel [#26306](https://github.com/hiero-ledger/hiero-consensus-node/pull/26306) by [@andrewb1269](https://github.com/andrewb1269)
  * fix Slack message failures [#26304](https://github.com/hiero-ledger/hiero-consensus-node/pull/26304) by [@andrewb1269](https://github.com/andrewb1269)
  * update the checkout steps [#26265](https://github.com/hiero-ledger/hiero-consensus-node/pull/26265) by [@andrewb1269](https://github.com/andrewb1269)
  * run TCK regression against the PR build and current mirror node [#26267](https://github.com/hiero-ledger/hiero-consensus-node/pull/26267) by [@ibankov](https://github.com/ibankov)
  * use snyk actions [#26275](https://github.com/hiero-ledger/hiero-consensus-node/pull/26275) by [@joshmarinacci](https://github.com/joshmarinacci)
  * make mirror-node and rpc-relay mandatory [#26280](https://github.com/hiero-ledger/hiero-consensus-node/pull/26280) by [@joshmarinacci](https://github.com/joshmarinacci)
  * set explicit version number [#26260](https://github.com/hiero-ledger/hiero-consensus-node/pull/26260) by [@joshmarinacci](https://github.com/joshmarinacci)
  * JSON-RPC Relay Test [#26244](https://github.com/hiero-ledger/hiero-consensus-node/pull/26244) by [@joshmarinacci](https://github.com/joshmarinacci)
  * delete unneeded files from pectra release [#26237](https://github.com/hiero-ledger/hiero-consensus-node/pull/26237) by [@joshmarinacci](https://github.com/joshmarinacci)
  * pin and validate grpcurl [#26195](https://github.com/hiero-ledger/hiero-consensus-node/pull/26195) by [@joshmarinacci](https://github.com/joshmarinacci)
  * use evn vars instead of direct shell injection for input vars [#26200](https://github.com/hiero-ledger/hiero-consensus-node/pull/26200) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Fix broken grpcurl [#26233](https://github.com/hiero-ledger/hiero-consensus-node/pull/26233) by [@joshmarinacci](https://github.com/joshmarinacci)
  * prevent SIGPIPE from crashing XTS candidate tag lookup [#26226](https://github.com/hiero-ledger/hiero-consensus-node/pull/26226) by [@andrewb1269](https://github.com/andrewb1269)
  * pass the BN version in XTS correctly [#26229](https://github.com/hiero-ledger/hiero-consensus-node/pull/26229) by [@andrewb1269](https://github.com/andrewb1269)
  * update how XTS exits when no tag found [#26189](https://github.com/hiero-ledger/hiero-consensus-node/pull/26189) by [@andrewb1269](https://github.com/andrewb1269)
  * add run attempt to slack templates [#26045](https://github.com/hiero-ledger/hiero-consensus-node/pull/26045) by [@joshmarinacci](https://github.com/joshmarinacci)
  * pin and validate binary versions [#26173](https://github.com/hiero-ledger/hiero-consensus-node/pull/26173) by [@joshmarinacci](https://github.com/joshmarinacci)
  * make bn regression mandatory in XTS [#26159](https://github.com/hiero-ledger/hiero-consensus-node/pull/26159) by [@andrewb1269](https://github.com/andrewb1269)
  * add xts-tag-exists to the slack-cancelled-summary template [#26044](https://github.com/hiero-ledger/hiero-consensus-node/pull/26044) by [@joshmarinacci](https://github.com/joshmarinacci)
  * install semver only through initialize-github-job [#26151](https://github.com/hiero-ledger/hiero-consensus-node/pull/26151) by [@joshmarinacci](https://github.com/joshmarinacci)
  * use 'showVersion' instead of 'properties' Gradle task [#26155](https://github.com/hiero-ledger/hiero-consensus-node/pull/26155) by [@jjohannes](https://github.com/jjohannes)
  * consolidate manual harden runner + checkout templates + install gomplate [#26048](https://github.com/hiero-ledger/hiero-consensus-node/pull/26048) by [@joshmarinacci](https://github.com/joshmarinacci)
  * update gradle cache cleanup to default behavior [#26140](https://github.com/hiero-ledger/hiero-consensus-node/pull/26140) by [@andrewb1269](https://github.com/andrewb1269)
  * update how release note commits are processed [#26128](https://github.com/hiero-ledger/hiero-consensus-node/pull/26128) by [@andrewb1269](https://github.com/andrewb1269)
  * update setup-gradle action input parameter [#26136](https://github.com/hiero-ledger/hiero-consensus-node/pull/26136) by [@andrewb1269](https://github.com/andrewb1269)
  * add commitish build handling to determinism checks [#25525](https://github.com/hiero-ledger/hiero-consensus-node/pull/25525) by [@andrewb1269](https://github.com/andrewb1269)
  * Update 855 to provide empty strings and verify outputs [#26086](https://github.com/hiero-ledger/hiero-consensus-node/pull/26086) by [@rbarker-dev](https://github.com/rbarker-dev)
  * update solo version [#26070](https://github.com/hiero-ledger/hiero-consensus-node/pull/26070) by [@joshmarinacci](https://github.com/joshmarinacci)
  * broken slack report [#26076](https://github.com/hiero-ledger/hiero-consensus-node/pull/26076) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Update access token for JRS panel [#26072](https://github.com/hiero-ledger/hiero-consensus-node/pull/26072) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Fix json-rpc-relay checkout tag step [#26055](https://github.com/hiero-ledger/hiero-consensus-node/pull/26055) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Add json-rpc-relay-version to hiero-consensus-node .citr-env [#26050](https://github.com/hiero-ledger/hiero-consensus-node/pull/26050) by [@rbarker-dev](https://github.com/rbarker-dev)
  * consolidate Slack payload generation code. [#25647](https://github.com/hiero-ledger/hiero-consensus-node/pull/25647) by [@joshmarinacci](https://github.com/joshmarinacci)
  * add workflow unit tests for templates [#25680](https://github.com/hiero-ledger/hiero-consensus-node/pull/25680) by [@joshmarinacci](https://github.com/joshmarinacci)
  * wire WRAPS XTS tests to a runner-mounted proving-key OCI image [#25846](https://github.com/hiero-ledger/hiero-consensus-node/pull/25846) by [@ibankov](https://github.com/ibankov)
  * Update XTS panels to use locked values [#25962](https://github.com/hiero-ledger/hiero-consensus-node/pull/25962) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Update names in workflow files [#25958](https://github.com/hiero-ledger/hiero-consensus-node/pull/25958) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Integrate the workflow renames [#25954](https://github.com/hiero-ledger/hiero-consensus-node/pull/25954) by [@rbarker-dev](https://github.com/rbarker-dev)
  * add permissions to PR formatting check workflow [#25933](https://github.com/hiero-ledger/hiero-consensus-node/pull/25933) by [@andrewb1269](https://github.com/andrewb1269)
  * bump mirror node version [#25911](https://github.com/hiero-ledger/hiero-consensus-node/pull/25911) by [@joshmarinacci](https://github.com/joshmarinacci)
  * move solo version check to separate workflow [#25927](https://github.com/hiero-ledger/hiero-consensus-node/pull/25927) by [@andrewb1269](https://github.com/andrewb1269)
  * fix solo version processing check [#25925](https://github.com/hiero-ledger/hiero-consensus-node/pull/25925) by [@andrewb1269](https://github.com/andrewb1269)
  * use setup-gomplate [#25909](https://github.com/hiero-ledger/hiero-consensus-node/pull/25909) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Add 855-extract-citr-vars workflow [#25908](https://github.com/hiero-ledger/hiero-consensus-node/pull/25908) by [@rbarker-dev](https://github.com/rbarker-dev)
  * refactor error handling [#25610](https://github.com/hiero-ledger/hiero-consensus-node/pull/25610) by [@joshmarinacci](https://github.com/joshmarinacci)
  * warn that standalone TransactionExecutors perform no contract-key verification [#26273](https://github.com/hiero-ledger/hiero-consensus-node/pull/26273) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * Minor fixes in knowledge base [#26302](https://github.com/hiero-ledger/hiero-consensus-node/pull/26302) by [@netopyr](https://github.com/netopyr)
  * Document consensus optimization in KB [#26271](https://github.com/hiero-ledger/hiero-consensus-node/pull/26271) by [@poulok](https://github.com/poulok)
  * Update consensus-layer wiring diagram [#26147](https://github.com/hiero-ledger/hiero-consensus-node/pull/26147) by [@poulok](https://github.com/poulok)
  * Add init judge explanation [#26119](https://github.com/hiero-ledger/hiero-consensus-node/pull/26119) by [@poulok](https://github.com/poulok)
  * fix readme links and update status badges [#26127](https://github.com/hiero-ledger/hiero-consensus-node/pull/26127) by [@andrewb1269](https://github.com/andrewb1269)
  * Improve consensus-layer wiring diagram [#26100](https://github.com/hiero-ledger/hiero-consensus-node/pull/26100) by [@poulok](https://github.com/poulok)
  * Hashgraph Invariants [#25966](https://github.com/hiero-ledger/hiero-consensus-node/pull/25966) by [@netopyr](https://github.com/netopyr)
  * Add CLAUDE.md for consensus layer KB [#26052](https://github.com/hiero-ledger/hiero-consensus-node/pull/26052) by [@poulok](https://github.com/poulok)
  * 25447: Clarify run configurations in swirlds-benchmarks [#25450](https://github.com/hiero-ledger/hiero-consensus-node/pull/25450) by [@thenswan](https://github.com/thenswan)
  * Update knowledge base with multiple other parents change [#25929](https://github.com/hiero-ledger/hiero-consensus-node/pull/25929) by [@netopyr](https://github.com/netopyr)
  * Update docs for new workflow names [#25960](https://github.com/hiero-ledger/hiero-consensus-node/pull/25960) by [@rbarker-dev](https://github.com/rbarker-dev)
  * cleanup knowledge base format [#25926](https://github.com/hiero-ledger/hiero-consensus-node/pull/25926) by [@netopyr](https://github.com/netopyr)
  * Dedup knowledge base [#25900](https://github.com/hiero-ledger/hiero-consensus-node/pull/25900) by [@poulok](https://github.com/poulok)
  * Adjust the protobuf comments for BlockItem to reflect correct field item rules. [#25762](https://github.com/hiero-ledger/hiero-consensus-node/pull/25762) by [@jsync-swirlds](https://github.com/jsync-swirlds)
  * Extract state initialization [#26429](https://github.com/hiero-ledger/hiero-consensus-node/pull/26429) by [@poulok](https://github.com/poulok)
  * Move test to hashgraph module [#26391](https://github.com/hiero-ledger/hiero-consensus-node/pull/26391) by [@poulok](https://github.com/poulok)
  * Make Consensus Layer construction eager [#26291](https://github.com/hiero-ledger/hiero-consensus-node/pull/26291) by [@poulok](https://github.com/poulok)
  * Introduce `ConsensusLayerFactory` [#26261](https://github.com/hiero-ledger/hiero-consensus-node/pull/26261) by [@poulok](https://github.com/poulok)
  * Remove consensus-state dependency from PCES module [#26222](https://github.com/hiero-ledger/hiero-consensus-node/pull/26222) by [@netopyr](https://github.com/netopyr)
  * delete legacy fee builders, relocate to FeeConstants [#26108](https://github.com/hiero-ledger/hiero-consensus-node/pull/26108) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee calculator engine and SPI [#26106](https://github.com/hiero-ledger/hiero-consensus-node/pull/26106) by [@aderevets](https://github.com/aderevets)
  * remove transitional createSimpleFeeSchedule flag [#26082](https://github.com/hiero-ledger/hiero-consensus-node/pull/26082) by [@aderevets](https://github.com/aderevets)
  * delete simpleFeesEnabled config field [#26065](https://github.com/hiero-ledger/hiero-consensus-node/pull/26065) by [@aderevets](https://github.com/aderevets)
  * stop reading simpleFeesEnabled in query and airdrop [#26029](https://github.com/hiero-ledger/hiero-consensus-node/pull/26029) by [@aderevets](https://github.com/aderevets)
  * clean up schedule fee tests [#25858](https://github.com/hiero-ledger/hiero-consensus-node/pull/25858) [#25996](https://github.com/hiero-ledger/hiero-consensus-node/pull/25996) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * remove legacy file fee suites [#25857](https://github.com/hiero-ledger/hiero-consensus-node/pull/25857) [#25980](https://github.com/hiero-ledger/hiero-consensus-node/pull/25980) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * 25854 - clean up consensus fee tests [#25965](https://github.com/hiero-ledger/hiero-consensus-node/pull/25965) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * Move event stream classes out of `swirlds-platform-core` [#25794](https://github.com/hiero-ledger/hiero-consensus-node/pull/25794) by [@poulok](https://github.com/poulok)
  * drop dead legacy fee code from handlers [#25976](https://github.com/hiero-ledger/hiero-consensus-node/pull/25976) by [@aderevets](https://github.com/aderevets)
  * drop simpleFeesEnabled from high-volume checks [#25974](https://github.com/hiero-ledger/hiero-consensus-node/pull/25974) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee SPI surface [#25917](https://github.com/hiero-ledger/hiero-consensus-node/pull/25917) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee methods from token and crypto handlers [#25913](https://github.com/hiero-ledger/hiero-consensus-node/pull/25913) by [@aderevets](https://github.com/aderevets)
  * Clean up crypto fee tests 25856 [#25963](https://github.com/hiero-ledger/hiero-consensus-node/pull/25963) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * Move two test fixture classes out of `swirlds-platform-core` [#25910](https://github.com/hiero-ledger/hiero-consensus-node/pull/25910) by [@poulok](https://github.com/poulok)
  * remove legacy fee methods from network admin handlers [#25916](https://github.com/hiero-ledger/hiero-consensus-node/pull/25916) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee methods from address book handlers [#25915](https://github.com/hiero-ledger/hiero-consensus-node/pull/25915) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee methods from consensus handlers [#25914](https://github.com/hiero-ledger/hiero-consensus-node/pull/25914) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee methods from smart contract handlers [#25891](https://github.com/hiero-ledger/hiero-consensus-node/pull/25891) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee methods from schedule handlers [#25890](https://github.com/hiero-ledger/hiero-consensus-node/pull/25890) by [@aderevets](https://github.com/aderevets)
  * remove legacy fee methods from file handlers [#25889](https://github.com/hiero-ledger/hiero-consensus-node/pull/25889) by [@aderevets](https://github.com/aderevets)
  * Move `MerkleSerializationException` [#25901](https://github.com/hiero-ledger/hiero-consensus-node/pull/25901) by [@poulok](https://github.com/poulok)
  * (Release 0.77) fix stale catch-up gate in Solo block-stream cutover [#26668](https://github.com/hiero-ledger/hiero-consensus-node/pull/26668) by [@ibankov](https://github.com/ibankov)
  * Cherry-pick: Replace CryptoGetAccountBalance with CryptoGetInfo in yahcli [#26814](https://github.com/hiero-ledger/hiero-consensus-node/pull/26814) by [@mhess-swl](https://github.com/mhess-swl)
  * Fix partition experiments [#26367](https://github.com/hiero-ledger/hiero-consensus-node/pull/26367) by [@netopyr](https://github.com/netopyr)
  * Stabilize Otter Communication [#26336](https://github.com/hiero-ledger/hiero-consensus-node/pull/26336) by [@netopyr](https://github.com/netopyr)
  * Stabilize ToxiProxy handling for chaos tests [#26297](https://github.com/hiero-ledger/hiero-consensus-node/pull/26297) by [@netopyr](https://github.com/netopyr)
  * Extend HSCS test coverage [#26283](https://github.com/hiero-ledger/hiero-consensus-node/pull/26283) by [@stoyanov-st](https://github.com/stoyanov-st)
  * Fix flaky ReconnetTest [#26313](https://github.com/hiero-ledger/hiero-consensus-node/pull/26313) by [@netopyr](https://github.com/netopyr)
  * Small improvements of chaos test [#26296](https://github.com/hiero-ledger/hiero-consensus-node/pull/26296) by [@netopyr](https://github.com/netopyr)
  * sync solo 076-to-077 cutover script to 075 pattern + add adhoc test scenario [#25995](https://github.com/hiero-ledger/hiero-consensus-node/pull/25995) by [@ibankov](https://github.com/ibankov)
  * Add Solo adhoc block node outage test backpressure [#25689](https://github.com/hiero-ledger/hiero-consensus-node/pull/25689) by [@derektriley](https://github.com/derektriley)
  * drop --upgrade-version and log real source -> target versions [#26186](https://github.com/hiero-ledger/hiero-consensus-node/pull/26186) by [@ruslanvelkov-beep](https://github.com/ruslanvelkov-beep)
  * remove legacy dual-mode fee assertion helpers [#26109](https://github.com/hiero-ledger/hiero-consensus-node/pull/26109) by [@aderevets](https://github.com/aderevets)
  * drop simpleFeesEnabled branches from simple-fee suites [#26028](https://github.com/hiero-ledger/hiero-consensus-node/pull/26028) by [@aderevets](https://github.com/aderevets)
  * drop legacy token fee suites, mirror cases to TSSF [#25984](https://github.com/hiero-ledger/hiero-consensus-node/pull/25984) by [@aderevets](https://github.com/aderevets)
  * e2e cutover — rc.6 labels, CN self-download of WRAPS proving key, drop nginx helper [#25923](https://github.com/hiero-ledger/hiero-consensus-node/pull/25923) by [@ibankov](https://github.com/ibankov)
  * adjusted baselines for CITR SDPT [#25956](https://github.com/hiero-ledger/hiero-consensus-node/pull/25956) [#25957](https://github.com/hiero-ledger/hiero-consensus-node/pull/25957) by [@alex-kuzmin-hg](https://github.com/alex-kuzmin-hg)

  **Full Release Notes**: [**v0.77.0**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.77.0)
...
## Release v0.76
<Check>
  **MAINNET UPDATED: AUGUST 28, 2026**
</Check>
<Check>
  **TESTNET UPDATED: SEPTEMBER 1, 2026**
</Check>

### [**Build 0.76.4**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.76.4)

<Accordion title="What's Changed">

### **Bug Fixes**

  * Block royalty payments even when receiver is exempt from in-scope fallback fee [#27069](https://github.com/hiero-ledger/hiero-consensus-node/pull/27069) by [@joshmarinacci](https://github.com/joshmarinacci)
  * ContractValidationRule order fix [#27068](https://github.com/hiero-ledger/hiero-consensus-node/pull/27068) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Modify the language around folding beneficiary mappings into the root builder at staking finalization [#27147](https://github.com/hiero-ledger/hiero-consensus-node/pull/27147) by [@joshmarinacci](https://github.com/joshmarinacci)
  * don't advance beneficiary stake metadata for rewards redirected from a deleted account [#27113](https://github.com/hiero-ledger/hiero-consensus-node/pull/27113) by [@joshmarinacci](https://github.com/joshmarinacci)
  * deleting a rewardable stakee no longer freezes its indirect stakers [#27112](https://github.com/hiero-ledger/hiero-consensus-node/pull/27112) by [@joshmarinacci](https://github.com/joshmarinacci)
  * isolate scheduled-transaction failures in the expiry scan [#27067](https://github.com/hiero-ledger/hiero-consensus-node/pull/27067) by [@joshmarinacci](https://github.com/joshmarinacci)
  * replay processed inner fees when a later inner exceeds the record limit [#27066](https://github.com/hiero-ledger/hiero-consensus-node/pull/27066) by [@joshmarinacci](https://github.com/joshmarinacci)
  * enforce file-update authorization at ingest and charge failed attempts [#27063](https://github.com/hiero-ledger/hiero-consensus-node/pull/27063) by [@joshmarinacci](https://github.com/joshmarinacci)
  * guard exchange-rate fee conversion against non-positive centEquiv and overflow [#27062](https://github.com/hiero-ledger/hiero-consensus-node/pull/27062) by [@joshmarinacci](https://github.com/joshmarinacci)
  * require a node-controlled payer for NODE-category transactions [#27061](https://github.com/hiero-ledger/hiero-consensus-node/pull/27061) by [@joshmarinacci](https://github.com/joshmarinacci)
  * enforce contract trace-data limit for batch and scheduled calls [#27102](https://github.com/hiero-ledger/hiero-consensus-node/pull/27102) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Cherry-pick stale createdContractIds, atomic batch rollback fixes [#27101](https://github.com/hiero-ledger/hiero-consensus-node/pull/27101) by [@joshmarinacci](https://github.com/joshmarinacci)
  * reject duplicate non-repeated fields when extracting query payment bytes [#27100](https://github.com/hiero-ledger/hiero-consensus-node/pull/27100) by [@joshmarinacci](https://github.com/joshmarinacci)
  * reject token transfers in query payments [#27099](https://github.com/hiero-ledger/hiero-consensus-node/pull/27099) by [@joshmarinacci](https://github.com/joshmarinacci)
  * validate migration-root-hash vote bodies and harden vote tallying and storage ordering [#27098](https://github.com/hiero-ledger/hiero-consensus-node/pull/27098) by [@joshmarinacci](https://github.com/joshmarinacci)
  * fold beneficiary mappings into the root builder at staking finalization [#27097](https://github.com/hiero-ledger/hiero-consensus-node/pull/27097) by [@joshmarinacci](https://github.com/joshmarinacci)
  * handle two bugs in reclaiming throttle capacity [#27096](https://github.com/hiero-ledger/hiero-consensus-node/pull/27096) by [@joshmarinacci](https://github.com/joshmarinacci)
  * make prng and exchange rate contracts stateless [#27095](https://github.com/hiero-ledger/hiero-consensus-node/pull/27095) by [@joshmarinacci](https://github.com/joshmarinacci)
  * optimise pre handle workflow [#27058](https://github.com/hiero-ledger/hiero-consensus-node/pull/27058) by [@joshmarinacci](https://github.com/joshmarinacci)

### **Other Changes**

  * upgrade io.netty:netty-codec-http to 4.2.17.Final [#27070](https://github.com/hiero-ledger/hiero-consensus-node/pull/27070) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Atomic batch EVM tx restriction [#27114](https://github.com/hiero-ledger/hiero-consensus-node/pull/27114) by [@joshmarinacci](https://github.com/joshmarinacci)
  * `streamMode=BOTH` block size circuit breaker [#27072](https://github.com/hiero-ledger/hiero-consensus-node/pull/27072) by [@joshmarinacci](https://github.com/joshmarinacci)
  * broken TCK & JS SDK XTS tests [#27059](https://github.com/hiero-ledger/hiero-consensus-node/pull/27059) by [@joshmarinacci](https://github.com/joshmarinacci)
  * replace hiero-solo-action [#26749](https://github.com/hiero-ledger/hiero-consensus-node/pull/26749) by [@andrewb1269](https://github.com/andrewb1269)

  **Full Release Notes**: [**v0.76.4**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.76.4)

</Accordion>

### [**Build 0.76.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.76.1)

<Accordion title="What's Changed">

### **Bug Fixes**

  * update solo version to v0.79.1 [#26708](https://github.com/hiero-ledger/hiero-consensus-node/pull/26708) by [@andrewb1269](https://github.com/andrewb1269)
  * 26656: (0.76) Increase AsyncInputStream max message size limit [#26658](https://github.com/hiero-ledger/hiero-consensus-node/pull/26658) by [@artemananiev](https://github.com/artemananiev)

### **Other Changes**

  * Disable TSS [#26672](https://github.com/hiero-ledger/hiero-consensus-node/pull/26672) by [@derektriley](https://github.com/derektriley)

  **Full Release Notes**: [**v0.76.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.76.1)
...
### **Features**
  ...
  * [0.75 CP 05/12] cherry-pick (0.75): SystemContracts input size limit [#26381](https://github.com/hiero-ledger/hiero-consensus-node/pull/26381) by [@aderevets](https://github.com/aderevets)

### **Bug Fixes**

  * [0.75 CP 12/12] cherry-pick (0.75): Fix jumpstart migration PBJ parsing [#26384](https://github.com/hiero-ledger/hiero-consensus-node/pull/26384) by [@aderevets](https://github.com/aderevets)
  * [0.75 CP 10/12] cherry-pick (0.75): non-deterministic gossip CA certificate validation [#26383](https://github.com/hiero-ledger/hiero-consensus-node/pull/26383) by [@aderevets](https://github.com/aderevets)
  * Cherry-pick (0.75): XTS fixes for BN Comms and JRS [#455](https://github.com/hiero-ledger/hiero-consensus-node/pull/455) [#26410](https://github.com/hiero-ledger/hiero-consensus-node/pull/26410) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * Cherry-pick (0.75): Feature/ops duration throtling for insuffuci… [#26409](https://github.com/hiero-ledger/hiero-consensus-node/pull/26409) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * [0.75 CP 03/12] cherry-pick (0.75): token association refactoring [#26380](https://github.com/hiero-ledger/hiero-consensus-node/pull/26380) by [@aderevets](https://github.com/aderevets)

### **Other Changes**

  * [0.75 CP 11/12] cherry-pick (0.75): mainnet jumpstart application.properties [#26378](https://github.com/hiero-ledger/hiero-consensus-node/pull/26378) by [@aderevets](https://github.com/aderevets)
  * [0.75 CP 08/12] cherry-pick (0.75): reduce block buffer size from 150 to 30 blocks [#26388](https://github.com/hiero-ledger/hiero-consensus-node/pull/26388) by [@aderevets](https://github.com/aderevets)
  * [0.75 CP 06/12] cherry-pick (0.75): Clip trace data [#26382](https://github.com/hiero-ledger/hiero-consensus-node/pull/26382) by [@aderevets](https://github.com/aderevets)
  * Update PBJ version 0.15.9 and add tests [#26073](https://github.com/hiero-ledger/hiero-consensus-node/pull/26073) by [@derektriley](https://github.com/derektriley)

  **Full Release Notes**: [**v0.75.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.75.1)

</Accordion>

### [**Build 0.75.0**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.75.0)

<Accordion title="What's Changed">

### **Features**

  * Remove unused/duplicate reconnect code [#25320](https://github.com/hiero-ledger/hiero-consensus-node/pull/25320) by [@akugal](https://github.com/akugal)
  * cleanup/improve MerkelDB tests [#25452](https://github.com/hiero-ledger/hiero-consensus-node/pull/25452) by [@akugal](https://github.com/akugal)
  * 25370 Add continuity check to `apply-blocks` command [#25448](https://github.com/hiero-ledger/hiero-consensus-node/pull/25448) by [@imalygin](https://github.com/imalygin)
  * 25301 Added support for the rate limiter to `apply-blocks` command [#25363](https://github.com/hiero-ledger/hiero-consensus-node/pull/25363) by [@imalygin](https://github.com/imalygin)
  * 25222: HalfDiskHashMap to write object key buckets in parallel on multiple threads [#25281](https://github.com/hiero-ledger/hiero-consensus-node/pull/25281) by [@artemananiev](https://github.com/artemananiev)
  * Refactor batch transaction rollback handling [#25174](https://github.com/hiero-ledger/hiero-consensus-node/pull/25174) by [@lukasz-hashgraph](https://github.com/lukasz-hashgraph)
  * Align record files with signed states [#25234](https://github.com/hiero-ledger/hiero-consensus-node/pull/25234) by [@derektriley](https://github.com/derektriley)
  * migrate protobuf parsing to parseStrict and add test coverage [#25273](https://github.com/hiero-ledger/hiero-consensus-node/pull/25273) by [@viniciusjssouza](https://github.com/viniciusjssouza)
  * 25299 : Relax state validator to accept `VirtualMapState` snapshots [#25300](https://github.com/hiero-ledger/hiero-consensus-node/pull/25300) by [@imalygin](https://github.com/imalygin)
  * extract root node exchange from reconnect tasks [#25242](https://github.com/hiero-ledger/hiero-consensus-node/pull/25242) by [@akugal](https://github.com/akugal)
  * 24999: improve lifecycle in swirlds-benchmarks [#25038](https://github.com/hiero-ledger/hiero-consensus-node/pull/25038) by [@thenswan](https://github.com/thenswan)
  * Execute block stream cutover logic [#24227](https://github.com/hiero-ledger/hiero-consensus-node/pull/24227) by [@mhess-swl](https://github.com/mhess-swl)
  * Replace validation slack_report.json with validation_errors.txt [#23355](https://github.com/hiero-ledger/hiero-consensus-node/pull/23355)
  * Tighten jumpstart migration conditions [#24986](https://github.com/hiero-ledger/hiero-consensus-node/pull/24986) by [@mhess-swl](https://github.com/mhess-swl)
  * HAPI tests and DSL verbs for WRB streaming [#24958](https://github.com/hiero-ledger/hiero-consensus-node/pull/24958) by [@aderevets](https://github.com/aderevets)
  * Change tipset algorithm to use event sequence number instead of NGen [#24991](https://github.com/hiero-ledger/hiero-consensus-node/pull/24991) by [@abies](https://github.com/abies)
  * Async delete leaves out of range during reconnect [#25123](https://github.com/hiero-ledger/hiero-consensus-node/pull/25123) by [@akugal](https://github.com/akugal)
  * route wrapped record block items through GrpcBlockItemWriter [#24889](https://github.com/hiero-ledger/hiero-consensus-node/pull/24889) by [@aderevets](https://github.com/aderevets)
  * 24875 Compaction - consolidation tasks to decrease small file count [#25071](https://github.com/hiero-ledger/hiero-consensus-node/pull/25071) by [@imalygin](https://github.com/imalygin)
  * 23294: re-enable async snapshot optimization [#24202](https://github.com/hiero-ledger/hiero-consensus-node/pull/24202) by [@thenswan](https://github.com/thenswan)
  * Extract reconnect logic from VirtualMap. [#24662](https://github.com/hiero-ledger/hiero-consensus-node/pull/24662) by [@akugal](https://github.com/akugal)
  * New Ad hoc Solo Tests Workflow and WRB migration test [#24904](https://github.com/hiero-ledger/hiero-consensus-node/pull/24904) by [@derektriley](https://github.com/derektriley)
  * 25043: Remove redundant Main class from swirlds-benchmarks [#25044](https://github.com/hiero-ledger/hiero-consensus-node/pull/25044) by [@thenswan](https://github.com/thenswan)
  * Standalone Fee Calculator improvements [#24791](https://github.com/hiero-ledger/hiero-consensus-node/pull/24791) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Add event sequence number managed in orphan buffer [#24937](https://github.com/hiero-ledger/hiero-consensus-node/pull/24937) by [@abies](https://github.com/abies)
  * Add support for remote SSH network for Sloth testing [#24834](https://github.com/hiero-ledger/hiero-consensus-node/pull/24834) by [@timo0](https://github.com/timo0)

### **Bug Fixes**

  * [0.75 CP 02/12] cherry-pick (0.75): Refactor access list encoding [#26379](https://github.com/hiero-ledger/hiero-consensus-node/pull/26379) by [@aderevets](https://github.com/aderevets)
  * [0.75 CP 01/12] cherry-pick (0.75): signSchedule(address,bytes) signatureMap size limit [#26387](https://github.com/hiero-ledger/hiero-consensus-node/pull/26387) by [@aderevets](https://github.com/aderevets)
  * cherry-pick: Add `BlockRecordManager.Lifecycle` for `streamMode=RECORDS` [#25755](https://github.com/hiero-ledger/hiero-consensus-node/pull/25755) by [@derektriley](https://github.com/derektriley)
  * cherry-pick: Allow multiple WRB Jumpstarts [#25752](https://github.com/hiero-ledger/hiero-consensus-node/pull/25752) by [@derektriley](https://github.com/derektriley)
  * cherry-pick: WRB BlockHeader.blockTimestamp incorrectly set to blockCreationTime instead of first consensus timestamp [#25750](https://github.com/hiero-ledger/hiero-consensus-node/pull/25750) by [@derektriley](https://github.com/derektriley)
  * NPE on null chainId [#25279](https://github.com/hiero-ledger/hiero-consensus-node/pull/25279) [#25466](https://github.com/hiero-ledger/hiero-consensus-node/pull/25466) by @0x-ds, @gkozyryatskyy
  * handle `happyPathWithoutReuseForAtomicBatch` flake [#25440](https://github.com/hiero-ledger/hiero-consensus-node/pull/25440) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * silence JVM warnings in Solo Latitude JAVA_OPTS [#25456](https://github.com/hiero-ledger/hiero-consensus-node/pull/25456) by [@aderevets](https://github.com/aderevets)
  * use parse not parseStrict for block nodes config [#25455](https://github.com/hiero-ledger/hiero-consensus-node/pull/25455) by [@aderevets](https://github.com/aderevets)
  * 25445: LongListDisk temp directories are not cleaned up [#25446](https://github.com/hiero-ledger/hiero-consensus-node/pull/25446) by [@thenswan](https://github.com/thenswan)
  * 25374: Reduce object allocations in VirtualHasher by not serializing leaf values [#25411](https://github.com/hiero-ledger/hiero-consensus-node/pull/25411) by [@artemananiev](https://github.com/artemananiev)
  * 25239 silence-jvm-warnings-in-consensus-node [#25287](https://github.com/hiero-ledger/hiero-consensus-node/pull/25287) by [@aderevets](https://github.com/aderevets)
  * generate signing key for :app:run so node boots past key loading [#25342](https://github.com/hiero-ledger/hiero-consensus-node/pull/25342) by [@aderevets](https://github.com/aderevets)
  * 25417: CryptoBench reports stray running threads, deletes its data directory unconditionally [#25438](https://github.com/hiero-ledger/hiero-consensus-node/pull/25438) by [@thenswan](https://github.com/thenswan)
  * delete snapshot dir on detach [#25409](https://github.com/hiero-ledger/hiero-consensus-node/pull/25409) by [@akugal](https://github.com/akugal)
  * 25163 surface precheck status when yahcli sysfile upload fails [#25209](https://github.com/hiero-ledger/hiero-consensus-node/pull/25209) by [@aderevets](https://github.com/aderevets)
  * 25365 Added missing `PathsConfig` [#25366](https://github.com/hiero-ledger/hiero-consensus-node/pull/25366) by [@imalygin](https://github.com/imalygin)
  * propagate transactionOffsetNanos through platform-sdk consensus timestamp chain [#25250](https://github.com/hiero-ledger/hiero-consensus-node/pull/25250) by [@Jeffrey-morgan34](https://github.com/Jeffrey-morgan34)
  * 25327 Filter `compactionInProgress` files in coordinator phase 1 filtering [#25329](https://github.com/hiero-ledger/hiero-consensus-node/pull/25329) by [@imalygin](https://github.com/imalygin)
  * Make sure to restore connectivity after starting the otter node [#25260](https://github.com/hiero-ledger/hiero-consensus-node/pull/25260) by [@abies](https://github.com/abies)
  * restore log output by bundling a dedicated log4j2 config [#25131](https://github.com/hiero-ledger/hiero-consensus-node/pull/25131) by [@Chinnmay](https://github.com/Chinnmay)
  * 25277: LongListDisk is not thread safe [#25280](https://github.com/hiero-ledger/hiero-consensus-node/pull/25280) by [@artemananiev](https://github.com/artemananiev)
  * Resolve Failing BN XTS regression panel [#24879](https://github.com/hiero-ledger/hiero-consensus-node/pull/24879) by [@Nana-EC](https://github.com/Nana-EC)
  * Simultaneous merge [#25252](https://github.com/hiero-ledger/hiero-consensus-node/pull/25252) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * 25171: Async snapshot intermittent failures [#25189](https://github.com/hiero-ledger/hiero-consensus-node/pull/25189) by [@thenswan](https://github.com/thenswan)
  * 25225 Fix race condition in EntityIdUniquenessValidator [#25226](https://github.com/hiero-ledger/hiero-consensus-node/pull/25226) by [@imalygin](https://github.com/imalygin)
  * 25204 Fix race condition in file assignment and reduce consolidation aggressiveness [#25216](https://github.com/hiero-ledger/hiero-consensus-node/pull/25216) by [@imalygin](https://github.com/imalygin)
  * 25162 silence yahcli JDK 25 warnings from protobuf and netty [#25199](https://github.com/hiero-ledger/hiero-consensus-node/pull/25199) by [@aderevets](https://github.com/aderevets)
  * 25177: PBJ version update to 0.15.2 [#25178](https://github.com/hiero-ledger/hiero-consensus-node/pull/25178) by [@artemananiev](https://github.com/artemananiev)
  * do not increment the wanted block when BlockNodeStatus#latestBlockAvailable is -1 [#25185](https://github.com/hiero-ledger/hiero-consensus-node/pull/25185) by [@timfn-hg](https://github.com/timfn-hg)
  * 25020 Registered missing ModulesConfig [#25021](https://github.com/hiero-ledger/hiero-consensus-node/pull/25021) by [@imalygin](https://github.com/imalygin)
  * disable state.saveStateAsync for restart/reconnect HAPI tests [#25153](https://github.com/hiero-ledger/hiero-consensus-node/pull/25153) by [@AlexKehayov](https://github.com/AlexKehayov)
  * Improve conditional for charging custom fees surcharge in Token Create [#25017](https://github.com/hiero-ledger/hiero-consensus-node/pull/25017) by [@joshmarinacci](https://github.com/joshmarinacci)
  * stabilize node reward HAPI tests by forcing block boundaries before state mutations [#24971](https://github.com/hiero-ledger/hiero-consensus-node/pull/24971) by [@viniciusjssouza](https://github.com/viniciusjssouza)
  * signature requirements and other improvements (HIP-1299 and HIP-869) [#25061](https://github.com/hiero-ledger/hiero-consensus-node/pull/25061) by [@petreze](https://github.com/petreze)
  * streamsAreValid flake from incomplete next-block lookup [#25097](https://github.com/hiero-ledger/hiero-consensus-node/pull/25097) by [@AlexKehayov](https://github.com/AlexKehayov)
  * raise platform.wiring.healthLogThreshold to 5s for hapiTestRestart [#25105](https://github.com/hiero-ledger/hiero-consensus-node/pull/25105) by [@AlexKehayov](https://github.com/AlexKehayov)
  * override HAPI Restart maximumPermissibleUnhealthySeconds, broaden CI log globs [#25085](https://github.com/hiero-ledger/hiero-consensus-node/pull/25085) by [@AlexKehayov](https://github.com/AlexKehayov)
  * CannotDeleteSystemEntitiesSuite silent failures and hardcoded shard/realm [#24739](https://github.com/hiero-ledger/hiero-consensus-node/pull/24739) by [@JivkoKelchev](https://github.com/JivkoKelchev)
  * set Atomic Batch CI runner to XL to avoid resource exhaustion [#25079](https://github.com/hiero-ledger/hiero-consensus-node/pull/25079) by [@AlexKehayov](https://github.com/AlexKehayov)
  ...
  * ignore recoverable WRAPS signing retry warning in log validator [#25063](https://github.com/hiero-ledger/hiero-consensus-node/pull/25063) by [@Evdokia-Georgieva](https://github.com/Evdokia-Georgieva)
  * failing transactionOpsDurationMetricsAreRecordedAndRetrieved test [#25055](https://github.com/hiero-ledger/hiero-consensus-node/pull/25055) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
  * stabilize failToUpdateNFTsMetadataWithEmptySerialNumbers by using virtual time [#25058](https://github.com/hiero-ledger/hiero-consensus-node/pull/25058) by [@AlexKehayov](https://github.com/AlexKehayov)
  * skip previous txn ids in `ValidContractIdsAssertion` [#25030](https://github.com/hiero-ledger/hiero-consensus-node/pull/25030) by [@petreze](https://github.com/petreze)
  * stabilize irreversiblePrecedingItemsAsExpected by flushing stream before watcher registers [#25027](https://github.com/hiero-ledger/hiero-consensus-node/pull/25027) by [@Evdokia-Georgieva](https://github.com/Evdokia-Georgieva)
  * Reduce noisy logs in the connection monitor when the detected changes are unchanged [#25036](https://github.com/hiero-ledger/hiero-consensus-node/pull/25036) by [@timfn-hg](https://github.com/timfn-hg)
  * charge NFT rate if amount == 0 AND metadata is not empty. [#25014](https://github.com/hiero-ledger/hiero-consensus-node/pull/25014) by [@joshmarinacci](https://github.com/joshmarinacci)
  * Fix flaky OS Entropy Check Test by increasing timeout [#25037](https://github.com/hiero-ledger/hiero-consensus-node/pull/25037) by [@poulok](https://github.com/poulok)
  * Stabilize fridayThe13thSpec by deferring expiry to execution time [#25026](https://github.com/hiero-ledger/hiero-consensus-node/pull/25026) by [@Evdokia-Georgieva](https://github.com/Evdokia-Georgieva)
  * increase expiry offset to deal with the timing issue under load [#24993](https://github.com/hiero-ledger/hiero-consensus-node/pull/24993) by [@Grigorov-Georgi](https://github.com/Grigorov-Georgi)
...
### **Other Changes**
  ...
  * Update BlockRecordStreamConfig writeWrappedRecordFileBlockHashesToDisk [#25737](https://github.com/hiero-ledger/hiero-consensus-node/pull/25737) by [@derektriley](https://github.com/derektriley)
  * previewnet jumpstart properties [#25708](https://github.com/hiero-ledger/hiero-consensus-node/pull/25708) by [@derektriley](https://github.com/derektriley)
  * cherry-pick: fix of SDLT Latency metrics NLG 0.14.3 [#25624](https://github.com/hiero-ledger/hiero-consensus-node/pull/25624) by [@derektriley](https://github.com/derektriley)
  * cherry-pick: Enable WRB Streaming in MATS and Update Block Node version [#25564](https://github.com/hiero-ledger/hiero-consensus-node/pull/25564) by [@derektriley](https://github.com/derektriley)
  * (0.75) Update Mainnet throttles for CryptoGetAccountBalanceQuery [#25586](https://github.com/hiero-ledger/hiero-consensus-node/pull/25586) by [@derektriley](https://github.com/derektriley)
  * Create v0.75.0 BlockRecordSchema with migration [#25507](https://github.com/hiero-ledger/hiero-consensus-node/pull/25507) [#25534](https://github.com/hiero-ledger/hiero-consensus-node/pull/25534) by [@derektriley](https://github.com/derektriley)
  * (0.75) Wait for proofs + ACKs for pending blocks in freeze `onSealConsensusRound()` [#25537](https://github.com/hiero-ledger/hiero-consensus-node/pull/25537) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Only log when a slow or stalled BN connection is detected [#25488](https://github.com/hiero-ledger/hiero-consensus-node/pull/25488) [#25563](https://github.com/hiero-ledger/hiero-consensus-node/pull/25563) by [@timfn-hg](https://github.com/timfn-hg)
  * Adopt TSS lib `3.8.1` [#25392](https://github.com/hiero-ledger/hiero-consensus-node/pull/25392) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Reduce block timestamp selection to first event or round timestamps [#25217](https://github.com/hiero-ledger/hiero-consensus-node/pull/25217) by [@mhess-swl](https://github.com/mhess-swl)
  * Disable hooks by default [#25406](https://github.com/hiero-ledger/hiero-consensus-node/pull/25406) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Cleanup consensus-pces-impl dependencies [#25362](https://github.com/hiero-ledger/hiero-consensus-node/pull/25362) by [@poulok](https://github.com/poulok)
  * bump grpc from 1.73.0 to 1.81.0 in /hiero-dependency-versions [#23888](https://github.com/hiero-ledger/hiero-consensus-node/pull/23888) by @dependabot[bot]
  * Update ingest parse metrics [#25262](https://github.com/hiero-ledger/hiero-consensus-node/pull/25262) by [@derektriley](https://github.com/derektriley)
  * ThrottleAccumulator ContractID getAssociationCount [#25418](https://github.com/hiero-ledger/hiero-consensus-node/pull/25418) by [@derektriley](https://github.com/derektriley)
  * Keep creating events when `FREEZING` until all blocks are signed [#25268](https://github.com/hiero-ledger/hiero-consensus-node/pull/25268) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Add record file running hash validator [#25368](https://github.com/hiero-ledger/hiero-consensus-node/pull/25368) by [@derektriley](https://github.com/derektriley)
  * bump gradle-wrapper from 9.3.1 to 9.5.0 [#25278](https://github.com/hiero-ledger/hiero-consensus-node/pull/25278) by @dependabot[bot]
  * Remove blockStream.enableStateProofs config [#25364](https://github.com/hiero-ledger/hiero-consensus-node/pull/25364) by [@derektriley](https://github.com/derektriley)
  * fix codeowners expression for 'HAPI Build Files' [#25387](https://github.com/hiero-ledger/hiero-consensus-node/pull/25387) by [@jjohannes](https://github.com/jjohannes)
  * Clean up remaining swirlds-common dependencies [#25286](https://github.com/hiero-ledger/hiero-consensus-node/pull/25286) by [@netopyr](https://github.com/netopyr)
  * Add test coverage for new transaction offset [#25338](https://github.com/hiero-ledger/hiero-consensus-node/pull/25338) by [@poulok](https://github.com/poulok)
  * Clean up dependencies of hashgraph-impl tests [#25285](https://github.com/hiero-ledger/hiero-consensus-node/pull/25285) by [@netopyr](https://github.com/netopyr)
  * Replace `LegacyTemporaryFileBuilder` with `FileSystemManager` [#25292](https://github.com/hiero-ledger/hiero-consensus-node/pull/25292) by [@poulok](https://github.com/poulok)
  * add dashboard for Node Rewards monitoring [#25303](https://github.com/hiero-ledger/hiero-consensus-node/pull/25303) by [@viniciusjssouza](https://github.com/viniciusjssouza)
  * clean up test dependencies of gossip-impl [#25274](https://github.com/hiero-ledger/hiero-consensus-node/pull/25274) by [@netopyr](https://github.com/netopyr)
  * Update max size for sending messages to the block node to be 125 MB [#25275](https://github.com/hiero-ledger/hiero-consensus-node/pull/25275) by [@timfn-hg](https://github.com/timfn-hg)
  * Move unit tests to their respective modules [#25259](https://github.com/hiero-ledger/hiero-consensus-node/pull/25259) by [@netopyr](https://github.com/netopyr)
  * 25136: Adjust run config in swirlds-benchmarks [#25149](https://github.com/hiero-ledger/hiero-consensus-node/pull/25149) by [@thenswan](https://github.com/thenswan)
  * fix test dependencies in event stream module [#25231](https://github.com/hiero-ledger/hiero-consensus-node/pull/25231) by [@netopyr](https://github.com/netopyr)
  * List-of-RSA-signatures for WRBs [#25179](https://github.com/hiero-ledger/hiero-consensus-node/pull/25179) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  ...
  * Fix `(AccountID, TokenID)` field order in block stream `StateChanges` [#25172](https://github.com/hiero-ledger/hiero-consensus-node/pull/25172) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Write consensus snapshot to disk in saved state directory [#25068](https://github.com/hiero-ledger/hiero-consensus-node/pull/25068) by [@poulok](https://github.com/poulok)
  * move swirlds common unit tests [#25173](https://github.com/hiero-ledger/hiero-consensus-node/pull/25173) by [@netopyr](https://github.com/netopyr)
  * Minor Version Roll to 0.75.0-SNAPSHOT
  * Enhance BN connection observability and block selection on start [#25092](https://github.com/hiero-ledger/hiero-consensus-node/pull/25092) by [@timfn-hg](https://github.com/timfn-hg)
  * 25110 Added reference doc for the signed snapshot format [#25120](https://github.com/hiero-ledger/hiero-consensus-node/pull/25120) by [@imalygin](https://github.com/imalygin)
  * cleanup consensus state dependencies [#25165](https://github.com/hiero-ledger/hiero-consensus-node/pull/25165) by [@netopyr](https://github.com/netopyr)
  * Move MockAppender [#25166](https://github.com/hiero-ledger/hiero-consensus-node/pull/25166) by [@netopyr](https://github.com/netopyr)
  * Move Mnemonics to crypto module [#25158](https://github.com/hiero-ledger/hiero-consensus-node/pull/25158) by [@netopyr](https://github.com/netopyr)
  * move crypto functionality to crypto module [#25137](https://github.com/hiero-ledger/hiero-consensus-node/pull/25137) by [@netopyr](https://github.com/netopyr)
  * Add `BinaryStateChangesValidator` [#24982](https://github.com/hiero-ledger/hiero-consensus-node/pull/24982) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Make `FeeAccumulator` defensive, clamp hook gas limits [#25022](https://github.com/hiero-ledger/hiero-consensus-node/pull/25022) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  * Remove unused Chart class [#25125](https://github.com/hiero-ledger/hiero-consensus-node/pull/25125) by [@poulok](https://github.com/poulok)
  * Add swirlds log validation to HAPI tests [#25034](https://github.com/hiero-ledger/hiero-consensus-node/pull/25034) by [@poulok](https://github.com/poulok)
  * Be noisy if WRAPS enabled but artifact unavailable [#24379](https://github.com/hiero-ledger/hiero-consensus-node/pull/24379) by [@tinker-michaelj](https://github.com/tinker-michaelj)
  ...
  * update cancelled HAPI test processing in MATS [#25401](https://github.com/hiero-ledger/hiero-consensus-node/pull/25401) by [@andrewb1269](https://github.com/andrewb1269)
  * consolidate find commit author slack into a script [#25324](https://github.com/hiero-ledger/hiero-consensus-node/pull/25324) by [@joshmarinacci](https://github.com/joshmarinacci)
  * revert flaky test rerun, processing, issue creation [#25271](https://github.com/hiero-ledger/hiero-consensus-node/pull/25271) by [@andrewb1269](https://github.com/andrewb1269)
  * update trigger on unapprove PR workflow [#25265](https://github.com/hiero-ledger/hiero-consensus-node/pull/25265) by [@andrewb1269](https://github.com/andrewb1269)
  * switch PR title check to step-security/action-semantic-pull-request [#25220](https://github.com/hiero-ledger/hiero-consensus-node/pull/25220) by [@nathanklick](https://github.com/nathanklick)
  * Fix typo in SDLT [#25206](https://github.com/hiero-ledger/hiero-consensus-node/pull/25206) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Update MQPT for chewie json response [#25099](https://github.com/hiero-ledger/hiero-consensus-node/pull/25099) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Update step-security and initialize-github-job [#25127](https://github.com/hiero-ledger/hiero-consensus-node/pull/25127) by [@rbarker-dev](https://github.com/rbarker-dev)
  * remove empty parens on xts cancelled slack message [#25103](https://github.com/hiero-ledger/hiero-consensus-node/pull/25103) by [@andrewb1269](https://github.com/andrewb1269)
  * Add read chewie response logic to sdlt [#25091](https://github.com/hiero-ledger/hiero-consensus-node/pull/25091) by [@rbarker-dev](https://github.com/rbarker-dev)
  * Update adhoc SDPT to use the chewie values [#25086](https://github.com/hiero-ledger/hiero-consensus-node/pull/25086) by [@rbarker-dev](https://github.com/rbarker-dev)
  * update docs to reflect compile and spotless job [#25050](https://github.com/hiero-ledger/hiero-consensus-node/pull/25050) by [@andrewb1269](https://github.com/andrewb1269)
  * combine compile and spotless into a single job [#25035](https://github.com/hiero-ledger/hiero-consensus-node/pull/25035) by [@andrewb1269](https://github.com/andrewb1269)
  * Update language on slack reports and categories to use environment [#25029](https://github.com/hiero-ledger/hiero-consensus-node/pull/25029) by [@rbarker-dev](https://github.com/rbarker-dev)
  * document runUntilFailure parameter for flaky test investigation [#25321](https://github.com/hiero-ledger/hiero-consensus-node/pull/25321) by [@viniciusjssouza](https://github.com/viniciusjssouza)
  * Add PCES snapshot coordination ADR doc [#25304](https://github.com/hiero-ledger/hiero-consensus-node/pull/25304) by [@poulok](https://github.com/poulok)
  * Initial draft of consensus knowledge base [#25310](https://github.com/hiero-ledger/hiero-consensus-node/pull/25310) by [@netopyr](https://github.com/netopyr)
  * forbid AI origin/attribution markers in repo content [#25221](https://github.com/hiero-ledger/hiero-consensus-node/pull/25221) by [@nathanklick](https://github.com/nathanklick)
  * getCode() without a copy. [#24981](https://github.com/hiero-ledger/hiero-consensus-node/pull/24981) by [@cliffclick](https://github.com/cliffclick)
  * Move recycle bin to `consensus-utility` [#25341](https://github.com/hiero-ledger/hiero-consensus-node/pull/25341) by [@poulok](https://github.com/poulok)
  * Move `FileSystemManager`, simplify configuration [#25218](https://github.com/hiero-ledger/hiero-consensus-node/pull/25218) by [@poulok](https://github.com/poulok)
  * 25249 Refactor `BlockStreamRecoveryWorkflow` to use `BinaryState` [#25256](https://github.com/hiero-ledger/hiero-consensus-node/pull/25256) by [@imalygin](https://github.com/imalygin)
  * 25243 Refactor `BinaryStateChangesValidator` to use `BinaryState` [#25244](https://github.com/hiero-ledger/hiero-consensus-node/pull/25244) by [@imalygin](https://github.com/imalygin)
  * Move `FileUtils` [#25213](https://github.com/hiero-ledger/hiero-consensus-node/pull/25213) by [@poulok](https://github.com/poulok)
  * Extract gui module [#25062](https://github.com/hiero-ledger/hiero-consensus-node/pull/25062) by [@poulok](https://github.com/poulok)
  * cherry-pick: update CITR to Solo 0.76 [#25714](https://github.com/hiero-ledger/hiero-consensus-node/pull/25714) [#25719](https://github.com/hiero-ledger/hiero-consensus-node/pull/25719) [#25881](https://github.com/hiero-ledger/hiero-consensus-node/pull/25881) by [@alex-kuzmin-hg](https://github.com/alex-kuzmin-hg)
  * cherry-picked 25128 to 0.75: reapply latency metrics in nlg (25128) [#25190](https://github.com/hiero-ledger/hiero-consensus-node/pull/25190) [#25653](https://github.com/hiero-ledger/hiero-consensus-node/pull/25653) by [@alex-kuzmin-hg](https://github.com/alex-kuzmin-hg)
  * update NLG to 0.14.1 (25407) [#25410](https://github.com/hiero-ledger/hiero-consensus-node/pull/25410) by [@alex-kuzmin-hg](https://github.com/alex-kuzmin-hg)
  * fix TPS EMA in CryptoBench [#25372](https://github.com/hiero-ledger/hiero-consensus-node/pull/25372) by [@OlegMazurov](https://github.com/OlegMazurov)
  * Use pre-cutover state changes in binary replay [#25311](https://github.com/hiero-ledger/hiero-consensus-node/pull/25311) by [@mhess-swl](https://github.com/mhess-swl)
  * Add Github workflow for WRB streaming tests with solo [#25138](https://github.com/hiero-ledger/hiero-consensus-node/pull/25138) by [@ibankov](https://github.com/ibankov)
  * to fix missed mc utility (25181) [#25182](https://github.com/hiero-ledger/hiero-consensus-node/pull/25182) by [@alex-kuzmin-hg](https://github.com/alex-kuzmin-hg)
  * fix flaky com.hedera.services.bdd.suites.blocknode.BlockNodeBackPressureSuite#backPressureAllNodesCheckingScenario tes [#25104](https://github.com/hiero-ledger/hiero-consensus-node/pull/25104) by [@aderevets](https://github.com/aderevets)
  * use max K8S CPUs for perf tests (25024) [#25069](https://github.com/hiero-ledger/hiero-consensus-node/pull/25069) by [@alex-kuzmin-hg](https://github.com/alex-kuzmin-hg)

  **Full Release Notes**: [**v0.75.0**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.75.0)
...
### [**Build 0.74.3**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.74.3)

<Accordion title="What's Changed">

### **Features**

  * Cherry-pick (0.74): SystemContracts input size limit [#433](https://github.com/hiero-ledger/hiero-consensus-node/pull/433) [#26357](https://github.com/hiero-ledger/hiero-consensus-node/pull/26357) by @tinker-michaelj, @gkozyryatskyy

### **Bug Fixes**

  * Cherry-pick (0.74): Feature/ops duration throtling for insuffucient gas tx [#443](https://github.com/hiero-ledger/hiero-consensus-node/pull/443) [#26386](https://github.com/hiero-ledger/hiero-consensus-node/pull/26386) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)

### **Other Changes**

  * Cherry-pick (0.74): Fail on trace data exceeding 256KB [#437](https://github.com/hiero-ledger/hiero-consensus-node/pull/437) [#26359](https://github.com/hiero-ledger/hiero-consensus-node/pull/26359) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * Cherry-pick (0.74): Set Block Buffer size to 2 [#440](https://github.com/hiero-ledger/hiero-consensus-node/pull/440) [#26385](https://github.com/hiero-ledger/hiero-consensus-node/pull/26385) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * Cherry-pick (0.74): Reduce block buffer size to 10 [#436](https://github.com/hiero-ledger/hiero-consensus-node/pull/436) [#26358](https://github.com/hiero-ledger/hiero-consensus-node/pull/26358) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)
  * Cherry-pick (0.74): Update PBJ version and add tests [#425](https://github.com/hiero-ledger/hiero-consensus-node/pull/425) [#26356](https://github.com/hiero-ledger/hiero-consensus-node/pull/26356) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)

  **Full Release Notes**: [**v0.74.3**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.74.3)

</Accordion>

### [**Build 0.74.2**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.74.2)

<Accordion title="What's Changed">

### **Bug Fixes**

  * Cherry-pick 0.74: Refactor access list encoding [#418](https://github.com/hiero-ledger/hiero-consensus-node/pull/418) [#26355](https://github.com/hiero-ledger/hiero-consensus-node/pull/26355) by @Neeharika-Sompalli, @gkozyryatskyy
  * Cherry-pick 0.74: signSchedule.from.contract.enabled=false [#419](https://github.com/hiero-ledger/hiero-consensus-node/pull/419) [#26354](https://github.com/hiero-ledger/hiero-consensus-node/pull/26354) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)

  **Full Release Notes**: [**v0.74.2**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.74.2)

</Accordion>

### [**Build 0.74.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.74.1)

<Accordion title="What's Changed">

### **Bug Fixes**

  * Cherry-pick 0.74: disable signSchedule(address,bytes) [#400](https://github.com/hiero-ledger/hiero-consensus-node/pull/400) [#26353](https://github.com/hiero-ledger/hiero-consensus-node/pull/26353) by [@gkozyryatskyy](https://github.com/gkozyryatskyy)

  **Full Release Notes**: [**v0.74.1**](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.74.1)
...
## Performance Results
<Frame>
  ![](/images/networks/release-notes/services/0.74_performance_measurement_results.png)
</Frame>
...
### **Features**
  ...
  * make BlockNodeEndpoint.endpoint_api a repeated field (HIP-1137) #24788 by @petreze
...
## Performance Results
<Frame>
  ![](/images/networks/release-notes/services/0.72_performance-measurement-results.png)
</Frame>
...
* Serialize and de-serialize high_volume field correctly #22881 by @Neeharika-Sompalli
...
## Performance Results
<Frame>
  ![](/images/networks/release-notes/services/0.71_performance_measurement_results_extract.png)
</Frame>
...
## Performance Results
<Frame>
  ![](/images/networks/release-notes/services/0.70_performance_measurement_results_extract.png)
</Frame>
...
<Accordion title="What's Changed">
  - ci(fix): add checkout in private to build release artifact (#22416) by @andrewb1269 in https://github.com/hiero-ledger/hiero-consensus-node/pull/22830
  - ci: cherry pick various CI changes to release 69 branch by @andrewb1269 in https://github.com/hiero-ledger/hiero-consensus-node/pull/23030
  - ci(workflows): rename zxf to flow on MATS and XTS dry run workflows by @andrewb1269 in https://github.com/hiero-ledger/hiero-consensus-node/pull/23193
  - ci(workflows): Update build-release-artifact and associated workflows by @andrewb1269 in https://github.com/hiero-ledger/hiero-consensus-node/pull/23208
  - ci(workflows): Update runners & Improve XTS Dry Run Capabilities (#23172) by @rbarker-dev in https://github.com/hiero-ledger/hiero-consensus-node/pull/23220
  - fix: (0.69) Ensure HTS transfer gas cost reflects HBAR auto-creations by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/23184
...
## Performance Results
<Frame>
  ![](/images/networks/release-notes/services/0.68_performance-measurement-results_001.png)
</Frame>
...
## Performance Results
<Frame>
  ![](/images/networks/release-notes/services/0.67_performance-measurement-results.001.png)
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-11.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-12.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-13.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-14.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-15.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-16.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-17.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-18.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-19.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-20.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-21.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-22.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-23.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-24.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-25.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-26.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-27.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-28.jpg" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-29.jpg" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-30.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-31.jpg" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-32.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-33.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-34.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-35.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-36.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-37.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-38.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-39.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-40.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-41.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-42.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-43.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-44.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-45.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-46.png" />
</Frame>
## v0.18.0
...
<Frame>
  <img src="/images/networks/release-notes/services/services-47.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-48.png" />
</Frame>
...
<Frame>
  <img src="/images/networks/release-notes/services/services-49.png" />
</Frame>
