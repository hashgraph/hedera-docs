...
description: "Delete a Hedera Consensus Service (HCS) topic with TopicDeleteTransaction using the admin key, removing the topic from the network permanently."
---
