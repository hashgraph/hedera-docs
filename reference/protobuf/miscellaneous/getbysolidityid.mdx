...
description: "Hedera protobuf reference for the GetBySolidityID query used to look up the Hedera account, contract, or file identifier mapped to a given Solidity address."
---
...
| `fileID`     | [FileID](/reference/protobuf/basic-types/fileid)                   | The file Id for the file                                                                                         |
| `contractID` | [ContractID](/reference/protobuf/basic-types/contractid)           | A smart contract ID for the instance (if this is included, then the associated accountID will also be included)  |
