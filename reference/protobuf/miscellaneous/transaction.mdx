---
title: "Transaction"
description: "Hedera protobuf reference for the Transaction message describing the signed envelope containing a transaction body, signatures, and Hedera node payment."
---
