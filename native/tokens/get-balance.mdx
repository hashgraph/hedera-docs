...
description: "Query the token balances held by a Hedera account using AccountBalanceQuery in the Hedera SDK (deprecated; migrate to the Mirror Node REST API)."
---
