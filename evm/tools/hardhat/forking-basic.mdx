---
title: "Fork Hedera with Hardhat: basic ERC-20 contract (Part 1)"
description: "Fork Hedera testnet with Hardhat in TypeScript to deploy an ERC-20 token and run tests against existing on-chain contracts using minimal setup."
