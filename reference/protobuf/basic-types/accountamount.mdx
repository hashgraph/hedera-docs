---
title: "AccountAmount"
description: "AccountAmount is a Hedera protobuf message pairing an account ID with a signed HBAR or token amount used inside CryptoTransfer transfer lists."
---
