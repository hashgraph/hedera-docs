...
description: "Hedera Status API reference for querying real-time network status, incident reports, and scheduled maintenance for mainnet, testnet, and previewnet."
