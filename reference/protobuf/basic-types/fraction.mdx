---
title: "Fraction"
description: "Hedera protobuf Fraction represents a rational number with a numerator and denominator, commonly used to set custom token fees as a percentage."
---
