---
title: "Get file info"
description: "Query Hedera File Service (HFS) file metadata with FileInfoQuery, returning size, expiration, keys, deletion status, and memo for a given file ID."
---
