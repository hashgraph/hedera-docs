...
description: "Import an existing on-chain contract into local state. Delete on Hedera (beneficiary required) or drop local state only. You must supply --file (path to a."
---
