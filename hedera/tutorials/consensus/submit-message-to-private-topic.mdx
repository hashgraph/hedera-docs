...
description: 'In the previous tutorial, "Submit Your First Message," you have learned how to submit a message to a public topic. It means anyone can send a message to the.'
---

## Summary

In the previous tutorial, "Submit Your First Message," you have learned how to submit a message to a **public topic**. It means anyone can send a message to the topic you created because you didn't set a [Submit Key](/hedera/sdks-and-apis/sdks/consensus-service/create-a-topic#private-topic).
...
We recommend you complete the "Submit Your First Message" tutorial [here](/hedera/tutorials/consensus/submit-your-first-message) to get a basic understanding of the Hedera Consensus Service. This example does not build upon the previous examples.
...
1. [Create Private Topic](#1.-create-a-private-topic)
2. [Subscribe to Topic](#2.-subscribe-to-a-topic)
3. [Submit Message](#3.-submit-a-message)
...
To create a private topic, you will use [**_`setSubmitKey()`_**](/hedera/sdks-and-apis/sdks/consensus-service/create-a-topic#methods) to set a Submit Key. This key needs to sign all messages someone sends to the topic. A message will be rejected if you don't sign the message or sign with an incorrect key. The cost of creating a private topic is the same as a public topic: [**$0.01**](/hedera/networks/mainnet/fees#consensus-service).
...
The code used to subscribe to a public or private topic doesn't change. Anyone can listen to the messages you send to your private topic. You need to provide the [**_`TopicMessageQuery()`_**](/hedera/sdks-and-apis/sdks/consensus-service/get-topic-message) with your topic ID to subscribe to it.
...
Now you are ready to submit a message to your private topic. To do this, you will use [**_`TopicMessageSubmitTransaction()`_**](/hedera/sdks-and-apis/sdks/consensus-service/submit-a-message). However, you need to sign this transaction with your Submit Key. The cost for sending a message to a private topic is the same as a public topic: [**$0.0001**](/hedera/networks/mainnet/fees#consensus-service).
