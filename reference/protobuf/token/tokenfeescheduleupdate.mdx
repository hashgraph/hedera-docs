...
description: "Hedera protobuf reference for the TokenFeeScheduleUpdate transaction used to change the custom fee schedule attached to an existing HTS token on Hedera."
---
...
| ------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `token_id`    | [TokenID](/reference/protobuf/basic-types/tokenid)                           | The token whose fee schedule is to be updated                                                 |
| `custom_Fees` | repeated [CustomFee](/reference/protobuf/token/customfees/customfee) | The new custom fees to be assessed during a CryptoTransfer that transfers units of this token |
