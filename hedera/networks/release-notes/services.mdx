...
<Info>
  **MAINNET UPDATE SCHEDULED: DECEMBER 16, 2025**
</Info>

<Check>
  **TESTNET UPDATE: DECEMBER 2, 2025**
</Check>

## Release Highlights

Release v0.68 introduces [Dynamic Address Book (DAB)](https://hips.hedera.com/hip/hip-1299) support, including updatable node account IDs, and enables generalized scheduled contract calls on the Hiero Consensus Node. These changes are now live on Hedera testnet (Nov 13, 2025) and are scheduled for mainnet on Dec 10, 2025.
