...
description: "Create fungible tokens and NFTs on the Hedera Token Service with TokenCreateTransaction, setting supply, treasury, keys, and metadata via the Hedera SDK."
---
...
<Card
  ...
  href="/learn/core-concepts/tokens/properties"
/>
