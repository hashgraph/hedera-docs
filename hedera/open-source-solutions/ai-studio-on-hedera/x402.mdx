...
description: "x402 is an open payment standard that reuses the existing HTTP 402 Payment Required status code to let a server ask for payment, and let a client pay, inside."
---
