...
description: "Transactions are requests sent by a client to a node with the expectation that they are submitted to the network for processing into consensus order and."
...
<Note>
  **Variable-rate pricing for high-volume transactions.** Entity creation transactions
  ...
  [High-Volume Entity Creation](/hedera/core-concepts/high-volume-entity-creation)
