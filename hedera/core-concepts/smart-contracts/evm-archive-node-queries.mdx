...
description: "HIP-584 enhances Hedera Mirror Nodes with extended EVM execution capabilities, allowing developers to perform gas-free smart contract queries, estimate gas."
---
...
* Basic knowledge of EVM smart contracts:
  * Understanding of [ABI (Application Binary Interface)](/hedera/core-concepts/smart-contracts/compiling-smart-contracts#smart-contract-application-binary-interface-abi) and function encoding.
...
To decode the data returned by the Mirror Node, you need the [ABI](/hedera/support-and-community/glossary#application-binary-interface-abi) of the smart contract you are interacting with. The ABI defines the structure of inputs and outputs for the contract's functions.
...
* [REST API Documentation](/hedera/sdks-and-apis/rest-api)
