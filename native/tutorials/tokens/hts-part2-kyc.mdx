---
title: "HTS Part 2: KYC, Token Updates, and Scheduled Transactions"
description: "Part 2 of the HTS tutorial series: grant and revoke token KYC, update token properties, and use scheduled transactions for multi-party HTS workflows."
