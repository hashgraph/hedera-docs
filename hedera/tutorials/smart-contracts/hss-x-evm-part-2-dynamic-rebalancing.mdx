...
📊 Monitor events at: https://hashscan.io/testnet/contract/0x2d8E63dE36eD12670E65FCf501e4a084562CF6ea/events
⏰ Rebalancing will execute automatically every ~15 seconds
```
...
Contract deployed at: 0x9034d960dcae5714cA9829825F7bbe20b89EC00e
    ✔ should deploy with correct initial state (305ms)
    ✔ should start rebalancing with capacity-aware scheduling (7131ms)
    ✔ should wait for first rebalance execution (13196ms)
    ✔ should wait for multiple rebalance executions (13903ms)
    ✔ should stop rebalancing and cancel pending schedule (7706ms)
    ✔ should be able to restart rebalancing with new interval (17535ms)
    ✔ should reject zero interval (627ms)
    ✔ should reject starting when already active (16700ms)
