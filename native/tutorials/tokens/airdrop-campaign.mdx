...
description: "Run your first frictionless Hedera airdrop campaign using TokenAirdrop, TokenClaimAirdrop, and TokenReject to distribute HTS tokens to many recipients."
---
