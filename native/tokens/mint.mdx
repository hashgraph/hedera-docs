---
title: "Mint a token"
description: "Mint fungible tokens or create new NFTs with unique metadata on the Hedera Token Service using TokenMintTransaction, signed by the supply key."
---
