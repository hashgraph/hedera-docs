...
| `POST /api/v1/network/fees` | Estimates fees for a specific protobuf-encoded transaction before submission, including the [HIP-1313](https://hips.hedera.com/hip/hip-1313) `high_volume_multiplier`. ([HIP-1261](https://hips.hedera.com/hip/hip-1261)) |
