---
title: "Blocks"
description: "Mirror node REST API endpoints for Hedera block data, including block metadata, hashes, timestamps, and the list of transactions contained within blocks."
---
