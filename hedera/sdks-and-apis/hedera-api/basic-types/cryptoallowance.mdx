...
description: "CryptoAllowance protobuf type defining an approved HBAR transfer allowance for a spender, including owner account, spender, and amount limits."
---
