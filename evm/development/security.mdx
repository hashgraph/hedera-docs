...
description: "How the Hedera Smart Contract Service targets EVM equivalence, how its security model went from v1 to v2, and the impact on HTS system contracts."
---
