---
title: "GetByKey"
description: "Hedera protobuf reference for the GetByKey query used to retrieve the list of accounts, contracts, files, and topics associated with a given Hedera key."
---
