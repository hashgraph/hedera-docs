---
title: "Signer"
description: "The Signer class an interface and is responsible for signing requests. Returns the account ID associated with this signer. getNetwork()->[Key:string]: string"
---
