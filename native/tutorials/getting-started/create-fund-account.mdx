...
description: "Create and fund a Hedera testnet account using the Hedera Portal, faucet, or SDKs so you can pay fees and start building with the Hedera APIs."
---


To interact with the Hedera network, you’ll need a testnet account funded with HBAR. [Hedera accounts](/learn/core-concepts/accounts) are essential for accessing the [Hedera APIs](/reference/protobuf) and paying for transactions and queries with HBAR. This guide outlines three ways to create and fund your testnet account.
...
<Info>
The portal dashboard also serves as a central location where you can manage your account IDs and private keys, easily access the testnet HBAR, and unlock features like a [personal access token (API key)](/native/tutorials/getting-started/create-api-key).
</Info>
...
Enter your EVM wallet address in the 'Enter Wallet Address' field. This initiates an [auto account creation](/learn/core-concepts/accounts/auto-account-creation) flow that automatically creates a new Hedera Testnet account with 100 testnet HBAR.
