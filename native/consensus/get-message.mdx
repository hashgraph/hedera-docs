...
description: "Subscribe to Hedera Consensus Service (HCS) topic messages with TopicMessageQuery over gRPC to stream new and historical messages from a mirror node."
---
