...
description: "Hedera protobuf reference for the CryptoGetStakers query used to retrieve information about accounts that are proxy-staking to a specified Hedera account."
---
...
| ------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| `accountID`   | [AccountID](/reference/protobuf/basic-types/accountid) | The Account ID that is being proxy staked to                              |
...
| `accountID` | [AccountID](/reference/protobuf/basic-types/accountid)       | The Account ID for which the records should be retrieved                                                                                            |
...
| Field       | Type                                                                                       | Description                                         |
| ----------- | ------------------------------------------------------------------------------------------ | --------------------------------------------------- |
| `accountID` | [AccountID](/reference/protobuf/basic-types/accountid) | The Account ID that is proxy staking                |
