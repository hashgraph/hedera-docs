...
description: "Retrieve the contents of a Hedera File Service (HFS) file with FileContentsQuery, returning the raw file bytes stored on the consensus network."
---
