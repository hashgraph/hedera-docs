...
description: "Update the properties, keys, treasury, and metadata of an existing Hedera Token Service token with TokenUpdateTransaction, signed by the admin key."
---
