...
description: "Add signatures to a Hedera scheduled transaction with ScheduleSignTransaction, collecting required signers before the inner transaction executes on consensus."
---
