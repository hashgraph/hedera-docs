...
description: "Configure the free public Hashio JSON-RPC endpoint to connect MetaMask, ethers.js, Hardhat, and Foundry to Hedera Mainnet, Testnet, or Previewnet."
---
