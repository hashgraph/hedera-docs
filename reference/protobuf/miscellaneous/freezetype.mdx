---
title: "FreezeType"
description: "Hedera protobuf reference for the FreezeType enum that identifies the kind of network freeze action being requested, such as freeze, upgrade, or abort."
---
