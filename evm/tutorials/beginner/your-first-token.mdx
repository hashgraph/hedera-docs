...
description: "Deploy and mint your first ERC-20 fungible token on Hedera testnet using Hardhat, OpenZeppelin, and MetaMask through the standard EVM development workflow."
---
