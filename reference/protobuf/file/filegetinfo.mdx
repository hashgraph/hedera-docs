---
title: "FileGetInfo"
description: "Hedera protobuf reference for the FileGetInfo query used to retrieve metadata about a Hedera File Service file, including size, keys, expiry, and memo."
---
...
| Field            | Type                                                                                         | Description                                                                                                                          |
| ---------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `fileID`         | [FileID](/reference/protobuf/basic-types/fileid)         | The file ID of the file for which information is requested                                                                           |
| `size`           | int64                                                                                        | Number of bytes in contents                                                                                                          |
| `expirationTime` | [Timestamp](/reference/protobuf/miscellaneous/timestamp) | The current time at which this account is set to expire                                                                              |
| `deleted`        | bool                                                                                         | True if deleted but not yet expired                                                                                                  |
| `keys`           | [KeyList](/reference/protobuf/basic-types/keylist)       | One of these keys must sign in order to modify or delete the file                                                                    |
