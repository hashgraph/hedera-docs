...
description: "Walkthrough of HIP-32 and HIP-542 auto-account creation on Hedera: send HBAR or HTS tokens to an EVM address alias to create the account on first transfer."
---
