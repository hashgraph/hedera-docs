...
description: "Hedera protobuf reference for the CryptoGetAccountBalance query used to retrieve the current HBAR and token balances of a Hedera account by account ID."
---
