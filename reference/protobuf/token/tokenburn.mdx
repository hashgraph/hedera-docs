---
title: "TokenBurn"
description: "Hedera protobuf reference for the TokenBurn transaction used to permanently destroy units of a fungible HTS token or specific non-fungible token serials."
---
...
| --------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `token`         | [TokenID](/reference/protobuf/basic-types/tokenid) | The token for which to burn tokens. If token does not exist, transaction results in INVALID\_TOKEN\_ID                                                                                                   |
