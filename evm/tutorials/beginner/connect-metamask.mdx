...
description: "Three ways to connect MetaMask to the Hedera network: via HashScan, manual JSON-RPC configuration, or ChainList one-click setup for mainnet and testnet."
---
