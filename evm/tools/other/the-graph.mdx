...
description: "Index Hedera smart contract data with The Graph by running a local graph node and querying your subgraph through GraphQL for dApp backends and dashboards."
