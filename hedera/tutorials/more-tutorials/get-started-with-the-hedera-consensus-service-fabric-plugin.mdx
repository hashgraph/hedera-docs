...
description: "Hyperledger Fabric is one of the most popular private/permissioned enterprise blockchain frameworks available today. Fabric's modular architecture approach."
...
<Frame>
![](/images/tutorials/more-tutorials/get-started-with-the-hedera-consensus-service-fabric-plugin.png)
</Frame>

hedera\tutorials\more-tutorials\get-started-with-the-hedera-consensus-service-fabric-plugin.mdx
## Concepts
...
<Info>
If you would like to run the sample using a virtual environment, please follow the instructions [here](/hedera/tutorials/more-tutorials/get-started-with-the-hedera-consensus-service-fabric-plugin/virtual-environment-set-up).
</Info>

### Hedera Consensus Service

* Testnet account ID and private key
  * Please follow the instructions [here](/hedera/networks/testnet/testnet-access)
