...
description: "Set up and run a Hedera local node with the @hashgraph/hedera-local NPM CLI and docker compose, including consensus node, mirror node, and JSON-RPC relay."
---
