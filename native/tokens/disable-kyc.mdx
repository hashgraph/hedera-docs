...
description: "Revoke the KYC flag from a Hedera account for a specified HTS token using TokenRevokeKycTransaction on the Hedera Token Service, signed by the KYC key."
---
