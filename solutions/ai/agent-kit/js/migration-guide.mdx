...
description: "Upgrade your Hedera Agent Kit JavaScript project from v3 to v4: scoped @hashgraph packages, split toolkit packages, and the new /plugins import subpath."
