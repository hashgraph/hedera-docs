...
<CardGroup cols={2}>
  <Card title="EVM Developer Quickstart" icon="file-code" href="/evm/quickstart/setup-metamask">
    Deploy Solidity contracts with Hardhat or Foundry. Start here if you know Ethereum.
  </Card>
  <Card title="Native SDK Quickstart" icon="code" href="/native/quickstart/javascript">
