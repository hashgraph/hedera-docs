...
description: "Modify Hedera transaction fields like transaction ID, valid duration, memo, node account ID, and max transaction fee before submitting to the network."
---
