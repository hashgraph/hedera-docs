---
title: "Reference"
description: "Browse Hedera's complete API and protocol reference, including mirror node REST endpoints, HCS gRPC, Protobuf definitions, and network status APIs."
mode: wide
---
