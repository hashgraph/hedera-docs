---
title: "Local Network"
description: "Configure the Hedera SDK Client to point at a local consensus and mirror node for development and testing using Client.forNetwork and setMirrorNetwork."
---
