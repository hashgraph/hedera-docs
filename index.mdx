...
<a href="/solutions/ai/index" className="ai-spotlight" aria-label="Hedera AI Studio: open-source toolkit bridging artificial intelligence and Hedera">
  ...
  <div className="ai-spotlight-features">
    ...
    <div className="ai-spotlight-feature">
      ...
      <span className="ai-spotlight-caption">Build with LangChain, Vercel AI SDK, and Google ADK</span>
    </div>
    ...
    <div className="ai-spotlight-feature">
      ...
      <span className="ai-spotlight-caption">Modular plugin system</span>
    </div>

    <div className="ai-spotlight-feature">
      <svg className="ai-spotlight-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2l8.66 5v10L12 22 3.34 17V7L12 2z"/>
        <circle cx="12" cy="12" r="2.5" fill="currentColor" stroke="none"/>
        <path d="M12 12V2M12 12l8.66-5M12 12l8.66 5M12 12V22M12 12l-8.66 5M12 12L3.34 7"/>
      </svg>
      <span className="ai-spotlight-caption">Hedera Network MCP and x402 payments</span>
    </div>
