...
sidebarTitle: "HCS gRPC API"
description: "Stream Hedera Consensus Service topic messages from the public HCS gRPC mirror node API by subscribing to topics on mainnet, testnet, or previewnet."
---
...
<Card
  ...
  href="/native/consensus/get-message"
/>
