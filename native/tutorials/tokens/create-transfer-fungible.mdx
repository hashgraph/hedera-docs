...
description: "Create and transfer your first fungible HTS token on Hedera testnet using the Hedera JavaScript SDK, covering token creation, association, and transfers."
---
