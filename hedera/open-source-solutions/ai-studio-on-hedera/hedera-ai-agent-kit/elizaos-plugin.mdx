...
> ⚠️ **Breaking Change: hedera-agent-kit v4 Package Update**
>
> Starting with **v4**, the ElizaOS toolkit has moved to its own package. The `hedera-agent-kit/elizaos` subpath no longer exists.
>
> ```typescript
...
<Card
  title="Github"
  href="https://github.com/hedera-dev/hedera-plugin-eliza"
  icon="github"
  horizontal
/>
