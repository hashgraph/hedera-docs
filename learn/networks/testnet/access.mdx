...
description: "Create a Hedera testnet or previewnet account through the Developer Portal, receive 1000 test HBAR, and configure your SDK to build and test applications."
---
