---
title: "Token ID"
description: "Construct a TokenId object in the Hedera SDK from shard, realm, and token number to reference fungible tokens and NFT collections on the Hedera Token Service."
---
