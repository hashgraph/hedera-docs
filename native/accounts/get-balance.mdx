...
description: "Query a Hedera account's HBAR and token balances with AccountBalanceQuery, a free SDK query returning current balances from any consensus node."
---
