---
title: "Topic Plugin"
description: "Create a new topic with admin and submit key set. Find messages between a range of 1 and 3. Define the name for this topic. Admin key(s) of the topic."
---
