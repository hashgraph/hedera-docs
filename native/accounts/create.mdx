...
description: "Create a new Hedera account with AccountCreateTransaction using the native SDK: set keys, initial balance, auto-renew, and signing requirements."
---
