---
title: "Topics"
description: "Mirror node REST API endpoints for HCS topics on Hedera, used to retrieve topic details, message history, and track consensus events across the network."
---
