...
- [Hedera Account](https://portal.hedera.com/) (for mainnet, testnet, or previewnet) or [a local Solo network](/native/local-dev/index) (for localnet)
...
To use the CLI against a [local Solo network](/native/local-dev/index), configure an operator for `localnet` and select that network.

The CLI's shipped `localnet` defaults match Solo's endpoints on version 0.63 and later (see `src/core/services/network/network.config.ts` in the [Hiero CLI repository](https://github.com/hiero-ledger/hiero-cli)):

| Setting | Default |
| --- | --- |
| JSON-RPC URL | `http://localhost:37546` |
| Mirror node REST URL | `http://localhost:38081/api/v1` |
| Consensus node address | `127.0.0.1:35211` (node account ID `0.0.3`) |
| Mirror node gRPC address | `127.0.0.1:35600` |
...
Use an operator key and account ID that match **your** local network; the values above are only an illustration from the Hiero CLI README. Solo writes its generated accounts to `~/.solo/one-shot-<deployment-name>/accounts.json`.
...
<Card
  ...
  href="/solutions/tools/hiero-cli/plugins/network-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/credentials-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/account-plugin"
  horizontal
>
...
<Card
  title="HBAR Plugin"
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/hbar-plugin"
  horizontal
>
...
<Card
  title="Token Plugin"
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/token-plugin"
  horizontal
>
...
<Card
  title="Swap Plugin"
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/swap-plugin"
  horizontal
>
...
<Card
  title="Topic Plugin"
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/topic-plugin"
  horizontal
>
...
<Card
  title="Config Plugin"
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/config-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/plugin-management-plugin"
  horizontal
>
...
<Card
  title="Batch Plugin"
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/batch-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/schedule-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/contract-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/contract-erc20-plugin"
  horizontal
>
...
<Card
  ...
  icon="puzzle-piece-simple"
  href="/solutions/tools/hiero-cli/plugins/contract-erc721-plugin"
  horizontal
>
...
<Card
  ...
  icon="scroll"
  href="/solutions/tools/hiero-cli/scripting/quickstart"
  horizontal
>
