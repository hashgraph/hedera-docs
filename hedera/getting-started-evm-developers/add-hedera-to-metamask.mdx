...
description: "Add Hedera mainnet, testnet, or previewnet to MetaMask using the JSON-RPC relay so you can send transactions and interact with EVM dApps on Hedera."
---
