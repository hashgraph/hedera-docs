---
title: "Network"
description: "Mirror node REST API endpoints for Hedera network supply, fees, exchange rates, node details, and staking information used to monitor network health."
---
