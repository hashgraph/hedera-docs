---
title: "HBAR"
description: "Work with the Hedera Hbar type to construct, convert, and display HBAR amounts in tinybars, microbars, millibars, and other denominations using the SDK."
---
