...
* [HashPack](/native/tutorials/getting-started/create-fund-account#option-3-hashpack-wallet) or [MetaMask Wallet](/evm/tutorials/beginner/connect-metamask)
...
<Columns cols={2}>
  <Card
    ...
    href="/solutions/tokenization/ats/web-ui#create-new-bond"
  ...
  <Card
    ...
    href="/solutions/tokenization/ats/web-ui#create-new-equity"
