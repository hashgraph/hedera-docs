...
2. [Step 1: Configure Hardhat](#step-1-configure-hardhat)
3. [Step 2: Creating an NFT collection via HTS(similar to ERC721)](#step-2.-creating-an-nft-collection-via-hts-similar-to-erc721)
4. [Step 3: Deploy HTS NFT Smart Contract](#step-3-deploy-your-hts-nft-smart-contract)
5. [Step 4: Minting an HTS NFT](#step-4-minting-an-hts-nft)
6. [Step 5: Burning an HTS NFT](#step-5-burning-an-hts-nft)
7. [Step 6: Run tests](#step-6-run-tests-optional)
...
```solidity contracts/MyHTSToken.sol
...
Continue exploring our [Part 2: KYC & Update](/hedera/tutorials/smart-contracts/hts-x-evm-part-2-kyc-and-update) to see how advanced compliance flags (e.g., KYC) or updating tokens can be handled natively.

<Card
  title="Hts X Evm Part 2 Kyc And Update"
