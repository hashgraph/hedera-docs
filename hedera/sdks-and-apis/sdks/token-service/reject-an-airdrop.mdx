...
description: "The TokenRejectTransaction allows users to reject and return unwanted airdrops to the treasury account without incurring custom fees."
---
