...
description: "Sign a Hedera multisignature transaction by collecting signatures from multiple private keys to satisfy KeyList or threshold key requirements."
---
