...
description: "Network response messages and error codes returned by the Hedera SDK for Token Service create, mint, burn, transfer, and management operations."
---
