...
description: "Get started with the Hedera Consensus Service Fabric plugin to use Hedera as the ordering service for a Hyperledger Fabric private blockchain network."
...
<Info>
If you would like to run the sample using a virtual environment, please follow the instructions [here](/native/tutorials/advanced/hcs-fabric-plugin/virtual-environment).
</Info>

### Hedera Consensus Service

* Testnet account ID and private key
  * Please follow the instructions [here](/learn/networks/testnet/access)
