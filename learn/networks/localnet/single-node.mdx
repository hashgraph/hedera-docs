...
description: "Configure Hedera Local Node in single-node mode using Docker for fast local development, debugging, and prototype testing of Hedera applications."
---
