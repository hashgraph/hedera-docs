...
description: "The transaction calls a function of the given smart contract instance, giving it functionParameters as its input. The call can use at maximum the given."
---
