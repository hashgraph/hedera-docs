...
<div className="flex flex-col justify-center items-center w-full mt-4 mb-8 not-prose">
  ...
  >
    <img
      ...
      className="mx-auto rounded-lg shadow-sm w-full h-auto mb-[5px]"
      noZoom
    />
    <p className="text-gray-1000 dark:text-gray-500 text-sm font-semibold mt-3 mb-0 text-center underline decoration-[#8853FF] decoration-1 underline-offset-[6px] transition-colors duration-200 group-hover:text-[#8853FF]">
      Hedera Developer Playground
    </p>
  </a>
</div>
