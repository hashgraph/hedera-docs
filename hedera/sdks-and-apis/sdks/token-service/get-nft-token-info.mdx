---
title: "Get NFT info"
description: "A query that returns information about a non-fungible token (NFT). You request the info for an NFT by specifying the NFT ID. Only when a spender is set on an."
---
