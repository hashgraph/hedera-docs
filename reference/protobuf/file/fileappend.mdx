---
title: "FileAppend"
description: "Hedera protobuf reference for the FileAppend transaction used to append additional bytes to an existing file stored on the Hedera File Service."
---
