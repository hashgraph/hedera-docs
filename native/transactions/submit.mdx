...
description: "Submit signed Hedera transactions with execute(), pick a consensus node, automatically sign with the operator key, and capture the transaction ID and hash."
---
