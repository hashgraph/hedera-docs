...
description: "Pick the right Hedera development path: deploy EVM Solidity contracts with Hardhat or Foundry, or build with the native Hiero SDKs in JavaScript, Java, or Go."
icon: "signs-post"
---
