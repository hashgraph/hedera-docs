...
Ed25519 is a supported key type on Hedera. It does **not** produce an EVM alias, so Ed25519 accounts cannot be used directly with EVM tooling, MetaMask, or Solidity contracts that rely on `msg.sender`. 
