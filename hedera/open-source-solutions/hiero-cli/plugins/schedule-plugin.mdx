...
description: 'Reference for the Hiero CLI Schedule plugin with commands to create, sign, verify, and inspect scheduled transactions for Hedera multi-sig workflows.'
---
