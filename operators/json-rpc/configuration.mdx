...
description: "Configure the Hiero JSON-RPC relay with environment variables for network selection, operator account, ports, rate limiting, and runtime tuning."
---
