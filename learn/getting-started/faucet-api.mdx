---
title: "Faucet API for testnet and previewnet HBAR"
description: "Use the Hedera Portal HTTP faucet endpoint to fund testnet and previewnet accounts with HBAR programmatically from scripts, CI pipelines, or SDKs."
icon: "terminal"
---
