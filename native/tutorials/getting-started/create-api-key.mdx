...
description: "Create a personal access token on the Hedera Portal and use it to call the portal API to list accounts, recreate accounts, and query account IDs."
