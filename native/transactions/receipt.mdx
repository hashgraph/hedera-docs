...
description: "Retrieve a Hedera transaction receipt with TransactionReceiptQuery to confirm status, get new entity IDs, and verify execution on the consensus network."
---
