---
title: "QueryHeader"
description: "Hedera protobuf reference for the QueryHeader message describing the response type and payment transaction included with every Hedera network query request."
---
...
| -------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| `payment`      | [Transaction](/reference/protobuf/miscellaneous/transaction) | A signed CryptoTransferTransaction to pay the node a fee for handling this query |
