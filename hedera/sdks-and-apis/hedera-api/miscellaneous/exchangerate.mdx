---
title: "ExchangeRate"
description: 'ExchangeRate protobuf type representing an HBAR-to-USD-cents exchange rate and the expiration time after which a new exchange rate supersedes it.'
---
