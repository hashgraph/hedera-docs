...
description: "HederaFunctionality enum protobuf type listing all transactions and queries supported by Hedera network services, used for fee schedule lookups."
---
