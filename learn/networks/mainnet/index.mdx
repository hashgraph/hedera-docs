---
title: Mainnet
description: "Join the Hedera mainnet — submit production transactions, query consensus data, view network throttles, and learn how HBAR fees pay for network services."
---
## Overview
