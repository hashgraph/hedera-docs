---
title: "HTS x EVM: pause, freeze, wipe, and delete NFTs (Part 3)"
description: "Pause, freeze, wipe, and delete Hedera NFT tokens from a Solidity smart contract using the HTS system contract to manage compliance and token lifecycle."
---
