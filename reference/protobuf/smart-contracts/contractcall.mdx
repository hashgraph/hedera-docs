---
title: "ContractCall"
description: "Hedera protobuf reference for the ContractCall transaction used to invoke a function on a deployed smart contract on the Hedera EVM with gas and parameters."
---
...
| -------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `contractID`         | [ContractID](/reference/protobuf/basic-types/contractid) | The contract instance to call                                             |
