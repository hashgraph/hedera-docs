...
<CardGroup cols={2}>
  <Card title="Create an Account" icon="user-plus" href="/native/quickstart/javascript">
    Generate a new account programmatically and fund it from your operator.
  </Card>
  <Card title="Create a Token" icon="coins" href="/native/quickstart/javascript">
    Mint a native HTS token with custom supply and decimals.
  </Card>
  <Card title="Submit to a Topic" icon="comment" href="/native/quickstart/javascript">
    Publish a message to HCS for verifiable, ordered audit logs.
  </Card>
  <Card title="SDK Reference" icon="book" href="https://github.com/hashgraph/hedera-sdk-go">
