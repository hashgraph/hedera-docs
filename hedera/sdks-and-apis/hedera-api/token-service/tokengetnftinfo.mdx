...
description: "Represents an NFT on the Ledger. Applicable only to tokens of type NONFUNGIBLEUNIQUE. Gets info on a NFT for a given TokenID (of type NONFUNGIBLEUNIQUE) and."
---
