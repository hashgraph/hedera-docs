...
description: "On Ethereum, sending ETH to a contract address automatically triggers the receive() or fallback() functions, allowing contracts to process incoming funds."
---
