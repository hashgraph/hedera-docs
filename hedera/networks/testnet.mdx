---
title: Testnets
description: "Hedera test networks provide developers access to a free testing environment for Hedera network services. Testnets simulate the exact development environment."
...
In addition to the standard throttles above, the testnet provides dedicated
