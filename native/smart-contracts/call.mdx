...
description: "Call a Hedera smart contract function with ContractExecuteTransaction, setting gas, function parameters, and payable amount using the native SDK."
---
