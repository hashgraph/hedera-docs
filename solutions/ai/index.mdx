...
description: "Hedera AI Studio is an open-source toolkit for building verifiable, transparent AI agents that transact on Hedera using natural language and HCS."
---
...
<div className="not-prose">
  <a href="https://ai-bounties.hedera.com/" target="_blank" rel="noopener noreferrer" className="ai-bounty-bar">
    ...
    <span className="ai-bounty-bar-text"><strong>AI Studio Bounty</strong> has wrapped up. See ai-bounties.hedera.com for entries and winners.</span>
