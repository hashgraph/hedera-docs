...
| **Queries (per node)** | `AccountBalanceQuery`: deprecated, see [Get account balance](/native/accounts/get-balance)<br/>`ContractGetInfo`: 700 tps<br/>`ContractGetBytecode`: 700 tps<br/>`ContractCallLocal`: 700 tps<br/>`FileGetInfo`: 700 tps<br/>`FileGetContents`: 700 tps<br/>`Other`: 10,000 tps |
