...
description: "Send HBAR to and from contracts with transfer(), send(), and call(), and learn why receive() and fallback() only run when HBAR arrives via contractCall."
---
