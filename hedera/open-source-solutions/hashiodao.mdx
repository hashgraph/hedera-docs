---
title: HashioDAO
description: "Distributed ledger technology (DLT) enables the shift from centralized control into the world of decentralization. Instead of having one central authority."
...
* **NFT**: This model gives decision-making powers to the holders of a specific NFT and allows more features than a regular token model like [soulbound tokens](/hedera/support-and-community/glossary#soul-bound-token-sbt) or limiting the number of NFTs an account can own.
...
<Frame>
  <img src="/images/open-source-solutions/hashiodao/hashiodao-1.png" />
</Frame>
...
* [Create](/hedera/tutorials/more-tutorials/create-and-fund-your-hedera-testnet-account#hedera-developer-portal-profile) a Hedera account.
* [Fund](/hedera/tutorials/more-tutorials/create-and-fund-your-hedera-testnet-account#hedera-faucet) the Hedera account.
...
<Columns cols={2}>
  <Card
    ...
    href="/hedera/open-source-solutions/hashiodao/governance-token-dao"
    arrow
  >
  ...
  <Card
    title="NFT DAO"
    href="/hedera/open-source-solutions/hashiodao/nft-dao"
    arrow
  >
  ...
  <Card
    title="Multisig DAO"
    href="/hedera/open-source-solutions/hashiodao/multisig-dao"
    arrow
  >
  ...
  <Card
    title="DAO Proposals"
    href="/hedera/open-source-solutions/hashiodao/dao-proposals"
    arrow
  >
