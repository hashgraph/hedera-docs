...
description: "Customize Hedera transaction fields with the Hiero SDKs: transaction ID, valid duration, node account ID, memo, max fee, and the 6 KiB transaction size limit."
---
