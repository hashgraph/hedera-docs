...
<Columns cols={2}>
  <Card
    title="NFT Token Holders List Builder Web App"
    href="https://nft-studio.hashgraph.com/token-holders-list-builder/"
    arrow
  ...
  <Card
    title="NFT Token Holders List Builder Repo"
    href="https://github.com/hedera-dev/token-holders-list-builder"
    arrow
    img="/images/open-source-solutions/nft-studio\nft-token-holders-list-builder/nft-token-holders-list-builder-8.png"
  ></Card>
</Columns>
...
<iframe
  width="720"
  height="405"
  src="https://www.youtube.com/embed/A4dDPF-e8TY"
  title="NFT Studio | NFT Token Holders List Builder"
  frameborder="0"
...
<Frame>
  <img src="/images/open-source-solutions/nft-studio/nft-token-holders-list-builder/nft-token-holders-list-builder-1.png" />
</Frame>
...
<Frame>
  <img src="/images/open-source-solutions/nft-studio/nft-token-holders-list-builder/nft-token-holders-list-builder-2.png" />
</Frame>

<Frame>
  <img src="/images/open-source-solutions/nft-studio/nft-token-holders-list-builder/nft-token-holders-list-builder-3.png" />
</Frame>
...
<Frame>
  <img src="/images/open-source-solutions/nft-studio/nft-token-holders-list-builder/nft-token-holders-list-builder-4.png" />
</Frame>
...
<Frame>
  <img src="/images/open-source-solutions/nft-studio/nft-token-holders-list-builder/nft-token-holders-list-builder-5.png" />
</Frame>
...
<Frame>
  <img src="/images/open-source-solutions/nft-studio/nft-token-holders-list-builder/nft-token-holders-list-builder-6.png" />
</Frame>

<Info>
#### **Tip: Verify Token Holders for Airdrops**

You can use the compiled list of account IDs in other tools, like the [Airdrop List Verifier](/solutions/tokenization/nft-studio/airdrop-verifier), to check if these accounts are eligible to receive tokens. This helps streamline the process of planning token distribution to your NFT community.
