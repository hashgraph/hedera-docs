...
description: "Get an account's token balances on Hedera. AccountBalanceQuery is removed in consensus node release v0.77, so migrate to the Mirror Node REST API balances endpoint."
---
