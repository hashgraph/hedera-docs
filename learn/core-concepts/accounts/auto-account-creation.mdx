...
description: "Auto-create free Hedera accounts by sending HBAR or HTS tokens to an EVM address alias derived from an ECDSA public key, as defined in HIP-32 and HIP-542."
---
