---
title: "TokenDelete"
description: "Hedera protobuf reference for the TokenDelete transaction used to mark a Hedera HTS token deleted so it can no longer be transferred, minted, or burned."
---
