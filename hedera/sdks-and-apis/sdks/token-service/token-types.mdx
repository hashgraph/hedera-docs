---
title: "Token types"
description: "There are two types of tokens you can create using the Hedera Token Service: fungible and non-fungible tokens. A fungible (FUNGIBLECOMMON) token is a class."
---
