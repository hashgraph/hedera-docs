...
description: "Hedera is an open-source, public, proof-of-stake network. Its network services offer low and fixed fees, 10k TPS, and instant transaction finality."
---
...
<Frame>
  <img src="/images/tutorials/local-node/setup-hedera-node-cli-npm/setup-hedera-node-cli-npm-1.png" />
</Frame>
## Verify Running Node
...
<Frame>
  <img src="/images/tutorials/local-node/setup-hedera-node-cli-npm/setup-hedera-node-cli-npm-2.png" />
</Frame>

<Frame>
  <img src="/images/tutorials/local-node/setup-hedera-node-cli-npm/setup-hedera-node-cli-npm-3.png" />
</Frame>
...
For an in depth explanation of the different terms below, see the [glossary documentation](/hedera/support-and-community/glossary).
...
Want to learn how to deploy smart contracts on Hedera? Visit the guide on how to [Deploy a Smart Contract Using Hardhat and Hedera JSON-RPC Relay](/hedera/core-concepts/smart-contracts/json-rpc-relay).
...
<Columns cols={2}>
  <Card title="Writer: Owanate, DX Engineer" arrow>
