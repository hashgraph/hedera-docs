...
description: "Cancel pending token airdrops you initiated with TokenCancelAirdropTransaction, removing them from network state so recipients can no longer claim them."
---
