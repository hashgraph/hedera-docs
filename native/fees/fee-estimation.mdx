...
description: "Use FeeEstimateQuery in the Hedera SDK to preview node, network, and service fees before submitting a transaction and gate spending against a budget."
