...
description: "Learn how Hedera hashgraph uses virtual voting to reach Byzantine consensus without sending votes across the network, saving bandwidth and ensuring fairness."
---
