...
description: "Learn how Hedera Token Service custom fees work, including fixed, fractional, and royalty fee types that automate revenue and royalties on token transfers."
---
