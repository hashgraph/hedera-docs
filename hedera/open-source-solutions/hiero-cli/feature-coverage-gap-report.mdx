  ...
  <div className="hiero-cli-coverage-heatmap">
    ...
    <div className="hiero-cli-coverage-heatmap-row">
      ...
      <div
        className="hiero-cli-coverage-heatmap-strip"
        role="img"
        aria-label="HTS compliance: Yes, Yes, No, Yes"
      >
        <span
          className="hiero-cli-coverage-dot hiero-cli-coverage-dot--yes"
        ...
        <span
          className="hiero-cli-coverage-dot hiero-cli-coverage-dot--no"
          title="No - Wipe (TokenWipe) not in plugin manifest"
        />
        <span
          className="hiero-cli-coverage-dot hiero-cli-coverage-dot--yes"
    ...
    <div className="hiero-cli-coverage-heatmap-row">
      ...
      >
        <span
          className="hiero-cli-coverage-dot hiero-cli-coverage-dot--yes"
          title="Yes - Multi-party token / HBAR swaps in a single transaction"
        />
      </div>
    </div>
    <div className="hiero-cli-coverage-heatmap-row">
    ...
    <div className="hiero-cli-coverage-heatmap-row">
      ...
      >
        ...
        <span
          className="hiero-cli-coverage-dot hiero-cli-coverage-dot--no"
          title="No - Contract update (ContractUpdate)"
        />
        <span
          className="hiero-cli-coverage-dot hiero-cli-coverage-dot--no"
...
| **HTS - compliance & risk**      | Wipe (`TokenWipe`)                                                              | **No**      | No `token wipe-ft` / `token wipe-nft` commands appear on the **token plugin manifest** in current Hiero CLI source (handlers may exist in the tree without being registered yet - check `hcli token --help`).                                                                                                                                                                |
...
| **HTS - swaps**                  | Multi-party token / HBAR swaps in a single transaction                          | **Yes**     | `swap create`, `swap add-hbar`, `swap add-ft`, `swap add-nft`, `swap execute`, `swap list`, `swap delete`                                                                                                                                                                                                                                                                    |
...
| **Smart contracts**              | Contract update (`ContractUpdate`)                                              | **No**      | Admin and auto-renew updates are not exposed. Tracked in [issue #1643](https://github.com/hiero-ledger/hiero-cli/issues/1643).                                                                                                                                                                                                                                               |
...
| **swap**              | `create`, `add-hbar`, `add-ft`, `add-nft`, `execute`, `list`, `delete`                                                                                                                                                                                                                                                                                                                                                                                                                    |
