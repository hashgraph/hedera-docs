...
description: "Submit your first Hedera transaction with the JavaScript SDK using the developer playground, create a testnet account, and view the result on HashScan."
---
