...
description: "all of the accounts proxy staking to a given account, and the amounts proxy staked. Get all the accounts that are proxy staking to this account."
---
