---
title: "Burn a token"
description: "Burn fungible or non-fungible tokens from the Hedera Token Service treasury; requires a Supply Key or transaction returns TOKEN_HAS_NO_SUPPLY_KEY."
---
