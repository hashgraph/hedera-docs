...
description: "Reference for Hedera account properties — account ID, shard and realm, keys, memo, auto-renew, and other fields stored on the network ledger."
---
...
A Hedera account can hold a balance of HBAR and custom fungible and non-fungible tokens (NFTs). Account balances can be viewed on a [Network Explorer](/learn/networks/community-mirror-nodes) and queried from mirror node REST APIs or consensus nodes.
