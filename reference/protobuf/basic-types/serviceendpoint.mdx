...
description: "Hedera protobuf reference for the ServiceEndpoint message, holding the IP address and port that expose a Hedera consensus node's gRPC service endpoint."
---
