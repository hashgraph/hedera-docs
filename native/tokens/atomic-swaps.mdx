---
title: "Atomic swaps"
description: "Atomically swap HBAR, fungible tokens, and NFTs between two Hedera accounts in a single transaction without a third-party exchange or intermediary."
---
...
<Info>
Hedera accounts must be associated with the specified token before you can transfer a token to their account. Please see how to associate a token to an account [here](/native/tokens/associate).
</Info>
