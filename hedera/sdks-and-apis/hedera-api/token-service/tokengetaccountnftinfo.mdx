...
description: "Applicable only to tokens of type NONFUNGIBLEUNIQUE. Gets info on NFTs N through M owned by the specified accountId. Example: If Account A owns 5 NFTs (might."
---
