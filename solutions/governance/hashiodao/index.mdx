...
* **NFT**: This model gives decision-making powers to the holders of a specific NFT and allows more features than a regular token model like [soulbound tokens](/support/glossary#soul-bound-token-sbt) or limiting the number of NFTs an account can own.
...
* [Create](/native/tutorials/getting-started/create-fund-account#hedera-developer-portal-profile) a Hedera account.
* [Fund](/native/tutorials/getting-started/create-fund-account#hedera-faucet) the Hedera account.
...
<Columns cols={2}>
  <Card
    ...
    href="/solutions/governance/hashiodao/governance-token-dao"
    arrow
  >
  ...
  <Card
    title="NFT DAO"
    href="/solutions/governance/hashiodao/nft-dao"
    arrow
  >
  ...
  <Card
    title="Multisig DAO"
    href="/solutions/governance/hashiodao/multisig-dao"
    arrow
  >
  ...
  <Card
    title="DAO Proposals"
    href="/solutions/governance/hashiodao/dao-proposals"
    arrow
  >
