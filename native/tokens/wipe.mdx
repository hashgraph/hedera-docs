---
title: "Wipe a token"
description: "Wipe fungible tokens or specific NFT serials from a Hedera account with TokenWipeTransaction, signed by the token's wipe key (excludes the treasury account)."
---
