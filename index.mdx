...
<a href="/solutions/ai/index" className="ai-spotlight" aria-label="Hedera AI Studio: open-source toolkit bridging artificial intelligence and Hedera">
  ...
  {/* 5 circles — exact brand icons, recolored per mode via CSS mask */}
  <div className="ai-spotlight-features">

    <div className="ai-spotlight-feature">
      <span className="ai-spotlight-ico" style={{ WebkitMaskImage: "url('/images/brand-icons/ai-studio/ai.svg')", maskImage: "url('/images/brand-icons/ai-studio/ai.svg')" }}></span>
      <span className="ai-spotlight-caption">Modular tools to build AI agents</span>
    </div>

    <div className="ai-spotlight-feature">
      <span className="ai-spotlight-ico" style={{ WebkitMaskImage: "url('/images/brand-icons/ai-studio/connect.svg')", maskImage: "url('/images/brand-icons/ai-studio/connect.svg')" }}></span>
      <span className="ai-spotlight-caption">Connect AI agents seamlessly</span>
    </div>

    <div className="ai-spotlight-feature">
      <span className="ai-spotlight-ico" style={{ WebkitMaskImage: "url('/images/brand-icons/ai-studio/code.svg')", maskImage: "url('/images/brand-icons/ai-studio/code.svg')" }}></span>
      <span className="ai-spotlight-caption">Build with LangChain, LangGraph, and JavaScript</span>
    </div>

    <div className="ai-spotlight-feature">
      <span className="ai-spotlight-ico" style={{ WebkitMaskImage: "url('/images/brand-icons/ai-studio/cube.svg')", maskImage: "url('/images/brand-icons/ai-studio/cube.svg')" }}></span>
      <span className="ai-spotlight-caption">Automated tokenization, messaging, and data logging</span>
    </div>

    <div className="ai-spotlight-feature">
      <span className="ai-spotlight-ico" style={{ WebkitMaskImage: "url('/images/brand-icons/ai-studio/gear.svg')", maskImage: "url('/images/brand-icons/ai-studio/gear.svg')" }}></span>
