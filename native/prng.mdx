...
description: "Generate verifiable pseudorandom numbers on Hedera with PrngTransaction (HIP-351), returning a 384-bit random value or a bounded 32-bit integer."
---
