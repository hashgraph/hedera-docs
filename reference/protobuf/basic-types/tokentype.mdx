---
title: "TokenType"
description: "Hedera protobuf reference for the TokenType enum, distinguishing FUNGIBLE_COMMON and NON_FUNGIBLE_UNIQUE token classes within Hashgraph token service messages."
---
