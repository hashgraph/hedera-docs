---
title: "Gas and Fees"
description: 'When executing smart contracts, the EVM requires the amount of work paid in gas. The "work" includes computation, state transitions, and storage.'
mode: "wide"
---
