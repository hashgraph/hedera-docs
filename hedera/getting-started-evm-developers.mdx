...
description: "Getting started guide for EVM developers on Hedera covering MetaMask setup, Remix, Hardhat, Foundry, the testnet faucet, and contract deployment."
