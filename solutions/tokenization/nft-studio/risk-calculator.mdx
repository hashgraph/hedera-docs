...
The NFT Risk Calculator pairs well with the [Token Holders List Builder](/solutions/tokenization/nft-studio/token-holders-list) to evaluate the risk of tokens held by specific wallet addresses and understand the potential exposure of those holders. Moreover, after identifying the list of token holders, you can use the [Airdrop List Verifier](/solutions/tokenization/nft-studio/airdrop-verifier) to ensure smooth distribution and airdrop eligibility.
...
- [**Create and Transfer Your First Hedera NFT**](/native/tutorials/tokens/create-transfer-nft)
