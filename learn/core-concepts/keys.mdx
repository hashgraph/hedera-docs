...
description: "Understand ECDSA secp256k1 and Ed25519 keys on Hedera: when to use each, public and private key roles, signature verification, and EVM compatibility."
---
