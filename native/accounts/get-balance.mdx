...
##### **Avoid Using `AccountBalanceQuery`**

Using `AccountBalanceQuery` is not recommended. **This query may not be supported in future releases**. For account balances and historical data, use the Mirror Node REST API.
