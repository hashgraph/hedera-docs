---
title: "FixedFee"
description: "Hedera protobuf reference for the FixedFee message describing a flat custom fee charged in HBAR or another token on each HTS token transfer transaction."
---
