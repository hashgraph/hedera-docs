...
description: "Run your own Hedera mirror node using Google Cloud Storage: GCP HMAC keys, repository setup, application.yml configuration, and Docker startup."
