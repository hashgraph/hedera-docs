---
title: "Provider"
description: "Provider interface in the Hedera JavaScript SDK that submits requests to a Hedera network and returns typed responses for transactions and queries."
---
