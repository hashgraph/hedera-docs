...
description: "Create and transfer your first NFT on Hedera with the Hedera Token Service, using the JavaScript SDK to mint, associate, and send non-fungible tokens."
---
