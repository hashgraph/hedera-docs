---
title: "RoyaltyFee"
description: "Hedera protobuf reference for the RoyaltyFee message describing a royalty custom fee charged when a non-fungible HTS token is exchanged for fungible value."
---
