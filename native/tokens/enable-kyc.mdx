...
description: "Grant the KYC flag to a Hedera account for a specific HTS token using TokenGrantKycTransaction, signed by the token's KYC key, before transfers."
---
