...
description: "In this tutorial, you'll learn how to create and deploy a subgraph using The Graph protocol. By indexing specific network data using user-defined data."
---
...
- The deployed Greeter smart contract address from the [Hardhat tutorial](/hedera/core-concepts/smart-contracts/json-rpc-relay).
...
<Accordion title="Find start block">
...
<Frame>
  <img src="/images/tutorials/smart-contracts/deploy-a-subgraph-using-the-graph-and-json-rpc/deploy-a-subgraph-using-the-graph-and-json-rpc-1.png" />
</Frame>
...
<Accordion title="Graph CLI installation">
...
_For example: ✔ Version Label (e.g. v0.0.1) · v0.0.1_
...
<Frame>
  <img src="/images/tutorials/smart-contracts/deploy-a-subgraph-using-the-graph-and-json-rpc/deploy-a-subgraph-using-the-graph-and-json-rpc-2.png" />
</Frame>
...
<Columns cols={2}>
  ...
  <Card title="Editor: Georgi, Sr Software Dev (LimeChain)" arrow>
