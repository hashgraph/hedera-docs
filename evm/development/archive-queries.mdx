...
description: "Use the mirror node /api/v1/contracts/call endpoint to estimate gas, run gas-free contract queries, and simulate EVM transactions, decoded with Ethers.js."
---
