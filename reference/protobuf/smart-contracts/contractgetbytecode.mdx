...
description: "Hedera protobuf reference for the ContractGetBytecode query used to retrieve the runtime EVM bytecode of a smart contract deployed on the Hedera network."
---
