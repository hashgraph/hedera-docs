---
title: "Supra Oracles"
description: "Supra is a novel, high-throughput Oracle & IntraLayer offering a vertically integrated toolkit of cross-chain solutions. These solutions include data."
---
...
<Columns cols={2}>
  <Card
    ...
    href="https://docs.supra.com/"
    arrow
    img="/images/open-source-solutions/supra-oracles/supra-oracles-1.png"
  />
  ...
  <Card
    ...
    arrow
    img="/images/open-source-solutions/supra-oracles/supra-oracles-2.png"
  />
...
<Accordion title="Data Feeds - Pull Model">
### Pull Model
...
<Accordion title="Data Feeds - Push Model">
### Push Model
