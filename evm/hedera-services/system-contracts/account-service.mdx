...
description: "Use the HIP-632 Hedera Account Service system contract, including isAuthorized and isAuthorizedRaw, to verify ECDSA and ED25519 signatures from Solidity."
---
