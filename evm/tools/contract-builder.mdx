...
description: "Use the Hedera Contract Builder, a browser-based IDE, to scaffold, compile, deploy, and verify ERC-20, ERC-721, ERC-1155, and HTS contracts on testnet."
mode: "custom"
---
