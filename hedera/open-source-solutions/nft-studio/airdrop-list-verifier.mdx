...
description: "The Airdrop List Verifier is a tool that streamlines organizing airdrops for Hedera tokens. By inputting a token ID and a list of account IDs, users can."
---
...
<iframe
  width="768"
  height="432"
  src="https://www.youtube.com/embed/3nzizeimiy0"
  title="NFT Studio | Airdrop List Verifier"
  frameborder="0"
