...
description: "ContractGetBytecode query protobuf reference for retrieving the EVM bytecode of a deployed Hedera smart contract instance by its ContractID."
---
