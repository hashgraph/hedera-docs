...
description: "Build an unsigned Hedera transaction and freeze it for offline signing, multi-key signing, or serialization to bytes for later submission via the SDK."
---
