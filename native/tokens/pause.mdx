---
title: "Pause a token"
description: "Pause all operations on a Hedera Token Service token with TokenPauseTransaction, blocking transfers, updates, and deletes until the token is unpaused."
---
